...
private FUNCTION CustomSortProc_ustring CDECL (BYVAL a AS ustring PTR, BYVAL b AS ustring PTR) AS LONG
'***********************************************************************************************
...
SUITE( fbc_tests.array.sort_string )
...
'      a(1,6) =  ""                                    'implicit gap !
    ...
    TEST( sort_custom )
      ...
      array_sort(a, @CustomSortProc_Ustring, all(1))
      CU_ASSERT( ubound(a) = 11 )
      CU_ASSERT( a(1) = "String1" )
