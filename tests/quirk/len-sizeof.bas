...
namespace tempVarDtors
	...
	function f1( byval x as ClassUdt ) as string
		function = str( x.i )
	end function

	function f2( byref x as ClassUdt ) as string
		function = str( x.i )
	end function

	function f3( byval x as ClassUdt ) as integer
		function = x.i
	end function

	function f4( byref x as ClassUdt ) as integer
		function = x.i
	end function
	...
	sub testLen cdecl( )
		...
		scope
			CU_ASSERT( len( f1( ClassUdt( 123 ) ) ) = 3 )
		end scope
		CU_ASSERT( ctors = 1 )
		CU_ASSERT( dtors = 1 )

		scope
			CU_ASSERT( len( f2( ClassUdt( 123 ) ) ) = 3 )
		end scope
		CU_ASSERT( ctors = 2 )
		CU_ASSERT( dtors = 2 )

		scope
			CU_ASSERT( len( f1( iif( c, ClassUdt( 112233 ), ClassUdt( 444 ) ) ) ) = 6 )
		end scope
		CU_ASSERT( ctors = 4 )
		CU_ASSERT( dtors = 4 )

		scope
			CU_ASSERT( len( f2( iif( c, ClassUdt( 112233 ), ClassUdt( 444 ) ) ) ) = 6 )
		end scope
		CU_ASSERT( ctors = 5 )
		CU_ASSERT( dtors = 5 )
	end sub
	...
	sub testSizeOf cdecl( )
		...
		scope
			CU_ASSERT( sizeof( f3( ClassUdt( 123 ) ) ) = sizeof( integer ) )
		end scope
		CU_ASSERT( ctors = 0 )
		CU_ASSERT( dtors = 0 )

		scope
			CU_ASSERT( sizeof( f4( ClassUdt( 123 ) ) ) = sizeof( integer ) )
		end scope
		CU_ASSERT( ctors = 0 )
		CU_ASSERT( dtors = 0 )

		scope
			CU_ASSERT( sizeof( f3( iif( c, ClassUdt( 112233 ), ClassUdt( 444 ) ) ) ) = sizeof( integer ) )
		end scope
		CU_ASSERT( ctors = 0 )
		CU_ASSERT( dtors = 0 )

		scope
			CU_ASSERT( sizeof( f4( iif( c, ClassUdt( 112233 ), ClassUdt( 444 ) ) ) ) = sizeof( integer ) )
		end scope
		CU_ASSERT( ctors = 0 )
		CU_ASSERT( dtors = 0 )

		scope
			CU_ASSERT( sizeof( ClassUdt( 123 ) ) = sizeof( ClassUdt ) )
		end scope
		CU_ASSERT( ctors = 0 )
		CU_ASSERT( dtors = 0 )

		scope
			CU_ASSERT( sizeof( iif( c, ClassUdt( 112233 ), ClassUdt( 444 ) ) ) = sizeof( ClassUdt ) )
		end scope
		CU_ASSERT( ctors = 0 )
		CU_ASSERT( dtors = 0 )

		scope
			CU_ASSERT( len( ClassUdt( 123 ) ) = sizeof( ClassUdt ) )
		end scope
		CU_ASSERT( ctors = 0 )
		CU_ASSERT( dtors = 0 )

		scope
			CU_ASSERT( len( iif( c, ClassUdt( 112233 ), ClassUdt( 444 ) ) ) = sizeof( ClassUdt ) )
		end scope
		CU_ASSERT( ctors = 0 )
		CU_ASSERT( dtors = 0 )

		scope
			CU_ASSERT( ((ClassUdt( 1 )).i + sizeof( ClassUdt( 123 ) )) = (1 + sizeof( ClassUdt )) )
		end scope
		CU_ASSERT( ctors = 1 )
		CU_ASSERT( dtors = 1 )

		scope
			CU_ASSERT( (sizeof( ClassUdt( 123 ) ) + (ClassUdt( 1 )).i) = (sizeof( ClassUdt ) + 1) )
		end scope
		CU_ASSERT( ctors = 2 )
		CU_ASSERT( dtors = 2 )
	end sub
...
private sub ctor( ) constructor
	...
	fbcu.add_test( "string len() temp dtors", @tempVarDtors.testLen )
	fbcu.add_test( "sizeof() temp dtors", @tempVarDtors.testSizeOf )
end sub
