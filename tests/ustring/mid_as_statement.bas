...
SUITE( fbc_tests.ustring_.mid_as_statement_ )
dim i as long
dim n as long
dim r as long


    TEST( rtl_MID_statement_lcase )
    ...
    TEST( rtl_MID_statement_russian )
    ...
    TEST( rtl_MID_statement_numbers )
