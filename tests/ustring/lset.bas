...
SUITE( fbc_tests.ustring_.lset_ )
dim i as long
dim n as long
dim r as long


    TEST( rtl_LSET__USTRING_to_WSTRING_and_vice_versa__lcase )
    ...
    TEST( rtl_LSET__USTRING_to_WSTRING_and_vice_versa__ucase )
    ...
    TEST( rtl_LSET__USTRING_to_WSTRING_and_vice_versa__wide )
    ...
    TEST( rtl_LSET__USTRING_to_WSTRING_and_vice_versa__russian )
    ...
    TEST( rtl_LSET__USTRING_to_WSTRING_and_vice_versa__numbers )
