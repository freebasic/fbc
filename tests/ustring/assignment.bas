...
SUITE( fbc_tests.ustring_.assignment )
dim i as long
dim r as long
dim x as long
dim z as long
    ...
    TEST( pointer_assignment_failed_lcase )
    ...
    TEST( pointer_assignment_failed_ucase )
    ...
    TEST( pointer_assignment_failed_wide )
    ...
    TEST( pointer_assignment_failed_russian )
    ...
    TEST( pointer_assignment_failed_numbers )
