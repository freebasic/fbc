...
#ifndef pcre_compile2
declare function pcre_compile2 (byval as zstring ptr, byval as integer, byval as integer ptr, byval as zstring ptr ptr, byval as integer ptr, byval as ubyte ptr) as pcre ptr
#endif
