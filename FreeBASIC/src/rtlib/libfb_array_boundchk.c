...
/*:::::*/
FBCALL void *fb_ArrayBoundChk( int idx, int lbound, int ubound,
							   int linenum, const char *fname )
{
...
/*:::::*/
FBCALL void *fb_ArraySngBoundChk( unsigned int idx, unsigned int ubound,
								  int linenum, const char *fname )
{
	if( idx > ubound )
		return hThrowError( linenum, fname );
