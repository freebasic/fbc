...
<p>{L_ADMIN_INTRO}</p>
<p><font size="+1"><b>Igloo theme v1.0 information</b></a></p>
<p><font size="0">Thanks for using the Igloo theme. This theme was created by <a href="http://andrewcharron.tk">Andrew Charron</a>.. Support for this theme can currently be found at <a href="http://www.dosgames.com/~kazer0/alexis/">the support forum</a>. Thanks for using Igloo, if you like this theme, consider <a href="http://www.dosgames.com/~kazer0/donate/donate.html">donating</a>. </p><p align="right">- Andrew Charron</font></p>
...
<table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline">
  ...
  <!-- END reg_user_row -->
  <tr> 
        <td colspan="5" height="1" class="row3"><img src="../templates/Igloo/images/spacer.gif" width="1" height="1" alt="."></td>
  </tr>
