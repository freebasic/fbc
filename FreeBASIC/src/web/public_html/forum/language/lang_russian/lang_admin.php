...
$lang['Backup_explain'] = 'Вы можете сохранить все связанные с phpBB данные. Если в БД для phpBB есть другие таблицы, которые вы тоже хотели бы сохранить, пожалуйста, введите их названия, разделённые запятыми, в поле "Дополнительные таблицы". Если ваш сервер поддерживает такую возможность, вы можете также перед скачиванием сжать файл gzip\'ом для уменьшения его размера.';
...
$lang['Ban_explain'] = 'Здесь вы можете закрывать пользователям любой доступ к форумам. Вы можете внести в чёрный список конкретного пользователя, а также один или несколько IP адресов или имён серверов. Этот метод не даст пользователю увидеть даже список форумов. Чтобы запретить регистрацию под другим именем, вы можете также внести в чёрный список адрес e-mail. Учтите, запрещение только e-mail адреса не закроет пользователю возможность заходить на форум и писать сообщения. Для этого вам придётся воспользоваться одним из первых двух методов.';
...
$lang['Board_disable_explain'] = 'Форумы станут недоступны пользователям. У администраторов останется доступ к администраторскому разделу';
...
$lang['Allow_local'] = 'Разрешить аватары из галереи';
$lang['Allow_remote'] = 'Разрешить удалённые аватары';
...
$lang['Avatar_gallery_path'] = 'Путь к галереям аватар';
$lang['Avatar_gallery_path_explain'] = 'Каталог ниже корня phpBB для предварительно загруженных аватар, например images/avatars/gallery';
...
$lang['Cookie_settings_explain'] = 'Вы можете изменить параметры куков (cookies), отправляемых пользователям. В большинстве случаев подходят значения по умолчанию. Если вам требуется их изменить, соблюдайте осторожность: неверные значения могут привести к невозможности входа пользователей на форум.';
$lang['Cookie_domain'] = 'Домен куки';
$lang['Cookie_name'] = 'Имя куки';
$lang['Cookie_path'] = 'Путь куки';
$lang['Cookie_secure'] = 'Безопасные куки [ https ]';
$lang['Cookie_secure_explain'] = 'Если ваш сервер работает через SSL, то включите этот параметр, в противном случае оставьте выключенным.';
...
$lang['Autologin_time'] = 'Время действия автоматического входа';
$lang['Autologin_time_explain'] = 'Срок в днях с последнего посещения, в течение которого пользователь может автоматически войти на форум. Введите 0 или оставьте поле пустым, чтобы отключить данную функцию.';
...
$lang['Forum_admin_explain'] = 'Здесь вы можете создавать, удалять и изменять порядок отображения категорий и форумов';
...
$lang['User_special_explain'] = 'Эти поля сами пользователи редактировать не могут. Здесь вы можете установить их статус и изменить прочие недоступные им настройки.';
...
$lang['delete_group_moderator'] = 'Удалить старого модератора группы?';
...
$lang['Delete_disallow_explain'] = 'Вы можете убрать запрещённое имя, выбрав его из списка и нажав кнопку &laquo;Удалить&raquo;';
