...
type SYMBKWD
	...
	{ _
        ...
        ( @"GETMOUSE"   , FB_TK_GETMOUSE 	, FB_TKCLASS_QUIRKWD , KWD_OPTION_NO_QB ), _
        ( @"GETJOYSTICK", FB_TK_GETJOYSTICK , FB_TKCLASS_QUIRKWD , KWD_OPTION_NO_QB ), _
        ( @"SCREENEVENT", FB_TK_SCREENEVENT , FB_TKCLASS_QUIRKWD , KWD_OPTION_NO_QB ), _
        ( NULL ) _
	}
