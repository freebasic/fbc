...
enum FBERRMSG_ENUM
	...
	FB.ERRMSG.MACROTEXTTOOLONG
	FB.ERRMSG.INVALIDCMDOPTION
	FB.ERRMSG.CANTINITDYNAMICSTRINGS
	FB.ERRMSG.RECURSIVEUDT
	FB.ERRMSG.CANTREDIMARRAYFIELDS
	FB.ERRMSGS
end enum

enum FBWARNINGMSG_ENUM
	FB.WARNINGMSG.INVALIDPOINTER			= 1
	FB.WARNINGMSG.SUSPICIOUSPTRASSIGN
	FB.WARNINGMSG.IMPLICITCONVERTION
	FB.WARNINGMSGS
end enum
