...
declare function 	symbLookup				( byval symbol as string, id as integer, class as integer, _
...
declare function 	symbFindByNameAndClass	( byval symbol as string, byval class as integer, _
											  byval preservecase as integer = FALSE ) as FBSYMBOL ptr
declare function 	symbFindByNameAndSuffix	( byval symbol as string, byval suffix as integer, _
											  byval preservecase as integer = FALSE ) as FBSYMBOL ptr

declare function 	symbLookupUDTVar		( byval symbol as string, byval dotpos as integer, _
...
declare function	symbGetArgOptvalStr		( byval f as FBSYMBOL ptr, byval a as FBSYMBOL ptr ) as FBSYMBOL ptr
...
declare function 	symbAddDefine			( byval symbol as string, byval text as string, _
											  byval args as integer = 0, byval arghead as FBDEFARG ptr = NULL ) as FBSYMBOL ptr
declare function 	symbAddDefineArg		( byval lastarg as FBDEFARG ptr, byval symbol as string ) as FBDEFARG ptr
declare function 	symbAddFwdRef			( byval symbol as string ) as FBSYMBOL ptr
declare function 	symbAddTypedef			( byval symbol as string, byval typ as integer, byval subtype as FBSYMBOL ptr, _
						 					  byval ptrcnt as integer, byval lgt as integer ) as FBSYMBOL ptr
declare function 	symbAddLabel			( byval symbol as string, byval declaring as integer = TRUE, _
											  byval createalias as integer = FALSE ) as FBSYMBOL ptr
declare function 	symbAddVar				( byval symbol as string, byval typ as integer, byval subtype as FBSYMBOL ptr, _
					  						  byval ptrcnt as integer, _
					  						  byval dimensions as integer, dTB() as FBARRAYDIM, _
				      						  byval alloctype as integer ) as FBSYMBOL ptr
declare function 	symbAddVarEx			( byval symbol as string, byval aliasname as string, _
...
declare function 	symbAddUDTElement		( byval t as FBSYMBOL ptr, byval id as string, _
											  byval dimensions as integer, dTB() as FBARRAYDIM, _
											  byval typ as integer, byval subtype as FBSYMBOL ptr, _
											  byval ptrcnt as integer, byval lgt as integer, _
											  byval isinnerunion as integer ) as FBSYMBOL ptr
declare function 	symbAddEnum				( byval symbol as string ) as FBSYMBOL ptr
declare function 	symbAddArg				( byval symbol as string, byval tail as FBSYMBOL ptr, _
					 						  byval typ as integer, byval subtype as FBSYMBOL ptr, _
					 						  byval ptrcnt as integer, byval lgt as integer, _
					 						  byval mode as integer, byval suffix as integer, _
					 						  byval optional as integer, byval optval as FBVALUE ptr ) as FBSYMBOL ptr
declare function 	symbAddPrototype		( byval symbol as string, byval aliasname as string, _
...
declare function 	symbAddProc				( byval symbol as string, byval aliasname as string, _
											  byval libname as string, _
					  						  byval typ as integer, byval subtype as FBSYMBOL ptr, _
					  						  byval ptrcnt as integer, byval alloctype as integer, _
...
declare function 	symbAddArgAsVar			( byval symbol as string, byval arg as FBSYMBOL ptr ) as FBSYMBOL ptr
...
declare function 	hAllocNumericConst		( byval sname as string, byval typ as integer ) as FBSYMBOL ptr
declare function 	hAllocStringConst		( byval sname as string, byval lgt as integer ) as FBSYMBOL ptr
