...
'' globals
	...
	{ _
		...
		( AST_NODECLASS_ASSIGN	, AST_OPFLAGS_NONE, @"let"		), _	'' AST_OP_ASSIGN
		...
		( AST_NODECLASS_BOP		, AST_OPFLAGS_NONE, @"mod"		), _	'' AST_OP_MOD
		( AST_NODECLASS_BOP		, AST_OPFLAGS_SELF, @"mod="		), _	'' AST_OP_MOD_SELF
		( AST_NODECLASS_BOP		, AST_OPFLAGS_COMM, @"and"		), _	'' AST_OP_AND
		( AST_NODECLASS_BOP		, AST_OPFLAGS_SELF, @"and="		), _	'' AST_OP_AND_SELF
		( AST_NODECLASS_BOP		, AST_OPFLAGS_COMM, @"or"		), _	'' AST_OP_OR
		( AST_NODECLASS_BOP		, AST_OPFLAGS_SELF, @"or="		), _	'' AST_OP_OR_SELF
		( AST_NODECLASS_BOP		, AST_OPFLAGS_COMM, @"xor"		), _	'' AST_OP_XOR
		( AST_NODECLASS_BOP		, AST_OPFLAGS_SELF, @"xor="		), _	'' AST_OP_XOR_SELF
		( AST_NODECLASS_BOP		, AST_OPFLAGS_NONE, @"eqv"		), _	'' AST_OP_EQV
		( AST_NODECLASS_BOP		, AST_OPFLAGS_SELF, @"eqv="		), _	'' AST_OP_EQV_SELF
		( AST_NODECLASS_BOP		, AST_OPFLAGS_NONE, @"imp"		), _	'' AST_OP_IMP
		( AST_NODECLASS_BOP		, AST_OPFLAGS_SELF, @"imp="		), _	'' AST_OP_IMP_SELF
		( AST_NODECLASS_BOP		, AST_OPFLAGS_NONE, @"shl"		), _	'' AST_OP_SHL
		( AST_NODECLASS_BOP		, AST_OPFLAGS_SELF, @"shl="		), _	'' AST_OP_SHL_SELF
		( AST_NODECLASS_BOP		, AST_OPFLAGS_NONE, @"shr"		), _	'' AST_OP_SHR
		( AST_NODECLASS_BOP		, AST_OPFLAGS_SELF, @"shr="		), _	'' AST_OP_SHR_SELF
		( AST_NODECLASS_BOP		, AST_OPFLAGS_NONE, @"pow"		), _	'' AST_OP_POW
		( AST_NODECLASS_BOP		, AST_OPFLAGS_SELF, @"pow="		), _	'' AST_OP_POW_SELF
		...
		( AST_NODECLASS_CONV 	, AST_OPFLAGS_NONE, @"cast"		), _	'' AST_OP_CAST
