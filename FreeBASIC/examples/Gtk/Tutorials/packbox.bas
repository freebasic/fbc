...
Function delete_event Cdecl(Byval widget As GtkWidget Ptr, Byval event As GdkEvent, Byval user_data As gpointer Ptr) As Integer
...
' ==============================================
	...
	' You should always remember to connect the delete_event gtk_window_set_title (GTK_WINDOW (win), "Hello Buttons!")signal
	...
	g_signal_connect_swapped (G_OBJECT (button), "clicked", G_CALLBACK (@gtk_main_quit), G_OBJECT (win))
