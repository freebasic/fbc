...
declare function gdk_bitmap_create_from_data cdecl alias "gdk_bitmap_create_from_data" (byval drawable as GdkDrawable ptr, byval data as zstring ptr, byval width as gint, byval height as gint) as GdkBitmap ptr
declare function gdk_pixmap_create_from_data cdecl alias "gdk_pixmap_create_from_data" (byval drawable as GdkDrawable ptr, byval data as zstring ptr, byval width as gint, byval height as gint, byval depth as gint, byval fg as GdkColor ptr, byval bg as GdkColor ptr) as GdkPixmap ptr
declare function gdk_pixmap_create_from_xpm cdecl alias "gdk_pixmap_create_from_xpm" (byval drawable as GdkDrawable ptr, byval mask as GdkBitmap ptr ptr, byval transparent_color as GdkColor ptr, byval filename as zstring ptr) as GdkPixmap ptr
declare function gdk_pixmap_colormap_create_from_xpm cdecl alias "gdk_pixmap_colormap_create_from_xpm" (byval drawable as GdkDrawable ptr, byval colormap as GdkColormap ptr, byval mask as GdkBitmap ptr ptr, byval transparent_color as GdkColor ptr, byval filename as zstring ptr) as GdkPixmap ptr
