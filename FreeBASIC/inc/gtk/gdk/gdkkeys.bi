...
declare function gdk_keyval_name cdecl alias "gdk_keyval_name" (byval keyval as guint) as gchar ptr
declare function gdk_keyval_from_name cdecl alias "gdk_keyval_from_name" (byval keyval_name as gchar ptr) as guint
