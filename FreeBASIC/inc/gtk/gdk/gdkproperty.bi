...
declare function gdk_atom_intern cdecl alias "gdk_atom_intern" (byval atom_name as zstring ptr, byval only_if_exists as gboolean) as GdkAtom
...
declare function gdk_utf8_to_compound_text cdecl alias "gdk_utf8_to_compound_text" (byval str as zstring ptr, byval encoding as GdkAtom ptr, byval format as gint ptr, byval ctext as guchar ptr ptr, byval length as gint ptr) as gboolean
declare function gdk_string_to_compound_text cdecl alias "gdk_string_to_compound_text" (byval str as zstring ptr, byval encoding as GdkAtom ptr, byval format as gint ptr, byval ctext as guchar ptr ptr, byval length as gint ptr) as gint
...
declare function gdk_utf8_to_string_target cdecl alias "gdk_utf8_to_string_target" (byval str as zstring ptr) as zstring ptr
declare function gdk_string_to_compound_text_for_display cdecl alias "gdk_string_to_compound_text_for_display" (byval display as GdkDisplay ptr, byval str as zstring ptr, byval encoding as GdkAtom ptr, byval format as gint ptr, byval ctext as guchar ptr ptr, byval length as gint ptr) as gint
declare function gdk_utf8_to_compound_text_for_display cdecl alias "gdk_utf8_to_compound_text_for_display" (byval display as GdkDisplay ptr, byval str as zstring ptr, byval encoding as GdkAtom ptr, byval format as gint ptr, byval ctext as guchar ptr ptr, byval length as gint ptr) as gboolean
