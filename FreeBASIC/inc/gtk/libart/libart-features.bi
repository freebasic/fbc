...
declare sub libart_preinit cdecl alias "libart_preinit" (byval app as any ptr, byval modinfo as any ptr)
declare sub libart_postinit cdecl alias "libart_postinit" (byval app as any ptr, byval modinfo as any ptr)
