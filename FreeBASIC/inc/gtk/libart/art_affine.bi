...
declare sub art_affine_rotate cdecl alias "art_affine_rotate" (byval dst as double ptr, byval theta as double)
declare sub art_affine_shear cdecl alias "art_affine_shear" (byval dst as double ptr, byval theta as double)
declare sub art_affine_translate cdecl alias "art_affine_translate" (byval dst as double ptr, byval tx as double, byval ty as double)
declare function art_affine_expansion cdecl alias "art_affine_expansion" (byval src as double ptr) as double
declare function art_affine_rectilinear cdecl alias "art_affine_rectilinear" (byval src as double ptr) as integer
declare function art_affine_equal cdecl alias "art_affine_equal" (byval matrix1 as double ptr, byval matrix2 as double ptr) as integer
