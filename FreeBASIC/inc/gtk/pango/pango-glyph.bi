...
declare function pango_glyph_string_new cdecl alias "pango_glyph_string_new" () as PangoGlyphString ptr
declare sub pango_glyph_string_set_size cdecl alias "pango_glyph_string_set_size" (byval string as PangoGlyphString ptr, byval new_len as gint)
declare function pango_glyph_string_get_type cdecl alias "pango_glyph_string_get_type" () as GType
declare function pango_glyph_string_copy cdecl alias "pango_glyph_string_copy" (byval string as PangoGlyphString ptr) as PangoGlyphString ptr
...
declare sub pango_shape cdecl alias "pango_shape" (byval text as gchar ptr, byval length as gint, byval analysis as PangoAnalysis ptr, byval glyphs as PangoGlyphString ptr)
