...
type GladeFindInternalChildFunc as function cdecl(byval as GladeXML ptr, byval as GtkWidget ptr, byval as string) as GtkWidget
type GladeApplyCustomPropFunc as sub cdecl(byval as GladeXML ptr, byval as GtkWidget ptr, byval as string, byval as string)
...
declare sub glade_register_custom_prop cdecl alias "glade_register_custom_prop" (byval type as GType, byval prop_name as string, byval apply_prop as GladeApplyCustomPropFunc)
...
declare sub glade_xml_handle_widget_prop cdecl alias "glade_xml_handle_widget_prop" (byval self as GladeXML ptr, byval widget as GtkWidget ptr, byval prop_name as string, byval value_name as string)
...
declare function glade_xml_set_value_from_string cdecl alias "glade_xml_set_value_from_string" (byval xml as GladeXML ptr, byval pspec as GParamSpec ptr, byval string as string, byval value as GValue ptr) as gboolean
