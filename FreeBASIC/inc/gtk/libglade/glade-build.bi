...
declare sub glade_register_custom_prop cdecl alias "glade_register_custom_prop" (byval type as GType, byval prop_name as zstring ptr, byval apply_prop as GladeApplyCustomPropFunc)
...
declare sub glade_xml_handle_widget_prop cdecl alias "glade_xml_handle_widget_prop" (byval self as GladeXML ptr, byval widget as GtkWidget ptr, byval prop_name as zstring ptr, byval value_name as zstring ptr)
declare sub glade_xml_set_packing_property cdecl alias "glade_xml_set_packing_property" (byval self as GladeXML ptr, byval parent as GtkWidget ptr, byval child as GtkWidget ptr, byval name as zstring ptr, byval value as zstring ptr)
...
declare function glade_xml_set_value_from_string cdecl alias "glade_xml_set_value_from_string" (byval xml as GladeXML ptr, byval pspec as GParamSpec ptr, byval string as zstring ptr, byval value as GValue ptr) as gboolean
...
declare function glade_enum_from_string cdecl alias "glade_enum_from_string" (byval type as GType, byval string as zstring ptr) as gint
declare function glade_flags_from_string cdecl alias "glade_flags_from_string" (byval type as GType, byval string as zstring ptr) as guint

#define GLADE_MODULE_API_VERSION 1

declare function glade_module_check_version cdecl alias "glade_module_check_version" (byval version as gint) as zstring ptr
