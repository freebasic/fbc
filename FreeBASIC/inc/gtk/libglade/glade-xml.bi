...
type GladeXMLConnectFunc as sub cdecl(byval as string, byval as GObject ptr, byval as string, byval as string, byval as GObject ptr, byval as gboolean, byval as gpointer)

declare sub glade_xml_signal_connect_full cdecl alias "glade_xml_signal_connect_full" (byval self as GladeXML ptr, byval handler_name as string, byval func as GladeXMLConnectFunc, byval user_data as gpointer)
...
declare function glade_xml_relative_file cdecl alias "glade_xml_relative_file" (byval self as GladeXML ptr, byval filename as string) as zstring ptr
...
type GladeXMLCustomWidgetHandler as function cdecl(byval as GladeXML ptr, byval as string, byval as string, byval as string, byval as string, byval as gint, byval as gint, byval as gpointer) as GtkWidget
