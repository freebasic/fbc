...
declare function glade_xml_new cdecl alias "glade_xml_new" (byval fname as zstring ptr, byval root as zstring ptr, byval domain as zstring ptr) as GladeXML ptr
declare function glade_xml_new_from_buffer cdecl alias "glade_xml_new_from_buffer" (byval buffer as zstring ptr, byval size as integer, byval root as zstring ptr, byval domain as zstring ptr) as GladeXML ptr
declare function glade_xml_construct cdecl alias "glade_xml_construct" (byval self as GladeXML ptr, byval fname as zstring ptr, byval root as zstring ptr, byval domain as zstring ptr) as gboolean
declare sub glade_xml_signal_connect cdecl alias "glade_xml_signal_connect" (byval self as GladeXML ptr, byval handlername as zstring ptr, byval func as GCallback)
declare sub glade_xml_signal_connect_data cdecl alias "glade_xml_signal_connect_data" (byval self as GladeXML ptr, byval handlername as zstring ptr, byval func as GCallback, byval user_data as gpointer)
...
declare sub glade_xml_signal_connect_full cdecl alias "glade_xml_signal_connect_full" (byval self as GladeXML ptr, byval handler_name as zstring ptr, byval func as GladeXMLConnectFunc, byval user_data as gpointer)
...
declare function glade_xml_get_widget cdecl alias "glade_xml_get_widget" (byval self as GladeXML ptr, byval name as zstring ptr) as GtkWidget ptr
declare function glade_xml_get_widget_prefix cdecl alias "glade_xml_get_widget_prefix" (byval self as GladeXML ptr, byval name as zstring ptr) as GList ptr
declare function glade_xml_relative_file cdecl alias "glade_xml_relative_file" (byval self as GladeXML ptr, byval filename as zstring ptr) as zstring ptr
