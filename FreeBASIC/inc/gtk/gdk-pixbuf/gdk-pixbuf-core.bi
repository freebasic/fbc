...
declare function gdk_pixbuf_new_from_file cdecl alias "gdk_pixbuf_new_from_file" (byval filename as zstring ptr, byval error as GError ptr ptr) as GdkPixbuf ptr
declare function gdk_pixbuf_new_from_file_at_size cdecl alias "gdk_pixbuf_new_from_file_at_size" (byval filename as zstring ptr, byval width as integer, byval height as integer, byval error as GError ptr ptr) as GdkPixbuf ptr
declare function gdk_pixbuf_new_from_file_at_scale cdecl alias "gdk_pixbuf_new_from_file_at_scale" (byval filename as zstring ptr, byval width as integer, byval height as integer, byval preserve_aspect_ratio as gboolean, byval error as GError ptr ptr) as GdkPixbuf ptr
...
declare function gdk_pixbuf_save cdecl alias "gdk_pixbuf_save" (byval pixbuf as GdkPixbuf ptr, byval filename as zstring ptr, byval type as zstring ptr, byval error as GError ptr ptr, ...) as gboolean
declare function gdk_pixbuf_savev cdecl alias "gdk_pixbuf_savev" (byval pixbuf as GdkPixbuf ptr, byval filename as zstring ptr, byval type as zstring ptr, byval option_keys as byte ptr ptr, byval option_values as byte ptr ptr, byval error as GError ptr ptr) as gboolean
...
declare function gdk_pixbuf_save_to_callback cdecl alias "gdk_pixbuf_save_to_callback" (byval pixbuf as GdkPixbuf ptr, byval save_func as GdkPixbufSaveFunc, byval user_data as gpointer, byval type as zstring ptr, byval error as GError ptr ptr, ...) as gboolean
declare function gdk_pixbuf_save_to_callbackv cdecl alias "gdk_pixbuf_save_to_callbackv" (byval pixbuf as GdkPixbuf ptr, byval save_func as GdkPixbufSaveFunc, byval user_data as gpointer, byval type as zstring ptr, byval option_keys as byte ptr ptr, byval option_values as byte ptr ptr, byval error as GError ptr ptr) as gboolean
declare function gdk_pixbuf_save_to_buffer cdecl alias "gdk_pixbuf_save_to_buffer" (byval pixbuf as GdkPixbuf ptr, byval buffer as zstring ptr ptr, byval buffer_size as gsize ptr, byval type as zstring ptr, byval error as GError ptr ptr, ...) as gboolean
declare function gdk_pixbuf_save_to_bufferv cdecl alias "gdk_pixbuf_save_to_bufferv" (byval pixbuf as GdkPixbuf ptr, byval buffer as zstring ptr ptr, byval buffer_size as gsize ptr, byval type as zstring ptr, byval option_keys as byte ptr ptr, byval option_values as byte ptr ptr, byval error as GError ptr ptr) as gboolean
...
declare function gdk_pixbuf_get_option cdecl alias "gdk_pixbuf_get_option" (byval pixbuf as GdkPixbuf ptr, byval key as zstring ptr) as zstring ptr
