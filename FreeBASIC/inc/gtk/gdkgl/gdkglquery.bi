...
declare function gdk_gl_query_gl_extension cdecl alias "gdk_gl_query_gl_extension" (byval extension as string) as gboolean
declare function gdk_gl_get_proc_address cdecl alias "gdk_gl_get_proc_address" (byval proc_name as string) as GdkGLProc
