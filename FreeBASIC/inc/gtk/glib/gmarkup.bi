...
type _GMarkupParser
	start_element as sub cdecl(byval as GMarkupParseContext ptr, byval as string, byval as zstring ptr ptr, byval as zstring ptr ptr, byval as gpointer, byval as GError ptr ptr)
	end_element as sub cdecl(byval as GMarkupParseContext ptr, byval as string, byval as gpointer, byval as GError ptr ptr)
	text as sub cdecl(byval as GMarkupParseContext ptr, byval as string, byval as gsize, byval as gpointer, byval as GError ptr ptr)
	passthrough as sub cdecl(byval as GMarkupParseContext ptr, byval as string, byval as gsize, byval as gpointer, byval as GError ptr ptr)
...
declare function g_markup_parse_context_parse cdecl alias "g_markup_parse_context_parse" (byval context as GMarkupParseContext ptr, byval text as string, byval text_len as gssize, byval error as GError ptr ptr) as gboolean
...
declare function g_markup_escape_text cdecl alias "g_markup_escape_text" (byval text as string, byval length as gssize) as zstring ptr
declare function g_markup_printf_escaped cdecl alias "g_markup_printf_escaped" (byval format as string, ...) as zstring ptr
''''''' declare function g_markup_vprintf_escaped cdecl alias "g_markup_vprintf_escaped" (byval format as string, byval args as va_list) as zstring ptr
