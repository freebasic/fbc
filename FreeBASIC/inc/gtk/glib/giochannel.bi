...
type _GIOFuncs
	...
	io_write as function cdecl(byval as GIOChannel ptr, byval as gchar ptr, byval as gsize, byval as gsize ptr, byval as GError ptr ptr) as GIOStatus
...
declare function g_io_channel_read cdecl alias "g_io_channel_read" (byval channel as GIOChannel ptr, byval buf as gchar ptr, byval count as gsize, byval bytes_read as gsize ptr) as GIOError
declare function g_io_channel_write cdecl alias "g_io_channel_write" (byval channel as GIOChannel ptr, byval buf as gchar ptr, byval count as gsize, byval bytes_written as gsize ptr) as GIOError
...
declare function g_io_add_watch_full cdecl alias "g_io_add_watch_full" (byval channel as GIOChannel ptr, byval priority as gint, byval condition as GIOCondition, byval func as GIOFunc, byval user_data as gpointer, byval notify as GDestroyNotify) as guint
declare function g_io_create_watch cdecl alias "g_io_create_watch" (byval channel as GIOChannel ptr, byval condition as GIOCondition) as GSource ptr
declare function g_io_add_watch cdecl alias "g_io_add_watch" (byval channel as GIOChannel ptr, byval condition as GIOCondition, byval func as GIOFunc, byval user_data as gpointer) as guint
declare sub g_io_channel_set_buffer_size cdecl alias "g_io_channel_set_buffer_size" (byval channel as GIOChannel ptr, byval size as gsize)
declare function g_io_channel_get_buffer_size cdecl alias "g_io_channel_get_buffer_size" (byval channel as GIOChannel ptr) as gsize
...
declare sub g_io_channel_set_line_term cdecl alias "g_io_channel_set_line_term" (byval channel as GIOChannel ptr, byval line_term as gchar ptr, byval length as gint)
declare function g_io_channel_get_line_term cdecl alias "g_io_channel_get_line_term" (byval channel as GIOChannel ptr, byval length as gint ptr) as gchar ptr
...
declare function g_io_channel_set_encoding cdecl alias "g_io_channel_set_encoding" (byval channel as GIOChannel ptr, byval encoding as gchar ptr, byval error as GError ptr ptr) as GIOStatus
declare function g_io_channel_get_encoding cdecl alias "g_io_channel_get_encoding" (byval channel as GIOChannel ptr) as gchar ptr
...
declare function g_io_channel_flush cdecl alias "g_io_channel_flush" (byval channel as GIOChannel ptr, byval error as GError ptr ptr) as GIOStatus
declare function g_io_channel_read_line cdecl alias "g_io_channel_read_line" (byval channel as GIOChannel ptr, byval str_return as gchar ptr ptr, byval length as gsize ptr, byval terminator_pos as gsize ptr, byval error as GError ptr ptr) as GIOStatus
...
declare function g_io_channel_read_to_end cdecl alias "g_io_channel_read_to_end" (byval channel as GIOChannel ptr, byval str_return as gchar ptr ptr, byval length as gsize ptr, byval error as GError ptr ptr) as GIOStatus
declare function g_io_channel_read_chars cdecl alias "g_io_channel_read_chars" (byval channel as GIOChannel ptr, byval buf as gchar ptr, byval count as gsize, byval bytes_read as gsize ptr, byval error as GError ptr ptr) as GIOStatus
...
declare function g_io_channel_write_chars cdecl alias "g_io_channel_write_chars" (byval channel as GIOChannel ptr, byval buf as gchar ptr, byval count as gssize, byval bytes_written as gsize ptr, byval error as GError ptr ptr) as GIOStatus
...
declare function g_io_channel_new_file_utf8 cdecl alias "g_io_channel_new_file_utf8" (byval filename as gchar ptr, byval mode as gchar ptr, byval error as GError ptr ptr) as GIOChannel ptr
...
declare function g_io_channel_unix_get_fd cdecl alias "g_io_channel_unix_get_fd" (byval channel as GIOChannel ptr) as gint

#define G_WIN32_MSG_HANDLE 19981206

declare sub g_io_channel_win32_make_pollfd cdecl alias "g_io_channel_win32_make_pollfd" (byval channel as GIOChannel ptr, byval condition as GIOCondition, byval fd as GPollFD ptr)
declare function g_io_channel_win32_poll cdecl alias "g_io_channel_win32_poll" (byval fds as GPollFD ptr, byval n_fds as gint, byval timeout_ as gint) as gint
declare function g_io_channel_win32_new_messages cdecl alias "g_io_channel_win32_new_messages" (byval hwnd as guint) as GIOChannel ptr
declare function g_io_channel_win32_new_fd cdecl alias "g_io_channel_win32_new_fd" (byval fd as gint) as GIOChannel ptr
declare function g_io_channel_win32_get_fd cdecl alias "g_io_channel_win32_get_fd" (byval channel as GIOChannel ptr) as gint
declare function g_io_channel_win32_new_socket cdecl alias "g_io_channel_win32_new_socket" (byval socket as gint) as GIOChannel ptr
