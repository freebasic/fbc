...
declare function g_error_new cdecl alias "g_error_new" (byval domain as GQuark, byval code as gint, byval format as zstring ptr, ...) as GError ptr
declare function g_error_new_literal cdecl alias "g_error_new_literal" (byval domain as GQuark, byval code as gint, byval message as zstring ptr) as GError ptr
...
declare sub g_set_error cdecl alias "g_set_error" (byval err as GError ptr ptr, byval domain as GQuark, byval code as gint, byval format as zstring ptr, ...)
