...
declare function g_string_chunk_insert cdecl alias "g_string_chunk_insert" (byval chunk as GStringChunk ptr, byval string as gchar ptr) as gchar ptr
declare function g_string_chunk_insert_len cdecl alias "g_string_chunk_insert_len" (byval chunk as GStringChunk ptr, byval string as gchar ptr, byval len as gssize) as gchar ptr
declare function g_string_chunk_insert_const cdecl alias "g_string_chunk_insert_const" (byval chunk as GStringChunk ptr, byval string as gchar ptr) as gchar ptr
declare function g_string_new cdecl alias "g_string_new" (byval init as gchar ptr) as GString ptr
declare function g_string_new_len cdecl alias "g_string_new_len" (byval init as gchar ptr, byval len as gssize) as GString ptr
declare function g_string_sized_new cdecl alias "g_string_sized_new" (byval dfl_size as gsize) as GString ptr
declare function g_string_free cdecl alias "g_string_free" (byval string as GString ptr, byval free_segment as gboolean) as gchar ptr
...
declare function g_string_assign cdecl alias "g_string_assign" (byval string as GString ptr, byval rval as gchar ptr) as GString ptr
...
declare function g_string_insert_len cdecl alias "g_string_insert_len" (byval string as GString ptr, byval pos as gssize, byval val as gchar ptr, byval len as gssize) as GString ptr
declare function g_string_append cdecl alias "g_string_append" (byval string as GString ptr, byval val as gchar ptr) as GString ptr
declare function g_string_append_len cdecl alias "g_string_append_len" (byval string as GString ptr, byval val as gchar ptr, byval len as gssize) as GString ptr
...
declare function g_string_prepend cdecl alias "g_string_prepend" (byval string as GString ptr, byval val as gchar ptr) as GString ptr
...
declare function g_string_prepend_len cdecl alias "g_string_prepend_len" (byval string as GString ptr, byval val as gchar ptr, byval len as gssize) as GString ptr
declare function g_string_insert cdecl alias "g_string_insert" (byval string as GString ptr, byval pos as gssize, byval val as gchar ptr) as GString ptr
...
declare sub g_string_printf cdecl alias "g_string_printf" (byval string as GString ptr, byval format as gchar ptr, ...)
declare sub g_string_append_printf cdecl alias "g_string_append_printf" (byval string as GString ptr, byval format as gchar ptr, ...)
