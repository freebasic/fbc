...
declare sub gtk_window_set_title cdecl alias "gtk_window_set_title" (byval window as GtkWindow ptr, byval title as zstring ptr)
declare function gtk_window_get_title cdecl alias "gtk_window_get_title" (byval window as GtkWindow ptr) as zstring ptr
declare sub gtk_window_set_wmclass cdecl alias "gtk_window_set_wmclass" (byval window as GtkWindow ptr, byval wmclass_name as zstring ptr, byval wmclass_class as zstring ptr)
declare sub gtk_window_set_role cdecl alias "gtk_window_set_role" (byval window as GtkWindow ptr, byval role as zstring ptr)
...
declare sub gtk_window_set_icon_name cdecl alias "gtk_window_set_icon_name" (byval window as GtkWindow ptr, byval name as zstring ptr)
declare function gtk_window_set_icon_from_file cdecl alias "gtk_window_set_icon_from_file" (byval window as GtkWindow ptr, byval filename as zstring ptr, byval err as GError ptr ptr) as gboolean
...
declare sub gtk_window_set_default_icon_name cdecl alias "gtk_window_set_default_icon_name" (byval name as zstring ptr)
declare function gtk_window_set_default_icon_from_file cdecl alias "gtk_window_set_default_icon_from_file" (byval filename as zstring ptr, byval err as GError ptr ptr) as gboolean
...
declare function gtk_window_parse_geometry cdecl alias "gtk_window_parse_geometry" (byval window as GtkWindow ptr, byval geometry as zstring ptr) as gboolean
