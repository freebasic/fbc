...
declare function gtk_text_tag_table_lookup cdecl alias "gtk_text_tag_table_lookup" (byval table as GtkTextTagTable ptr, byval name as gchar ptr) as GtkTextTag ptr
