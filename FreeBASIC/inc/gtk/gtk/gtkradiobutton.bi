...
declare function gtk_radio_button_new_with_label cdecl alias "gtk_radio_button_new_with_label" (byval group as GSList ptr, byval label as string) as GtkWidget ptr
declare function gtk_radio_button_new_with_label_from_widget cdecl alias "gtk_radio_button_new_with_label_from_widget" (byval group as GtkRadioButton ptr, byval label as string) as GtkWidget ptr
declare function gtk_radio_button_new_with_mnemonic cdecl alias "gtk_radio_button_new_with_mnemonic" (byval group as GSList ptr, byval label as string) as GtkWidget ptr
declare function gtk_radio_button_new_with_mnemonic_from_widget cdecl alias "gtk_radio_button_new_with_mnemonic_from_widget" (byval group as GtkRadioButton ptr, byval label as string) as GtkWidget ptr
