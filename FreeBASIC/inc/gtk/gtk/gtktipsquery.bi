...
type _GtkTipsQueryClass
	...
	widget_entered as sub cdecl(byval as GtkTipsQuery ptr, byval as GtkWidget ptr, byval as string, byval as string)
	widget_selected as function cdecl(byval as GtkTipsQuery ptr, byval as GtkWidget ptr, byval as string, byval as string, byval as GdkEventButton ptr) as gint
...
declare sub gtk_tips_query_set_labels cdecl alias "gtk_tips_query_set_labels" (byval tips_query as GtkTipsQuery ptr, byval label_inactive as string, byval label_no_tip as string)
