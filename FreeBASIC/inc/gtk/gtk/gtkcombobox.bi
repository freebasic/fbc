...
declare sub gtk_combo_box_append_text cdecl alias "gtk_combo_box_append_text" (byval combo_box as GtkComboBox ptr, byval text as gchar ptr)
declare sub gtk_combo_box_insert_text cdecl alias "gtk_combo_box_insert_text" (byval combo_box as GtkComboBox ptr, byval position as gint, byval text as gchar ptr)
declare sub gtk_combo_box_prepend_text cdecl alias "gtk_combo_box_prepend_text" (byval combo_box as GtkComboBox ptr, byval text as gchar ptr)
...
declare function gtk_combo_box_get_active_text cdecl alias "gtk_combo_box_get_active_text" (byval combo_box as GtkComboBox ptr) as gchar ptr
