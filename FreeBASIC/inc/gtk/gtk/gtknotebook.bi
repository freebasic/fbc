...
declare sub gtk_notebook_set_tab_label_text cdecl alias "gtk_notebook_set_tab_label_text" (byval notebook as GtkNotebook ptr, byval child as GtkWidget ptr, byval tab_text as gchar ptr)
declare function gtk_notebook_get_tab_label_text cdecl alias "gtk_notebook_get_tab_label_text" (byval notebook as GtkNotebook ptr, byval child as GtkWidget ptr) as gchar ptr
...
declare sub gtk_notebook_set_menu_label_text cdecl alias "gtk_notebook_set_menu_label_text" (byval notebook as GtkNotebook ptr, byval child as GtkWidget ptr, byval menu_text as gchar ptr)
declare function gtk_notebook_get_menu_label_text cdecl alias "gtk_notebook_get_menu_label_text" (byval notebook as GtkNotebook ptr, byval child as GtkWidget ptr) as gchar ptr
