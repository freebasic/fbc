...
type _GtkActionGroupClass
	...
	get_action as function cdecl(byval as GtkActionGroup ptr, byval as gchar ptr) as GtkAction
...
declare function gtk_action_group_new cdecl alias "gtk_action_group_new" (byval name as gchar ptr) as GtkActionGroup ptr
declare function gtk_action_group_get_name cdecl alias "gtk_action_group_get_name" (byval action_group as GtkActionGroup ptr) as gchar ptr
...
declare function gtk_action_group_get_action cdecl alias "gtk_action_group_get_action" (byval action_group as GtkActionGroup ptr, byval action_name as gchar ptr) as GtkAction ptr
...
declare sub gtk_action_group_add_action_with_accel cdecl alias "gtk_action_group_add_action_with_accel" (byval action_group as GtkActionGroup ptr, byval action as GtkAction ptr, byval accelerator as gchar ptr)
...
declare sub gtk_action_group_add_radio_actions cdecl alias "gtk_action_group_add_radio_actions" (byval action_group as GtkActionGroup ptr, byval entries as GtkRadioActionEntry ptr, byval n_entries as guint, byval value as gint, byval on_change as GCallback, byval user_data as gpointer)
declare sub gtk_action_group_add_actions_full cdecl alias "gtk_action_group_add_actions_full" (byval action_group as GtkActionGroup ptr, byval entries as GtkActionEntry ptr, byval n_entries as guint, byval user_data as gpointer, byval destroy as GDestroyNotify)
...
declare sub gtk_action_group_set_translation_domain cdecl alias "gtk_action_group_set_translation_domain" (byval action_group as GtkActionGroup ptr, byval domain as gchar ptr)
declare function gtk_action_group_translate_string cdecl alias "gtk_action_group_translate_string" (byval action_group as GtkActionGroup ptr, byval string as gchar ptr) as gchar ptr
...
declare sub _gtk_action_group_emit_post_activate cdecl alias "_gtk_action_group_emit_post_activate" (byval action_group as GtkActionGroup ptr, byval action as GtkAction ptr)
