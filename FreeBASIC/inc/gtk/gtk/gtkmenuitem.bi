...
declare function gtk_menu_item_new_with_label cdecl alias "gtk_menu_item_new_with_label" (byval label as gchar ptr) as GtkWidget ptr
declare function gtk_menu_item_new_with_mnemonic cdecl alias "gtk_menu_item_new_with_mnemonic" (byval label as gchar ptr) as GtkWidget ptr
...
declare sub gtk_menu_item_select cdecl alias "gtk_menu_item_select" (byval menu_item as GtkMenuItem ptr)
declare sub gtk_menu_item_deselect cdecl alias "gtk_menu_item_deselect" (byval menu_item as GtkMenuItem ptr)
declare sub gtk_menu_item_activate cdecl alias "gtk_menu_item_activate" (byval menu_item as GtkMenuItem ptr)
declare sub gtk_menu_item_toggle_size_request cdecl alias "gtk_menu_item_toggle_size_request" (byval menu_item as GtkMenuItem ptr, byval requisition as gint ptr)
...
declare sub gtk_menu_item_set_accel_path cdecl alias "gtk_menu_item_set_accel_path" (byval menu_item as GtkMenuItem ptr, byval accel_path as gchar ptr)
declare sub _gtk_menu_item_refresh_accel_path cdecl alias "_gtk_menu_item_refresh_accel_path" (byval menu_item as GtkMenuItem ptr, byval prefix as gchar ptr, byval accel_group as GtkAccelGroup ptr, byval group_changed as gboolean)
