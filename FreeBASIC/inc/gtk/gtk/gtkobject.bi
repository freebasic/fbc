...
declare function gtk_object_new cdecl alias "gtk_object_new" (byval type as GtkType, byval first_property_name as gchar ptr, ...) as GtkObject ptr
...
declare sub gtk_object_set_data cdecl alias "gtk_object_set_data" (byval object as GtkObject ptr, byval key as gchar ptr, byval data as gpointer)
declare sub gtk_object_set_data_full cdecl alias "gtk_object_set_data_full" (byval object as GtkObject ptr, byval key as gchar ptr, byval data as gpointer, byval destroy as GtkDestroyNotify)
declare sub gtk_object_remove_data cdecl alias "gtk_object_remove_data" (byval object as GtkObject ptr, byval key as gchar ptr)
declare function gtk_object_get_data cdecl alias "gtk_object_get_data" (byval object as GtkObject ptr, byval key as gchar ptr) as gpointer
declare sub gtk_object_remove_no_notify cdecl alias "gtk_object_remove_no_notify" (byval object as GtkObject ptr, byval key as gchar ptr)
...
declare sub gtk_object_get cdecl alias "gtk_object_get" (byval object as GtkObject ptr, byval first_property_name as gchar ptr, ...)
declare sub gtk_object_set cdecl alias "gtk_object_set" (byval object as GtkObject ptr, byval first_property_name as gchar ptr, ...)
declare sub gtk_object_add_arg_type cdecl alias "gtk_object_add_arg_type" (byval arg_name as gchar ptr, byval arg_type as GtkType, byval arg_flags as guint, byval arg_id as guint)
