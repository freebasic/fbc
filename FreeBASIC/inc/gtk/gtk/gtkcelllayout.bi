...
declare sub gtk_cell_layout_add_attribute cdecl alias "gtk_cell_layout_add_attribute" (byval cell_layout as GtkCellLayout ptr, byval cell as GtkCellRenderer ptr, byval attribute as zstring ptr, byval column as gint)
