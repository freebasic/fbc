...
type _GtkEditableClass
	...
	insert_text as sub cdecl(byval as GtkEditable ptr, byval as gchar ptr, byval as gint, byval as gint ptr)
	...
	do_insert_text as sub cdecl(byval as GtkEditable ptr, byval as gchar ptr, byval as gint, byval as gint ptr)
...
declare sub gtk_editable_insert_text cdecl alias "gtk_editable_insert_text" (byval editable as GtkEditable ptr, byval new_text as gchar ptr, byval new_text_length as gint, byval position as gint ptr)
...
declare function gtk_editable_get_chars cdecl alias "gtk_editable_get_chars" (byval editable as GtkEditable ptr, byval start_pos as gint, byval end_pos as gint) as gchar ptr
declare sub gtk_editable_cut_clipboard cdecl alias "gtk_editable_cut_clipboard" (byval editable as GtkEditable ptr)
declare sub gtk_editable_copy_clipboard cdecl alias "gtk_editable_copy_clipboard" (byval editable as GtkEditable ptr)
declare sub gtk_editable_paste_clipboard cdecl alias "gtk_editable_paste_clipboard" (byval editable as GtkEditable ptr)
declare sub gtk_editable_delete_selection cdecl alias "gtk_editable_delete_selection" (byval editable as GtkEditable ptr)
declare sub gtk_editable_set_position cdecl alias "gtk_editable_set_position" (byval editable as GtkEditable ptr, byval position as gint)
declare function gtk_editable_get_position cdecl alias "gtk_editable_get_position" (byval editable as GtkEditable ptr) as gint
declare sub gtk_editable_set_editable cdecl alias "gtk_editable_set_editable" (byval editable as GtkEditable ptr, byval is_editable as gboolean)
declare function gtk_editable_get_editable cdecl alias "gtk_editable_get_editable" (byval editable as GtkEditable ptr) as gboolean
