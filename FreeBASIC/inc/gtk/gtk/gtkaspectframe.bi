...
declare function gtk_aspect_frame_new cdecl alias "gtk_aspect_frame_new" (byval label as gchar ptr, byval xalign as gfloat, byval yalign as gfloat, byval ratio as gfloat, byval obey_child as gboolean) as GtkWidget ptr
