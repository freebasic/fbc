...
declare function gtk_file_chooser_dialog_new cdecl alias "gtk_file_chooser_dialog_new" (byval title as gchar ptr, byval parent as GtkWindow ptr, byval action as GtkFileChooserAction, byval first_button_text as gchar ptr, ...) as GtkWidget ptr
declare function gtk_file_chooser_dialog_new_with_backend cdecl alias "gtk_file_chooser_dialog_new_with_backend" (byval title as gchar ptr, byval parent as GtkWindow ptr, byval action as GtkFileChooserAction, byval backend as gchar ptr, byval first_button_text as gchar ptr, ...) as GtkWidget ptr
