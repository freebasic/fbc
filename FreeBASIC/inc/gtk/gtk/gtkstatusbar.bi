...
type _GtkStatusbarClass
	...
	text_pushed as sub cdecl(byval as GtkStatusbar ptr, byval as guint, byval as gchar ptr)
	text_popped as sub cdecl(byval as GtkStatusbar ptr, byval as guint, byval as gchar ptr)
...
declare function gtk_statusbar_get_context_id cdecl alias "gtk_statusbar_get_context_id" (byval statusbar as GtkStatusbar ptr, byval context_description as gchar ptr) as guint
declare function gtk_statusbar_push cdecl alias "gtk_statusbar_push" (byval statusbar as GtkStatusbar ptr, byval context_id as guint, byval text as gchar ptr) as guint
