...
declare function gtk_font_selection_get_font_name cdecl alias "gtk_font_selection_get_font_name" (byval fontsel as GtkFontSelection ptr) as gchar ptr
...
declare function gtk_font_selection_set_font_name cdecl alias "gtk_font_selection_set_font_name" (byval fontsel as GtkFontSelection ptr, byval fontname as gchar ptr) as gboolean
declare function gtk_font_selection_get_preview_text cdecl alias "gtk_font_selection_get_preview_text" (byval fontsel as GtkFontSelection ptr) as gchar ptr
declare sub gtk_font_selection_set_preview_text cdecl alias "gtk_font_selection_set_preview_text" (byval fontsel as GtkFontSelection ptr, byval text as gchar ptr)
declare function gtk_font_selection_dialog_get_type cdecl alias "gtk_font_selection_dialog_get_type" () as GType
declare function gtk_font_selection_dialog_new cdecl alias "gtk_font_selection_dialog_new" (byval title as gchar ptr) as GtkWidget ptr
declare function gtk_font_selection_dialog_get_font_name cdecl alias "gtk_font_selection_dialog_get_font_name" (byval fsd as GtkFontSelectionDialog ptr) as gchar ptr
...
declare function gtk_font_selection_dialog_set_font_name cdecl alias "gtk_font_selection_dialog_set_font_name" (byval fsd as GtkFontSelectionDialog ptr, byval fontname as gchar ptr) as gboolean
declare function gtk_font_selection_dialog_get_preview_text cdecl alias "gtk_font_selection_dialog_get_preview_text" (byval fsd as GtkFontSelectionDialog ptr) as gchar ptr
declare sub gtk_font_selection_dialog_set_preview_text cdecl alias "gtk_font_selection_dialog_set_preview_text" (byval fsd as GtkFontSelectionDialog ptr, byval text as gchar ptr)
