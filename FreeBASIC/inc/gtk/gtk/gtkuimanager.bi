...
type _GtkUIManagerClass
	...
	get_widget as function cdecl(byval as GtkUIManager ptr, byval as gchar ptr) as GtkWidget
	get_action as function cdecl(byval as GtkUIManager ptr, byval as gchar ptr) as GtkAction
...
declare function gtk_ui_manager_get_widget cdecl alias "gtk_ui_manager_get_widget" (byval self as GtkUIManager ptr, byval path as gchar ptr) as GtkWidget ptr
...
declare function gtk_ui_manager_get_action cdecl alias "gtk_ui_manager_get_action" (byval self as GtkUIManager ptr, byval path as gchar ptr) as GtkAction ptr
declare function gtk_ui_manager_add_ui_from_string cdecl alias "gtk_ui_manager_add_ui_from_string" (byval self as GtkUIManager ptr, byval buffer as gchar ptr, byval length as gssize, byval error as GError ptr ptr) as guint
declare function gtk_ui_manager_add_ui_from_file cdecl alias "gtk_ui_manager_add_ui_from_file" (byval self as GtkUIManager ptr, byval filename as gchar ptr, byval error as GError ptr ptr) as guint
declare sub gtk_ui_manager_add_ui cdecl alias "gtk_ui_manager_add_ui" (byval self as GtkUIManager ptr, byval merge_id as guint, byval path as gchar ptr, byval name as gchar ptr, byval action as gchar ptr, byval type as GtkUIManagerItemType, byval top as gboolean)
...
declare function gtk_ui_manager_get_ui cdecl alias "gtk_ui_manager_get_ui" (byval self as GtkUIManager ptr) as gchar ptr
