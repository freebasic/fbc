...
type _GtkStyleClass
	...
	render_icon as function cdecl(byval as GtkStyle ptr, byval as GtkIconSource ptr, byval as GtkTextDirection, byval as GtkStateType, byval as GtkIconSize, byval as GtkWidget ptr, byval as string) as GdkPixbuf ptr
	draw_hline as sub cdecl(byval as GtkStyle ptr, byval as GdkWindow ptr, byval as GtkStateType, byval as GdkRectangle ptr, byval as GtkWidget ptr, byval as string, byval as gint, byval as gint, byval as gint)
	draw_vline as sub cdecl(byval as GtkStyle ptr, byval as GdkWindow ptr, byval as GtkStateType, byval as GdkRectangle ptr, byval as GtkWidget ptr, byval as string, byval as gint, byval as gint, byval as gint)
	draw_shadow as sub cdecl(byval as GtkStyle ptr, byval as GdkWindow ptr, byval as GtkStateType, byval as GtkShadowType, byval as GdkRectangle ptr, byval as GtkWidget ptr, byval as string, byval as gint, byval as gint, byval as gint, byval as gint)
	draw_polygon as sub cdecl(byval as GtkStyle ptr, byval as GdkWindow ptr, byval as GtkStateType, byval as GtkShadowType, byval as GdkRectangle ptr, byval as GtkWidget ptr, byval as string, byval as GdkPoint ptr, byval as gint, byval as gboolean)
	draw_arrow as sub cdecl(byval as GtkStyle ptr, byval as GdkWindow ptr, byval as GtkStateType, byval as GtkShadowType, byval as GdkRectangle ptr, byval as GtkWidget ptr, byval as string, byval as GtkArrowType, byval as gboolean, byval as gint, byval as gint, byval as gint, byval as gint)
	draw_diamond as sub cdecl(byval as GtkStyle ptr, byval as GdkWindow ptr, byval as GtkStateType, byval as GtkShadowType, byval as GdkRectangle ptr, byval as GtkWidget ptr, byval as string, byval as gint, byval as gint, byval as gint, byval as gint)
	draw_string as sub cdecl(byval as GtkStyle ptr, byval as GdkWindow ptr, byval as GtkStateType, byval as GdkRectangle ptr, byval as GtkWidget ptr, byval as string, byval as gint, byval as gint, byval as string)
	draw_box as sub cdecl(byval as GtkStyle ptr, byval as GdkWindow ptr, byval as GtkStateType, byval as GtkShadowType, byval as GdkRectangle ptr, byval as GtkWidget ptr, byval as string, byval as gint, byval as gint, byval as gint, byval as gint)
	draw_flat_box as sub cdecl(byval as GtkStyle ptr, byval as GdkWindow ptr, byval as GtkStateType, byval as GtkShadowType, byval as GdkRectangle ptr, byval as GtkWidget ptr, byval as string, byval as gint, byval as gint, byval as gint, byval as gint)
	draw_check as sub cdecl(byval as GtkStyle ptr, byval as GdkWindow ptr, byval as GtkStateType, byval as GtkShadowType, byval as GdkRectangle ptr, byval as GtkWidget ptr, byval as string, byval as gint, byval as gint, byval as gint, byval as gint)
	draw_option as sub cdecl(byval as GtkStyle ptr, byval as GdkWindow ptr, byval as GtkStateType, byval as GtkShadowType, byval as GdkRectangle ptr, byval as GtkWidget ptr, byval as string, byval as gint, byval as gint, byval as gint, byval as gint)
	draw_tab as sub cdecl(byval as GtkStyle ptr, byval as GdkWindow ptr, byval as GtkStateType, byval as GtkShadowType, byval as GdkRectangle ptr, byval as GtkWidget ptr, byval as string, byval as gint, byval as gint, byval as gint, byval as gint)
	draw_shadow_gap as sub cdecl(byval as GtkStyle ptr, byval as GdkWindow ptr, byval as GtkStateType, byval as GtkShadowType, byval as GdkRectangle ptr, byval as GtkWidget ptr, byval as string, byval as gint, byval as gint, byval as gint, byval as gint, byval as GtkPositionType, byval as gint, byval as gint)
	draw_box_gap as sub cdecl(byval as GtkStyle ptr, byval as GdkWindow ptr, byval as GtkStateType, byval as GtkShadowType, byval as GdkRectangle ptr, byval as GtkWidget ptr, byval as string, byval as gint, byval as gint, byval as gint, byval as gint, byval as GtkPositionType, byval as gint, byval as gint)
	draw_extension as sub cdecl(byval as GtkStyle ptr, byval as GdkWindow ptr, byval as GtkStateType, byval as GtkShadowType, byval as GdkRectangle ptr, byval as GtkWidget ptr, byval as string, byval as gint, byval as gint, byval as gint, byval as gint, byval as GtkPositionType)
	draw_focus as sub cdecl(byval as GtkStyle ptr, byval as GdkWindow ptr, byval as GtkStateType, byval as GdkRectangle ptr, byval as GtkWidget ptr, byval as string, byval as gint, byval as gint, byval as gint, byval as gint)
	draw_slider as sub cdecl(byval as GtkStyle ptr, byval as GdkWindow ptr, byval as GtkStateType, byval as GtkShadowType, byval as GdkRectangle ptr, byval as GtkWidget ptr, byval as string, byval as gint, byval as gint, byval as gint, byval as gint, byval as GtkOrientation)
	draw_handle as sub cdecl(byval as GtkStyle ptr, byval as GdkWindow ptr, byval as GtkStateType, byval as GtkShadowType, byval as GdkRectangle ptr, byval as GtkWidget ptr, byval as string, byval as gint, byval as gint, byval as gint, byval as gint, byval as GtkOrientation)
	draw_expander as sub cdecl(byval as GtkStyle ptr, byval as GdkWindow ptr, byval as GtkStateType, byval as GdkRectangle ptr, byval as GtkWidget ptr, byval as string, byval as gint, byval as gint, byval as GtkExpanderStyle)
	draw_layout as sub cdecl(byval as GtkStyle ptr, byval as GdkWindow ptr, byval as GtkStateType, byval as gboolean, byval as GdkRectangle ptr, byval as GtkWidget ptr, byval as string, byval as gint, byval as gint, byval as PangoLayout ptr)
	draw_resize_grip as sub cdecl(byval as GtkStyle ptr, byval as GdkWindow ptr, byval as GtkStateType, byval as GdkRectangle ptr, byval as GtkWidget ptr, byval as string, byval as GdkWindowEdge, byval as gint, byval as gint, byval as gint, byval as gint)
...
declare function gtk_style_lookup_icon_set cdecl alias "gtk_style_lookup_icon_set" (byval style as GtkStyle ptr, byval stock_id as string) as GtkIconSet ptr
declare function gtk_style_render_icon cdecl alias "gtk_style_render_icon" (byval style as GtkStyle ptr, byval source as GtkIconSource ptr, byval direction as GtkTextDirection, byval state as GtkStateType, byval size as GtkIconSize, byval widget as GtkWidget ptr, byval detail as string) as GdkPixbuf ptr
...
declare sub gtk_paint_hline cdecl alias "gtk_paint_hline" (byval style as GtkStyle ptr, byval window as GdkWindow ptr, byval state_type as GtkStateType, byval area as GdkRectangle ptr, byval widget as GtkWidget ptr, byval detail as string, byval x1 as gint, byval x2 as gint, byval y as gint)
declare sub gtk_paint_vline cdecl alias "gtk_paint_vline" (byval style as GtkStyle ptr, byval window as GdkWindow ptr, byval state_type as GtkStateType, byval area as GdkRectangle ptr, byval widget as GtkWidget ptr, byval detail as string, byval y1_ as gint, byval y2_ as gint, byval x as gint)
declare sub gtk_paint_shadow cdecl alias "gtk_paint_shadow" (byval style as GtkStyle ptr, byval window as GdkWindow ptr, byval state_type as GtkStateType, byval shadow_type as GtkShadowType, byval area as GdkRectangle ptr, byval widget as GtkWidget ptr, byval detail as string, byval x as gint, byval y as gint, byval width as gint, byval height as gint)
declare sub gtk_paint_polygon cdecl alias "gtk_paint_polygon" (byval style as GtkStyle ptr, byval window as GdkWindow ptr, byval state_type as GtkStateType, byval shadow_type as GtkShadowType, byval area as GdkRectangle ptr, byval widget as GtkWidget ptr, byval detail as string, byval points as GdkPoint ptr, byval npoints as gint, byval fill as gboolean)
declare sub gtk_paint_arrow cdecl alias "gtk_paint_arrow" (byval style as GtkStyle ptr, byval window as GdkWindow ptr, byval state_type as GtkStateType, byval shadow_type as GtkShadowType, byval area as GdkRectangle ptr, byval widget as GtkWidget ptr, byval detail as string, byval arrow_type as GtkArrowType, byval fill as gboolean, byval x as gint, byval y as gint, byval width as gint, byval height as gint)
...
declare sub gtk_paint_shadow_gap cdecl alias "gtk_paint_shadow_gap" (byval style as GtkStyle ptr, byval window as GdkWindow ptr, byval state_type as GtkStateType, byval shadow_type as GtkShadowType, byval area as GdkRectangle ptr, byval widget as GtkWidget ptr, byval detail as string, byval x as gint, byval y as gint, byval width as gint, byval height as gint, byval gap_side as GtkPositionType, byval gap_x as gint, byval gap_width as gint)
declare sub gtk_paint_box_gap cdecl alias "gtk_paint_box_gap" (byval style as GtkStyle ptr, byval window as GdkWindow ptr, byval state_type as GtkStateType, byval shadow_type as GtkShadowType, byval area as GdkRectangle ptr, byval widget as GtkWidget ptr, byval detail as string, byval x as gint, byval y as gint, byval width as gint, byval height as gint, byval gap_side as GtkPositionType, byval gap_x as gint, byval gap_width as gint)
declare sub gtk_paint_extension cdecl alias "gtk_paint_extension" (byval style as GtkStyle ptr, byval window as GdkWindow ptr, byval state_type as GtkStateType, byval shadow_type as GtkShadowType, byval area as GdkRectangle ptr, byval widget as GtkWidget ptr, byval detail as string, byval x as gint, byval y as gint, byval width as gint, byval height as gint, byval gap_side as GtkPositionType)
declare sub gtk_paint_focus cdecl alias "gtk_paint_focus" (byval style as GtkStyle ptr, byval window as GdkWindow ptr, byval state_type as GtkStateType, byval area as GdkRectangle ptr, byval widget as GtkWidget ptr, byval detail as string, byval x as gint, byval y as gint, byval width as gint, byval height as gint)
declare sub gtk_paint_slider cdecl alias "gtk_paint_slider" (byval style as GtkStyle ptr, byval window as GdkWindow ptr, byval state_type as GtkStateType, byval shadow_type as GtkShadowType, byval area as GdkRectangle ptr, byval widget as GtkWidget ptr, byval detail as string, byval x as gint, byval y as gint, byval width as gint, byval height as gint, byval orientation as GtkOrientation)
declare sub gtk_paint_handle cdecl alias "gtk_paint_handle" (byval style as GtkStyle ptr, byval window as GdkWindow ptr, byval state_type as GtkStateType, byval shadow_type as GtkShadowType, byval area as GdkRectangle ptr, byval widget as GtkWidget ptr, byval detail as string, byval x as gint, byval y as gint, byval width as gint, byval height as gint, byval orientation as GtkOrientation)
declare sub gtk_paint_expander cdecl alias "gtk_paint_expander" (byval style as GtkStyle ptr, byval window as GdkWindow ptr, byval state_type as GtkStateType, byval area as GdkRectangle ptr, byval widget as GtkWidget ptr, byval detail as string, byval x as gint, byval y as gint, byval expander_style as GtkExpanderStyle)
declare sub gtk_paint_layout cdecl alias "gtk_paint_layout" (byval style as GtkStyle ptr, byval window as GdkWindow ptr, byval state_type as GtkStateType, byval use_text as gboolean, byval area as GdkRectangle ptr, byval widget as GtkWidget ptr, byval detail as string, byval x as gint, byval y as gint, byval layout as PangoLayout ptr)
declare sub gtk_paint_resize_grip cdecl alias "gtk_paint_resize_grip" (byval style as GtkStyle ptr, byval window as GdkWindow ptr, byval state_type as GtkStateType, byval area as GdkRectangle ptr, byval widget as GtkWidget ptr, byval detail as string, byval edge as GdkWindowEdge, byval x as gint, byval y as gint, byval width as gint, byval height as gint)
...
declare sub gtk_draw_string cdecl alias "gtk_draw_string" (byval style as GtkStyle ptr, byval window as GdkWindow ptr, byval state_type as GtkStateType, byval x as gint, byval y as gint, byval string as string)
declare sub gtk_paint_string cdecl alias "gtk_paint_string" (byval style as GtkStyle ptr, byval window as GdkWindow ptr, byval state_type as GtkStateType, byval area as GdkRectangle ptr, byval widget as GtkWidget ptr, byval detail as string, byval x as gint, byval y as gint, byval string as string)
