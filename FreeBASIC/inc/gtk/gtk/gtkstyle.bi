...
declare function gtk_style_lookup_icon_set cdecl alias "gtk_style_lookup_icon_set" (byval style as GtkStyle ptr, byval stock_id as zstring ptr) as GtkIconSet ptr
declare function gtk_style_render_icon cdecl alias "gtk_style_render_icon" (byval style as GtkStyle ptr, byval source as GtkIconSource ptr, byval direction as GtkTextDirection, byval state as GtkStateType, byval size as GtkIconSize, byval widget as GtkWidget ptr, byval detail as zstring ptr) as GdkPixbuf ptr
...
declare sub gtk_paint_hline cdecl alias "gtk_paint_hline" (byval style as GtkStyle ptr, byval window as GdkWindow ptr, byval state_type as GtkStateType, byval area as GdkRectangle ptr, byval widget as GtkWidget ptr, byval detail as zstring ptr, byval x1 as gint, byval x2 as gint, byval y as gint)
declare sub gtk_paint_vline cdecl alias "gtk_paint_vline" (byval style as GtkStyle ptr, byval window as GdkWindow ptr, byval state_type as GtkStateType, byval area as GdkRectangle ptr, byval widget as GtkWidget ptr, byval detail as zstring ptr, byval y1_ as gint, byval y2_ as gint, byval x as gint)
...
declare sub gtk_paint_focus cdecl alias "gtk_paint_focus" (byval style as GtkStyle ptr, byval window as GdkWindow ptr, byval state_type as GtkStateType, byval area as GdkRectangle ptr, byval widget as GtkWidget ptr, byval detail as zstring ptr, byval x as gint, byval y as gint, byval width as gint, byval height as gint)
...
declare sub gtk_paint_expander cdecl alias "gtk_paint_expander" (byval style as GtkStyle ptr, byval window as GdkWindow ptr, byval state_type as GtkStateType, byval area as GdkRectangle ptr, byval widget as GtkWidget ptr, byval detail as zstring ptr, byval x as gint, byval y as gint, byval expander_style as GtkExpanderStyle)
declare sub gtk_paint_layout cdecl alias "gtk_paint_layout" (byval style as GtkStyle ptr, byval window as GdkWindow ptr, byval state_type as GtkStateType, byval use_text as gboolean, byval area as GdkRectangle ptr, byval widget as GtkWidget ptr, byval detail as zstring ptr, byval x as gint, byval y as gint, byval layout as PangoLayout ptr)
...
declare sub gtk_draw_string cdecl alias "gtk_draw_string" (byval style as GtkStyle ptr, byval window as GdkWindow ptr, byval state_type as GtkStateType, byval x as gint, byval y as gint, byval string as zstring ptr)
