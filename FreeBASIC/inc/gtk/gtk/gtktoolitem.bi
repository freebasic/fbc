...
type _GtkToolItemClass
	...
	set_tooltip as function cdecl(byval as GtkToolItem ptr, byval as GtkTooltips ptr, byval as string, byval as string) as gboolean
...
declare sub gtk_tool_item_set_tooltip cdecl alias "gtk_tool_item_set_tooltip" (byval tool_item as GtkToolItem ptr, byval tooltips as GtkTooltips ptr, byval tip_text as string, byval tip_private as string)
...
declare function gtk_tool_item_get_proxy_menu_item cdecl alias "gtk_tool_item_get_proxy_menu_item" (byval tool_item as GtkToolItem ptr, byval menu_item_id as string) as GtkWidget ptr
declare sub gtk_tool_item_set_proxy_menu_item cdecl alias "gtk_tool_item_set_proxy_menu_item" (byval tool_item as GtkToolItem ptr, byval menu_item_id as string, byval menu_item as GtkWidget ptr)
