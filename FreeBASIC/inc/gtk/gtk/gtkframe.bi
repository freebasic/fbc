...
declare function gtk_frame_new cdecl alias "gtk_frame_new" (byval label as zstring ptr) as GtkWidget ptr
declare sub gtk_frame_set_label cdecl alias "gtk_frame_set_label" (byval frame as GtkFrame ptr, byval label as zstring ptr)
