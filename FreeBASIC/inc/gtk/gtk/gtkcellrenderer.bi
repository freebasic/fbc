...
type _GtkCellRendererClass
	...
	activate as function cdecl(byval as GtkCellRenderer ptr, byval as GdkEvent ptr, byval as GtkWidget ptr, byval as gchar ptr, byval as GdkRectangle ptr, byval as GdkRectangle ptr, byval as GtkCellRendererState) as gboolean
	start_editing as function cdecl(byval as GtkCellRenderer ptr, byval as GdkEvent ptr, byval as GtkWidget ptr, byval as gchar ptr, byval as GdkRectangle ptr, byval as GdkRectangle ptr, byval as GtkCellRendererState) as GtkCellEditable ptr
	editing_canceled as sub cdecl(byval as GtkCellRenderer ptr)
	editing_started as sub cdecl(byval as GtkCellRenderer ptr, byval as GtkCellEditable ptr, byval as gchar ptr)
...
declare function gtk_cell_renderer_activate cdecl alias "gtk_cell_renderer_activate" (byval cell as GtkCellRenderer ptr, byval event as GdkEvent ptr, byval widget as GtkWidget ptr, byval path as gchar ptr, byval background_area as GdkRectangle ptr, byval cell_area as GdkRectangle ptr, byval flags as GtkCellRendererState) as gboolean
declare function gtk_cell_renderer_start_editing cdecl alias "gtk_cell_renderer_start_editing" (byval cell as GtkCellRenderer ptr, byval event as GdkEvent ptr, byval widget as GtkWidget ptr, byval path as gchar ptr, byval background_area as GdkRectangle ptr, byval cell_area as GdkRectangle ptr, byval flags as GtkCellRendererState) as GtkCellEditable ptr
