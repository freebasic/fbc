...
type _GtkIMContextClass
	...
	commit as sub cdecl(byval as GtkIMContext ptr, byval as gchar ptr)
	...
	set_surrounding as sub cdecl(byval as GtkIMContext ptr, byval as gchar ptr, byval as gint, byval as gint)
...
declare sub gtk_im_context_get_preedit_string cdecl alias "gtk_im_context_get_preedit_string" (byval context as GtkIMContext ptr, byval str as gchar ptr ptr, byval attrs as PangoAttrList ptr ptr, byval cursor_pos as gint ptr)
...
declare sub gtk_im_context_set_surrounding cdecl alias "gtk_im_context_set_surrounding" (byval context as GtkIMContext ptr, byval text as gchar ptr, byval len as gint, byval cursor_index as gint)
declare function gtk_im_context_get_surrounding cdecl alias "gtk_im_context_get_surrounding" (byval context as GtkIMContext ptr, byval text as gchar ptr ptr, byval cursor_index as gint ptr) as gboolean
