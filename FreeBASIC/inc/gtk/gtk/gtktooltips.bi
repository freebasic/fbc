...
declare sub gtk_tooltips_set_tip cdecl alias "gtk_tooltips_set_tip" (byval tooltips as GtkTooltips ptr, byval widget as GtkWidget ptr, byval tip_text as gchar ptr, byval tip_private as gchar ptr)
