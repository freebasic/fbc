...
declare sub gtk_icon_theme_set_search_path cdecl alias "gtk_icon_theme_set_search_path" (byval icon_theme as GtkIconTheme ptr, byval path as gchar ptr ptr, byval n_elements as gint)
declare sub gtk_icon_theme_get_search_path cdecl alias "gtk_icon_theme_get_search_path" (byval icon_theme as GtkIconTheme ptr, byval path as gchar ptr ptr ptr, byval n_elements as gint ptr)
declare sub gtk_icon_theme_append_search_path cdecl alias "gtk_icon_theme_append_search_path" (byval icon_theme as GtkIconTheme ptr, byval path as gchar ptr)
declare sub gtk_icon_theme_prepend_search_path cdecl alias "gtk_icon_theme_prepend_search_path" (byval icon_theme as GtkIconTheme ptr, byval path as gchar ptr)
declare sub gtk_icon_theme_set_custom_theme cdecl alias "gtk_icon_theme_set_custom_theme" (byval icon_theme as GtkIconTheme ptr, byval theme_name as gchar ptr)
declare function gtk_icon_theme_has_icon cdecl alias "gtk_icon_theme_has_icon" (byval icon_theme as GtkIconTheme ptr, byval icon_name as gchar ptr) as gboolean
declare function gtk_icon_theme_get_icon_sizes cdecl alias "gtk_icon_theme_get_icon_sizes" (byval icon_theme as GtkIconTheme ptr, byval icon_name as gchar ptr) as gint ptr
declare function gtk_icon_theme_lookup_icon cdecl alias "gtk_icon_theme_lookup_icon" (byval icon_theme as GtkIconTheme ptr, byval icon_name as gchar ptr, byval size as gint, byval flags as GtkIconLookupFlags) as GtkIconInfo ptr
declare function gtk_icon_theme_load_icon cdecl alias "gtk_icon_theme_load_icon" (byval icon_theme as GtkIconTheme ptr, byval icon_name as gchar ptr, byval size as gint, byval flags as GtkIconLookupFlags, byval error as GError ptr ptr) as GdkPixbuf ptr
declare function gtk_icon_theme_list_icons cdecl alias "gtk_icon_theme_list_icons" (byval icon_theme as GtkIconTheme ptr, byval context as gchar ptr) as GList ptr
...
declare sub gtk_icon_theme_add_builtin_icon cdecl alias "gtk_icon_theme_add_builtin_icon" (byval icon_name as gchar ptr, byval size as gint, byval pixbuf as GdkPixbuf ptr)
...
declare function gtk_icon_info_get_filename cdecl alias "gtk_icon_info_get_filename" (byval icon_info as GtkIconInfo ptr) as gchar ptr
...
declare function gtk_icon_info_get_display_name cdecl alias "gtk_icon_info_get_display_name" (byval icon_info as GtkIconInfo ptr) as gchar ptr
