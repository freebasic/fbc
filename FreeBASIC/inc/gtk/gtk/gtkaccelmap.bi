...
declare sub gtk_accel_map_add_entry cdecl alias "gtk_accel_map_add_entry" (byval accel_path as zstring ptr, byval accel_key as guint, byval accel_mods as GdkModifierType)
declare function gtk_accel_map_lookup_entry cdecl alias "gtk_accel_map_lookup_entry" (byval accel_path as zstring ptr, byval key as GtkAccelKey ptr) as gboolean
declare function gtk_accel_map_change_entry cdecl alias "gtk_accel_map_change_entry" (byval accel_path as zstring ptr, byval accel_key as guint, byval accel_mods as GdkModifierType, byval replace as gboolean) as gboolean
declare sub gtk_accel_map_load cdecl alias "gtk_accel_map_load" (byval file_name as zstring ptr)
declare sub gtk_accel_map_save cdecl alias "gtk_accel_map_save" (byval file_name as zstring ptr)
...
declare sub gtk_accel_map_lock_path cdecl alias "gtk_accel_map_lock_path" (byval accel_path as zstring ptr)
declare sub gtk_accel_map_unlock_path cdecl alias "gtk_accel_map_unlock_path" (byval accel_path as zstring ptr)
declare sub gtk_accel_map_add_filter cdecl alias "gtk_accel_map_add_filter" (byval filter_pattern as zstring ptr)
...
declare sub _gtk_accel_map_add_group cdecl alias "_gtk_accel_map_add_group" (byval accel_path as zstring ptr, byval accel_group as GtkAccelGroup ptr)
declare sub _gtk_accel_map_remove_group cdecl alias "_gtk_accel_map_remove_group" (byval accel_path as zstring ptr, byval accel_group as GtkAccelGroup ptr)
declare function _gtk_accel_path_is_valid cdecl alias "_gtk_accel_path_is_valid" (byval accel_path as zstring ptr) as gboolean
