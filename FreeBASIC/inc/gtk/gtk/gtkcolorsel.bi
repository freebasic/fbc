...
declare function gtk_color_selection_get_type cdecl alias "gtk_color_selection_get_type" () as GType
declare function gtk_color_selection_new cdecl alias "gtk_color_selection_new" () as GtkWidget ptr
declare function gtk_color_selection_get_has_opacity_control cdecl alias "gtk_color_selection_get_has_opacity_control" (byval colorsel as GtkColorSelection ptr) as gboolean
declare sub gtk_color_selection_set_has_opacity_control cdecl alias "gtk_color_selection_set_has_opacity_control" (byval colorsel as GtkColorSelection ptr, byval has_opacity as gboolean)
declare function gtk_color_selection_get_has_palette cdecl alias "gtk_color_selection_get_has_palette" (byval colorsel as GtkColorSelection ptr) as gboolean
declare sub gtk_color_selection_set_has_palette cdecl alias "gtk_color_selection_set_has_palette" (byval colorsel as GtkColorSelection ptr, byval has_palette as gboolean)
declare sub gtk_color_selection_set_current_color cdecl alias "gtk_color_selection_set_current_color" (byval colorsel as GtkColorSelection ptr, byval color as GdkColor ptr)
declare sub gtk_color_selection_set_current_alpha cdecl alias "gtk_color_selection_set_current_alpha" (byval colorsel as GtkColorSelection ptr, byval alpha as guint16)
declare sub gtk_color_selection_get_current_color cdecl alias "gtk_color_selection_get_current_color" (byval colorsel as GtkColorSelection ptr, byval color as GdkColor ptr)
declare function gtk_color_selection_get_current_alpha cdecl alias "gtk_color_selection_get_current_alpha" (byval colorsel as GtkColorSelection ptr) as guint16
declare sub gtk_color_selection_set_previous_color cdecl alias "gtk_color_selection_set_previous_color" (byval colorsel as GtkColorSelection ptr, byval color as GdkColor ptr)
declare sub gtk_color_selection_set_previous_alpha cdecl alias "gtk_color_selection_set_previous_alpha" (byval colorsel as GtkColorSelection ptr, byval alpha as guint16)
...
declare function gtk_color_selection_palette_from_string cdecl alias "gtk_color_selection_palette_from_string" (byval str as zstring ptr, byval colors as GdkColor ptr ptr, byval n_colors as gint ptr) as gboolean
...
declare sub gtk_color_selection_get_color cdecl alias "gtk_color_selection_get_color" (byval colorsel as GtkColorSelection ptr, byval color as gdouble ptr)
declare sub gtk_color_selection_set_update_policy cdecl alias "gtk_color_selection_set_update_policy" (byval colorsel as GtkColorSelection ptr, byval policy as GtkUpdateType)
