...
declare function _gtk_toolbar_elide_underscores cdecl alias "_gtk_toolbar_elide_underscores" (byval original as zstring ptr) as zstring ptr
...
declare function gtk_toolbar_append_item cdecl alias "gtk_toolbar_append_item" (byval toolbar as GtkToolbar ptr, byval text as zstring ptr, byval tooltip_text as zstring ptr, byval tooltip_private_text as zstring ptr, byval icon as GtkWidget ptr, byval callback as GtkSignalFunc, byval user_data as gpointer) as GtkWidget ptr
declare function gtk_toolbar_prepend_item cdecl alias "gtk_toolbar_prepend_item" (byval toolbar as GtkToolbar ptr, byval text as zstring ptr, byval tooltip_text as zstring ptr, byval tooltip_private_text as zstring ptr, byval icon as GtkWidget ptr, byval callback as GtkSignalFunc, byval user_data as gpointer) as GtkWidget ptr
declare function gtk_toolbar_insert_item cdecl alias "gtk_toolbar_insert_item" (byval toolbar as GtkToolbar ptr, byval text as zstring ptr, byval tooltip_text as zstring ptr, byval tooltip_private_text as zstring ptr, byval icon as GtkWidget ptr, byval callback as GtkSignalFunc, byval user_data as gpointer, byval position as gint) as GtkWidget ptr
declare function gtk_toolbar_insert_stock cdecl alias "gtk_toolbar_insert_stock" (byval toolbar as GtkToolbar ptr, byval stock_id as zstring ptr, byval tooltip_text as zstring ptr, byval tooltip_private_text as zstring ptr, byval callback as GtkSignalFunc, byval user_data as gpointer, byval position as gint) as GtkWidget ptr
...
declare function gtk_toolbar_append_element cdecl alias "gtk_toolbar_append_element" (byval toolbar as GtkToolbar ptr, byval type as GtkToolbarChildType, byval widget as GtkWidget ptr, byval text as zstring ptr, byval tooltip_text as zstring ptr, byval tooltip_private_text as zstring ptr, byval icon as GtkWidget ptr, byval callback as GtkSignalFunc, byval user_data as gpointer) as GtkWidget ptr
declare function gtk_toolbar_prepend_element cdecl alias "gtk_toolbar_prepend_element" (byval toolbar as GtkToolbar ptr, byval type as GtkToolbarChildType, byval widget as GtkWidget ptr, byval text as zstring ptr, byval tooltip_text as zstring ptr, byval tooltip_private_text as zstring ptr, byval icon as GtkWidget ptr, byval callback as GtkSignalFunc, byval user_data as gpointer) as GtkWidget ptr
declare function gtk_toolbar_insert_element cdecl alias "gtk_toolbar_insert_element" (byval toolbar as GtkToolbar ptr, byval type as GtkToolbarChildType, byval widget as GtkWidget ptr, byval text as zstring ptr, byval tooltip_text as zstring ptr, byval tooltip_private_text as zstring ptr, byval icon as GtkWidget ptr, byval callback as GtkSignalFunc, byval user_data as gpointer, byval position as gint) as GtkWidget ptr
declare sub gtk_toolbar_append_widget cdecl alias "gtk_toolbar_append_widget" (byval toolbar as GtkToolbar ptr, byval widget as GtkWidget ptr, byval tooltip_text as zstring ptr, byval tooltip_private_text as zstring ptr)
declare sub gtk_toolbar_prepend_widget cdecl alias "gtk_toolbar_prepend_widget" (byval toolbar as GtkToolbar ptr, byval widget as GtkWidget ptr, byval tooltip_text as zstring ptr, byval tooltip_private_text as zstring ptr)
declare sub gtk_toolbar_insert_widget cdecl alias "gtk_toolbar_insert_widget" (byval toolbar as GtkToolbar ptr, byval widget as GtkWidget ptr, byval tooltip_text as zstring ptr, byval tooltip_private_text as zstring ptr, byval position as gint)
