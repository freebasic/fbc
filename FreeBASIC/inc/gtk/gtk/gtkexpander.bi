...
declare function gtk_expander_new cdecl alias "gtk_expander_new" (byval label as string) as GtkWidget ptr
declare function gtk_expander_new_with_mnemonic cdecl alias "gtk_expander_new_with_mnemonic" (byval label as string) as GtkWidget ptr
...
declare sub gtk_expander_set_label cdecl alias "gtk_expander_set_label" (byval expander as GtkExpander ptr, byval label as string)
