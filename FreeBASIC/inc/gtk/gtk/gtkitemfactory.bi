...
declare function gtk_item_factory_new cdecl alias "gtk_item_factory_new" (byval container_type as GType, byval path as zstring ptr, byval accel_group as GtkAccelGroup ptr) as GtkItemFactory ptr
declare sub gtk_item_factory_construct cdecl alias "gtk_item_factory_construct" (byval ifactory as GtkItemFactory ptr, byval container_type as GType, byval path as zstring ptr, byval accel_group as GtkAccelGroup ptr)
declare sub gtk_item_factory_add_foreign cdecl alias "gtk_item_factory_add_foreign" (byval accel_widget as GtkWidget ptr, byval full_path as zstring ptr, byval accel_group as GtkAccelGroup ptr, byval keyval as guint, byval modifiers as GdkModifierType)
...
declare function gtk_item_factory_get_item cdecl alias "gtk_item_factory_get_item" (byval ifactory as GtkItemFactory ptr, byval path as zstring ptr) as GtkWidget ptr
declare function gtk_item_factory_get_widget cdecl alias "gtk_item_factory_get_widget" (byval ifactory as GtkItemFactory ptr, byval path as zstring ptr) as GtkWidget ptr
...
declare sub gtk_item_factory_delete_item cdecl alias "gtk_item_factory_delete_item" (byval ifactory as GtkItemFactory ptr, byval path as zstring ptr)
...
declare function gtk_item_factory_from_path cdecl alias "gtk_item_factory_from_path" (byval path as zstring ptr) as GtkItemFactory ptr
...
declare sub gtk_item_factories_path_delete cdecl alias "gtk_item_factories_path_delete" (byval ifactory_path as zstring ptr, byval path as zstring ptr)
