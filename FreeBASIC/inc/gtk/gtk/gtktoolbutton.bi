...
declare function gtk_tool_button_new cdecl alias "gtk_tool_button_new" (byval icon_widget as GtkWidget ptr, byval label as gchar ptr) as GtkToolItem ptr
declare function gtk_tool_button_new_from_stock cdecl alias "gtk_tool_button_new_from_stock" (byval stock_id as gchar ptr) as GtkToolItem ptr
declare sub gtk_tool_button_set_label cdecl alias "gtk_tool_button_set_label" (byval button as GtkToolButton ptr, byval label as gchar ptr)
declare function gtk_tool_button_get_label cdecl alias "gtk_tool_button_get_label" (byval button as GtkToolButton ptr) as gchar ptr
...
declare sub gtk_tool_button_set_stock_id cdecl alias "gtk_tool_button_set_stock_id" (byval button as GtkToolButton ptr, byval stock_id as gchar ptr)
declare function gtk_tool_button_get_stock_id cdecl alias "gtk_tool_button_get_stock_id" (byval button as GtkToolButton ptr) as gchar ptr
