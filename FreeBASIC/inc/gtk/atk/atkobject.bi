...
declare function atk_role_register cdecl alias "atk_role_register" (byval name as gchar ptr) as AtkRole
...
type _AtkObjectClass
	...
	set_name as sub cdecl(byval as AtkObject ptr, byval as gchar ptr)
	set_description as sub cdecl(byval as AtkObject ptr, byval as gchar ptr)
	...
	state_change as sub cdecl(byval as AtkObject ptr, byval as gchar ptr, byval as gboolean)
...
declare function atk_object_get_name cdecl alias "atk_object_get_name" (byval accessible as AtkObject ptr) as gchar ptr
declare function atk_object_get_description cdecl alias "atk_object_get_description" (byval accessible as AtkObject ptr) as gchar ptr
...
declare sub atk_object_set_name cdecl alias "atk_object_set_name" (byval accessible as AtkObject ptr, byval name as gchar ptr)
declare sub atk_object_set_description cdecl alias "atk_object_set_description" (byval accessible as AtkObject ptr, byval description as gchar ptr)
...
declare function atk_role_get_name cdecl alias "atk_role_get_name" (byval role as AtkRole) as gchar ptr
declare function atk_role_for_name cdecl alias "atk_role_for_name" (byval name as gchar ptr) as AtkRole
...
declare function atk_role_get_localized_name cdecl alias "atk_role_get_localized_name" (byval role as AtkRole) as gchar ptr
