...
type _AtkImageIface
	...
	set_image_description as function cdecl(byval as AtkImage ptr, byval as gchar ptr) as gboolean
	pad1 as AtkFunction
	pad2 as AtkFunction
end type

declare function atk_image_get_type cdecl alias "atk_image_get_type" () as GType
declare function atk_image_get_image_description cdecl alias "atk_image_get_image_description" (byval image as AtkImage ptr) as gchar ptr
...
declare function atk_image_set_image_description cdecl alias "atk_image_set_image_description" (byval image as AtkImage ptr, byval description as gchar ptr) as gboolean
