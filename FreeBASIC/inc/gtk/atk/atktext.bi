...
declare function atk_text_attribute_register cdecl alias "atk_text_attribute_register" (byval name as gchar ptr) as AtkTextAttribute
...
declare function atk_text_get_text cdecl alias "atk_text_get_text" (byval text as AtkText ptr, byval start_offset as gint, byval end_offset as gint) as gchar ptr
...
declare function atk_text_get_text_after_offset cdecl alias "atk_text_get_text_after_offset" (byval text as AtkText ptr, byval offset as gint, byval boundary_type as AtkTextBoundary, byval start_offset as gint ptr, byval end_offset as gint ptr) as gchar ptr
declare function atk_text_get_text_at_offset cdecl alias "atk_text_get_text_at_offset" (byval text as AtkText ptr, byval offset as gint, byval boundary_type as AtkTextBoundary, byval start_offset as gint ptr, byval end_offset as gint ptr) as gchar ptr
declare function atk_text_get_text_before_offset cdecl alias "atk_text_get_text_before_offset" (byval text as AtkText ptr, byval offset as gint, byval boundary_type as AtkTextBoundary, byval start_offset as gint ptr, byval end_offset as gint ptr) as gchar ptr
...
declare function atk_text_get_selection cdecl alias "atk_text_get_selection" (byval text as AtkText ptr, byval selection_num as gint, byval start_offset as gint ptr, byval end_offset as gint ptr) as gchar ptr
...
declare function atk_text_attribute_get_name cdecl alias "atk_text_attribute_get_name" (byval attr as AtkTextAttribute) as gchar ptr
declare function atk_text_attribute_for_name cdecl alias "atk_text_attribute_for_name" (byval name as gchar ptr) as AtkTextAttribute
declare function atk_text_attribute_get_value cdecl alias "atk_text_attribute_get_value" (byval attr as AtkTextAttribute, byval index_ as gint) as gchar ptr
