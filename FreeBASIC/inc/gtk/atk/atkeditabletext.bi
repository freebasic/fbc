...
type _AtkEditableTextIface
	...
	set_text_contents as sub cdecl(byval as AtkEditableText ptr, byval as gchar ptr)
	insert_text as sub cdecl(byval as AtkEditableText ptr, byval as gchar ptr, byval as gint, byval as gint ptr)
...
declare sub atk_editable_text_set_text_contents cdecl alias "atk_editable_text_set_text_contents" (byval text as AtkEditableText ptr, byval string as gchar ptr)
declare sub atk_editable_text_insert_text cdecl alias "atk_editable_text_insert_text" (byval text as AtkEditableText ptr, byval string as gchar ptr, byval length as gint, byval position as gint ptr)
