...
type _AtkTableIface
	...
	set_column_description as sub cdecl(byval as AtkTable ptr, byval as gint, byval as gchar ptr)
	set_column_header as sub cdecl(byval as AtkTable ptr, byval as gint, byval as AtkObject ptr)
	set_row_description as sub cdecl(byval as AtkTable ptr, byval as gint, byval as gchar ptr)
...
declare function atk_table_get_column_description cdecl alias "atk_table_get_column_description" (byval table as AtkTable ptr, byval column as gint) as gchar ptr
...
declare function atk_table_get_row_description cdecl alias "atk_table_get_row_description" (byval table as AtkTable ptr, byval row as gint) as gchar ptr
...
declare sub atk_table_set_column_description cdecl alias "atk_table_set_column_description" (byval table as AtkTable ptr, byval column as gint, byval description as gchar ptr)
...
declare sub atk_table_set_row_description cdecl alias "atk_table_set_row_description" (byval table as AtkTable ptr, byval row as gint, byval description as gchar ptr)
