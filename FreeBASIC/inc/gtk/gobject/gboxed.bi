...
declare function g_boxed_type_register_static cdecl alias "g_boxed_type_register_static" (byval name as gchar ptr, byval boxed_copy as GBoxedCopyFunc, byval boxed_free as GBoxedFreeFunc) as GType
