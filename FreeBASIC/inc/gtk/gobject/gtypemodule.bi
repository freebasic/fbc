...
declare sub g_type_module_set_name cdecl alias "g_type_module_set_name" (byval module as GTypeModule ptr, byval name as string)
declare function g_type_module_register_type cdecl alias "g_type_module_register_type" (byval module as GTypeModule ptr, byval parent_type as GType, byval type_name as string, byval type_info as GTypeInfo ptr, byval flags as GTypeFlags) as GType
...
declare function g_type_module_register_enum cdecl alias "g_type_module_register_enum" (byval module as GTypeModule ptr, byval name as string, byval const_static_values as GEnumValue ptr) as GType
declare function g_type_module_register_flags cdecl alias "g_type_module_register_flags" (byval module as GTypeModule ptr, byval name as string, byval const_static_values as GFlagsValue ptr) as GType
