...
declare function g_object_class_find_property cdecl alias "g_object_class_find_property" (byval oclass as GObjectClass ptr, byval property_name as gchar ptr) as GParamSpec ptr
...
declare sub g_object_class_override_property cdecl alias "g_object_class_override_property" (byval oclass as GObjectClass ptr, byval property_id as guint, byval name as gchar ptr)
...
declare function g_object_interface_find_property cdecl alias "g_object_interface_find_property" (byval g_iface as gpointer, byval property_name as gchar ptr) as GParamSpec ptr
...
declare function g_object_new cdecl alias "g_object_new" (byval object_type as GType, byval first_property_name as gchar ptr, ...) as gpointer
...
''''''' declare function g_object_new_valist cdecl alias "g_object_new_valist" (byval object_type as GType, byval first_property_name as gchar ptr, byval var_args as va_list) as GObject ptr
declare sub g_object_set cdecl alias "g_object_set" (byval object as gpointer, byval first_property_name as gchar ptr, ...)
declare sub g_object_get cdecl alias "g_object_get" (byval object as gpointer, byval first_property_name as gchar ptr, ...)
declare function g_object_connect cdecl alias "g_object_connect" (byval object as gpointer, byval signal_spec as gchar ptr, ...) as gpointer
declare sub g_object_disconnect cdecl alias "g_object_disconnect" (byval object as gpointer, byval signal_spec as gchar ptr, ...)
''''''' declare sub g_object_set_valist cdecl alias "g_object_set_valist" (byval object as GObject ptr, byval first_property_name as gchar ptr, byval var_args as va_list)
''''''' declare sub g_object_get_valist cdecl alias "g_object_get_valist" (byval object as GObject ptr, byval first_property_name as gchar ptr, byval var_args as va_list)
declare sub g_object_set_property cdecl alias "g_object_set_property" (byval object as GObject ptr, byval property_name as gchar ptr, byval value as GValue ptr)
declare sub g_object_get_property cdecl alias "g_object_get_property" (byval object as GObject ptr, byval property_name as gchar ptr, byval value as GValue ptr)
declare sub g_object_freeze_notify cdecl alias "g_object_freeze_notify" (byval object as GObject ptr)
declare sub g_object_notify cdecl alias "g_object_notify" (byval object as GObject ptr, byval property_name as gchar ptr)
...
declare function g_object_get_data cdecl alias "g_object_get_data" (byval object as GObject ptr, byval key as gchar ptr) as gpointer
declare sub g_object_set_data cdecl alias "g_object_set_data" (byval object as GObject ptr, byval key as gchar ptr, byval data as gpointer)
declare sub g_object_set_data_full cdecl alias "g_object_set_data_full" (byval object as GObject ptr, byval key as gchar ptr, byval data as gpointer, byval destroy as GDestroyNotify)
declare function g_object_steal_data cdecl alias "g_object_steal_data" (byval object as GObject ptr, byval key as gchar ptr) as gpointer
...
declare function g_signal_connect_object cdecl alias "g_signal_connect_object" (byval instance as gpointer, byval detailed_signal as gchar ptr, byval c_handler as GCallback, byval gobject as gpointer, byval connect_flags as GConnectFlags) as gulong
