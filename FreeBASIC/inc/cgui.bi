...
#define CGUI_RIGHT DIR_RIGHT,AUTOINDICATOR
#define DOWNLEFT DIR_DOWNLEFT,AUTOINDICATOR
#define CGUI_LEFT DIR_LEFT,AUTOINDICATOR
...
#define W_CENTRE_H ((1 shl 6) or (1 shl 7))
#define W_CENTRE_V ((1 shl 4) or (1 shl 5))
#define W_CENTRE (((1 shl 6) or (1 shl 7)) or ((1 shl 4) or (1 shl 5)))
...
#define I_UNDEF_VAL &h80000000L
#define L_UNDEF_VAL &h80000000L
...
#define CGUI_OFF 0
#define CGUI_ON 1
#define ROW_STRIKE &h80000000
#define ROW_UNDERLINE &h40000000
#define ROW_CHECK &h20000000
#define ROW_UNCHECK &h10000000
#define COL_RIGHT_ALIGN &h08000000
...
#define LIST_COLUMNS_ADJUSTABLE 1
#define LIST_COLUMNS_DELIMITER 2
...
#define FS_BROWSE_DAT 1
#define FS_DISABLE_EDIT_DAT 2
#define FS_WARN_EXISTING_FILE 4
#define FS_FORBID_EXISTING_FILE 8
#define FS_REQUIRE_EXISTING_FILE &h10
#define FS_SELECT_DIR &h20
#define FS_DISABLE_CREATE_DIR &h40
#define FS_DISABLE_DELETING &h80
#define FS_DISABLE_COPYING &h100
#define FS_SHOW_MENU &h200
#define FS_NO_SETTINGS_IN_CONFIG &h400
#define FS_MULTIPLE_SELECTION &h800
#define FS_NO_DRAG_DROP &h4000
#define FS_SAVE_AS &h8000
#define FM_BROWSE_DAT 1
#define FM_DISABLE_EDIT_DAT 2
#define FM_DISABLE_CREATE_DIR &h40
#define FM_DISABLE_DELETING &h80
#define FM_DISABLE_COPYING &h100
#define FM_DO_NOT_SHOW_MENU &h2000
#define FM_NO_SETTINGS_IN_CONFIG &h400
#define FM_NO_FLOATING &h1000
...
#define FRAMERAISE &h80000000
#define FRAMESINK &h40000000
#define W_NOMODAL (1 shl 3)
#define W_CHILD 0
