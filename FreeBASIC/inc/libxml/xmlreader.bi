...
declare function xmlTextReaderConstString cdecl alias "xmlTextReaderConstString" (byval reader as xmlTextReaderPtr, byval str as string) as zstring ptr
...
declare function xmlTextReaderGetAttribute cdecl alias "xmlTextReaderGetAttribute" (byval reader as xmlTextReaderPtr, byval name as string) as zstring ptr
declare function xmlTextReaderGetAttributeNs cdecl alias "xmlTextReaderGetAttributeNs" (byval reader as xmlTextReaderPtr, byval localName as string, byval namespaceURI as string) as zstring ptr
...
declare function xmlTextReaderLookupNamespace cdecl alias "xmlTextReaderLookupNamespace" (byval reader as xmlTextReaderPtr, byval prefix as string) as zstring ptr
...
declare function xmlTextReaderMoveToAttribute cdecl alias "xmlTextReaderMoveToAttribute" (byval reader as xmlTextReaderPtr, byval name as string) as integer
declare function xmlTextReaderMoveToAttributeNs cdecl alias "xmlTextReaderMoveToAttributeNs" (byval reader as xmlTextReaderPtr, byval localName as string, byval namespaceURI as string) as integer
...
declare function xmlTextReaderPreservePattern cdecl alias "xmlTextReaderPreservePattern" (byval reader as xmlTextReaderPtr, byval pattern as string, byval namespaces as zstring ptr ptr) as integer
...
declare function xmlReaderForDoc cdecl alias "xmlReaderForDoc" (byval cur as string, byval URL as string, byval encoding as string, byval options as integer) as xmlTextReaderPtr
...
declare function xmlReaderNewDoc cdecl alias "xmlReaderNewDoc" (byval reader as xmlTextReaderPtr, byval cur as string, byval URL as string, byval encoding as string, byval options as integer) as integer
