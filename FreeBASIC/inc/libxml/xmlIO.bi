...
declare function xmlParserInputBufferCreateFilename cdecl alias "xmlParserInputBufferCreateFilename" (byval URI as zstring ptr, byval enc as xmlCharEncoding) as xmlParserInputBufferPtr
...
declare function xmlParserInputBufferCreateMem cdecl alias "xmlParserInputBufferCreateMem" (byval mem as zstring ptr, byval size as integer, byval enc as xmlCharEncoding) as xmlParserInputBufferPtr
declare function xmlParserInputBufferCreateStatic cdecl alias "xmlParserInputBufferCreateStatic" (byval mem as zstring ptr, byval size as integer, byval enc as xmlCharEncoding) as xmlParserInputBufferPtr
...
declare function xmlParserInputBufferPush cdecl alias "xmlParserInputBufferPush" (byval in as xmlParserInputBufferPtr, byval len as integer, byval buf as zstring ptr) as integer
declare sub xmlFreeParserInputBuffer cdecl alias "xmlFreeParserInputBuffer" (byval in as xmlParserInputBufferPtr)
declare function xmlParserGetDirectory cdecl alias "xmlParserGetDirectory" (byval filename as zstring ptr) as byte ptr
...
declare function __xmlParserInputBufferCreateFilename cdecl alias "__xmlParserInputBufferCreateFilename" (byval URI as zstring ptr, byval enc as xmlCharEncoding) as xmlParserInputBufferPtr
...
declare function xmlOutputBufferCreateFilename cdecl alias "xmlOutputBufferCreateFilename" (byval URI as zstring ptr, byval encoder as xmlCharEncodingHandlerPtr, byval compression as integer) as xmlOutputBufferPtr
...
declare function xmlOutputBufferWrite cdecl alias "xmlOutputBufferWrite" (byval out as xmlOutputBufferPtr, byval len as integer, byval buf as zstring ptr) as integer
declare function xmlOutputBufferWriteString cdecl alias "xmlOutputBufferWriteString" (byval out as xmlOutputBufferPtr, byval str as zstring ptr) as integer
declare function xmlOutputBufferWriteEscape cdecl alias "xmlOutputBufferWriteEscape" (byval out as xmlOutputBufferPtr, byval str as zstring ptr, byval escaping as xmlCharEncodingOutputFunc) as integer
...
declare function __xmlOutputBufferCreateFilename cdecl alias "__xmlOutputBufferCreateFilename" (byval URI as zstring ptr, byval encoder as xmlCharEncodingHandlerPtr, byval compression as integer) as xmlOutputBufferPtr
...
declare function xmlNoNetExternalEntityLoader cdecl alias "xmlNoNetExternalEntityLoader" (byval URL as zstring ptr, byval ID as zstring ptr, byval ctxt as xmlParserCtxtPtr) as xmlParserInputPtr
declare function xmlNormalizeWindowsPath cdecl alias "xmlNormalizeWindowsPath" (byval path as zstring ptr) as zstring ptr
declare function xmlCheckFilename cdecl alias "xmlCheckFilename" (byval path as zstring ptr) as integer
declare function xmlFileMatch cdecl alias "xmlFileMatch" (byval filename as zstring ptr) as integer
declare function xmlFileOpen cdecl alias "xmlFileOpen" (byval filename as zstring ptr) as any ptr
declare function xmlFileRead cdecl alias "xmlFileRead" (byval context as any ptr, byval buffer as zstring ptr, byval len as integer) as integer
declare function xmlFileClose cdecl alias "xmlFileClose" (byval context as any ptr) as integer
declare function xmlIOHTTPMatch cdecl alias "xmlIOHTTPMatch" (byval filename as zstring ptr) as integer
declare function xmlIOHTTPOpen cdecl alias "xmlIOHTTPOpen" (byval filename as zstring ptr) as any ptr
declare function xmlIOHTTPOpenW cdecl alias "xmlIOHTTPOpenW" (byval post_uri as zstring ptr, byval compression as integer) as any ptr
declare function xmlIOHTTPRead cdecl alias "xmlIOHTTPRead" (byval context as any ptr, byval buffer as zstring ptr, byval len as integer) as integer
declare function xmlIOHTTPClose cdecl alias "xmlIOHTTPClose" (byval context as any ptr) as integer
declare function xmlIOFTPMatch cdecl alias "xmlIOFTPMatch" (byval filename as zstring ptr) as integer
declare function xmlIOFTPOpen cdecl alias "xmlIOFTPOpen" (byval filename as zstring ptr) as any ptr
declare function xmlIOFTPRead cdecl alias "xmlIOFTPRead" (byval context as any ptr, byval buffer as zstring ptr, byval len as integer) as integer
