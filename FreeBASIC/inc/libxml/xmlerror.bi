...
declare sub xmlParserError cdecl alias "xmlParserError" (byval ctx as any ptr, byval msg as string, ...)
declare sub xmlParserWarning cdecl alias "xmlParserWarning" (byval ctx as any ptr, byval msg as string, ...)
declare sub xmlParserValidityError cdecl alias "xmlParserValidityError" (byval ctx as any ptr, byval msg as string, ...)
declare sub xmlParserValidityWarning cdecl alias "xmlParserValidityWarning" (byval ctx as any ptr, byval msg as string, ...)
