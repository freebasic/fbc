...
declare function xmlDictLookup cdecl alias "xmlDictLookup" (byval dict as xmlDictPtr, byval name as xmlChar ptr, byval len as integer) as xmlChar ptr
declare function xmlDictExists cdecl alias "xmlDictExists" (byval dict as xmlDictPtr, byval name as xmlChar ptr, byval len as integer) as xmlChar ptr
declare function xmlDictQLookup cdecl alias "xmlDictQLookup" (byval dict as xmlDictPtr, byval prefix as xmlChar ptr, byval name as xmlChar ptr) as xmlChar ptr
declare function xmlDictOwns cdecl alias "xmlDictOwns" (byval dict as xmlDictPtr, byval str as xmlChar ptr) as integer
