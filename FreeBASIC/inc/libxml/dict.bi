...
declare function xmlDictLookup cdecl alias "xmlDictLookup" (byval dict as xmlDictPtr, byval name as zstring ptr, byval len as integer) as zstring ptr
declare function xmlDictExists cdecl alias "xmlDictExists" (byval dict as xmlDictPtr, byval name as zstring ptr, byval len as integer) as zstring ptr
declare function xmlDictQLookup cdecl alias "xmlDictQLookup" (byval dict as xmlDictPtr, byval prefix as zstring ptr, byval name as zstring ptr) as zstring ptr
declare function xmlDictOwns cdecl alias "xmlDictOwns" (byval dict as xmlDictPtr, byval str as zstring ptr) as integer
