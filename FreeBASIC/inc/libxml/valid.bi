...
declare function xmlAddNotationDecl cdecl alias "xmlAddNotationDecl" (byval ctxt as xmlValidCtxtPtr, byval dtd as xmlDtdPtr, byval name as string, byval PublicID as string, byval SystemID as string) as xmlNotationPtr
...
declare function xmlNewElementContent cdecl alias "xmlNewElementContent" (byval name as string, byval type as xmlElementContentType) as xmlElementContentPtr
...
declare function xmlAddElementDecl cdecl alias "xmlAddElementDecl" (byval ctxt as xmlValidCtxtPtr, byval dtd as xmlDtdPtr, byval name as string, byval type as xmlElementTypeVal, byval content as xmlElementContentPtr) as xmlElementPtr
...
declare function xmlCreateEnumeration cdecl alias "xmlCreateEnumeration" (byval name as string) as xmlEnumerationPtr
...
declare function xmlAddAttributeDecl cdecl alias "xmlAddAttributeDecl" (byval ctxt as xmlValidCtxtPtr, byval dtd as xmlDtdPtr, byval elem as string, byval name as string, byval ns as string, byval type as xmlAttributeType, byval def as xmlAttributeDefault, byval defaultValue as string, byval tree as xmlEnumerationPtr) as xmlAttributePtr
...
declare function xmlAddID cdecl alias "xmlAddID" (byval ctxt as xmlValidCtxtPtr, byval doc as xmlDocPtr, byval value as string, byval attr as xmlAttrPtr) as xmlIDPtr
declare sub xmlFreeIDTable cdecl alias "xmlFreeIDTable" (byval table as xmlIDTablePtr)
declare function xmlGetID cdecl alias "xmlGetID" (byval doc as xmlDocPtr, byval ID as string) as xmlAttrPtr
...
declare function xmlAddRef cdecl alias "xmlAddRef" (byval ctxt as xmlValidCtxtPtr, byval doc as xmlDocPtr, byval value as string, byval attr as xmlAttrPtr) as xmlRefPtr
...
declare function xmlGetRefs cdecl alias "xmlGetRefs" (byval doc as xmlDocPtr, byval ID as string) as xmlListPtr
...
declare function xmlValidNormalizeAttributeValue cdecl alias "xmlValidNormalizeAttributeValue" (byval doc as xmlDocPtr, byval elem as xmlNodePtr, byval name as string, byval value as string) as zstring ptr
declare function xmlValidCtxtNormalizeAttributeValue cdecl alias "xmlValidCtxtNormalizeAttributeValue" (byval ctxt as xmlValidCtxtPtr, byval doc as xmlDocPtr, byval elem as xmlNodePtr, byval name as string, byval value as string) as zstring ptr
...
declare function xmlValidateAttributeValue cdecl alias "xmlValidateAttributeValue" (byval type as xmlAttributeType, byval value as string) as integer
...
declare function xmlValidateOneAttribute cdecl alias "xmlValidateOneAttribute" (byval ctxt as xmlValidCtxtPtr, byval doc as xmlDocPtr, byval elem as xmlNodePtr, byval attr as xmlAttrPtr, byval value as string) as integer
declare function xmlValidateOneNamespace cdecl alias "xmlValidateOneNamespace" (byval ctxt as xmlValidCtxtPtr, byval doc as xmlDocPtr, byval elem as xmlNodePtr, byval prefix as string, byval ns as xmlNsPtr, byval value as string) as integer
...
declare function xmlValidateNotationUse cdecl alias "xmlValidateNotationUse" (byval ctxt as xmlValidCtxtPtr, byval doc as xmlDocPtr, byval notationName as string) as integer
declare function xmlIsMixedElement cdecl alias "xmlIsMixedElement" (byval doc as xmlDocPtr, byval name as string) as integer
declare function xmlGetDtdAttrDesc cdecl alias "xmlGetDtdAttrDesc" (byval dtd as xmlDtdPtr, byval elem as string, byval name as string) as xmlAttributePtr
declare function xmlGetDtdQAttrDesc cdecl alias "xmlGetDtdQAttrDesc" (byval dtd as xmlDtdPtr, byval elem as string, byval name as string, byval prefix as string) as xmlAttributePtr
declare function xmlGetDtdNotationDesc cdecl alias "xmlGetDtdNotationDesc" (byval dtd as xmlDtdPtr, byval name as string) as xmlNotationPtr
declare function xmlGetDtdQElementDesc cdecl alias "xmlGetDtdQElementDesc" (byval dtd as xmlDtdPtr, byval name as string, byval prefix as string) as xmlElementPtr
declare function xmlGetDtdElementDesc cdecl alias "xmlGetDtdElementDesc" (byval dtd as xmlDtdPtr, byval name as string) as xmlElementPtr
...
declare function xmlValidateNameValue cdecl alias "xmlValidateNameValue" (byval value as string) as integer
declare function xmlValidateNamesValue cdecl alias "xmlValidateNamesValue" (byval value as string) as integer
declare function xmlValidateNmtokenValue cdecl alias "xmlValidateNmtokenValue" (byval value as string) as integer
declare function xmlValidateNmtokensValue cdecl alias "xmlValidateNmtokensValue" (byval value as string) as integer
...
declare function xmlValidatePushElement cdecl alias "xmlValidatePushElement" (byval ctxt as xmlValidCtxtPtr, byval doc as xmlDocPtr, byval elem as xmlNodePtr, byval qname as string) as integer
declare function xmlValidatePushCData cdecl alias "xmlValidatePushCData" (byval ctxt as xmlValidCtxtPtr, byval data as string, byval len as integer) as integer
declare function xmlValidatePopElement cdecl alias "xmlValidatePopElement" (byval ctxt as xmlValidCtxtPtr, byval doc as xmlDocPtr, byval elem as xmlNodePtr, byval qname as string) as integer
