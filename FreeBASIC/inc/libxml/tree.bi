...
declare function xmlSaveFile cdecl alias "xmlSaveFile" (byval filename as string, byval cur as xmlDocPtr) as integer
declare function xmlSaveFormatFile cdecl alias "xmlSaveFormatFile" (byval filename as string, byval cur as xmlDocPtr, byval format as integer) as integer
...
declare function xmlSaveFileTo cdecl alias "xmlSaveFileTo" (byval buf as xmlOutputBufferPtr, byval cur as xmlDocPtr, byval encoding as string) as integer
declare function xmlSaveFormatFileTo cdecl alias "xmlSaveFormatFileTo" (byval buf as xmlOutputBufferPtr, byval cur as xmlDocPtr, byval encoding as string, byval format as integer) as integer
