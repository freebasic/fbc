...
declare function xmlXPathPopString cdecl alias "xmlXPathPopString" (byval ctxt as xmlXPathParserContextPtr) as xmlChar ptr
...
declare sub xmlXPatherror cdecl alias "xmlXPatherror" (byval ctxt as xmlXPathParserContextPtr, byval file as string, byval line as integer, byval no as integer)
...
declare function xmlXPathRegisterNs cdecl alias "xmlXPathRegisterNs" (byval ctxt as xmlXPathContextPtr, byval prefix as xmlChar ptr, byval ns_uri as xmlChar ptr) as integer
declare function xmlXPathNsLookup cdecl alias "xmlXPathNsLookup" (byval ctxt as xmlXPathContextPtr, byval prefix as xmlChar ptr) as xmlChar ptr
declare sub xmlXPathRegisteredNsCleanup cdecl alias "xmlXPathRegisteredNsCleanup" (byval ctxt as xmlXPathContextPtr)
declare function xmlXPathRegisterFunc cdecl alias "xmlXPathRegisterFunc" (byval ctxt as xmlXPathContextPtr, byval name as xmlChar ptr, byval f as xmlXPathFunction) as integer
declare function xmlXPathRegisterFuncNS cdecl alias "xmlXPathRegisterFuncNS" (byval ctxt as xmlXPathContextPtr, byval name as xmlChar ptr, byval ns_uri as xmlChar ptr, byval f as xmlXPathFunction) as integer
declare function xmlXPathRegisterVariable cdecl alias "xmlXPathRegisterVariable" (byval ctxt as xmlXPathContextPtr, byval name as xmlChar ptr, byval value as xmlXPathObjectPtr) as integer
declare function xmlXPathRegisterVariableNS cdecl alias "xmlXPathRegisterVariableNS" (byval ctxt as xmlXPathContextPtr, byval name as xmlChar ptr, byval ns_uri as xmlChar ptr, byval value as xmlXPathObjectPtr) as integer
declare function xmlXPathFunctionLookup cdecl alias "xmlXPathFunctionLookup" (byval ctxt as xmlXPathContextPtr, byval name as xmlChar ptr) as xmlXPathFunction
declare function xmlXPathFunctionLookupNS cdecl alias "xmlXPathFunctionLookupNS" (byval ctxt as xmlXPathContextPtr, byval name as xmlChar ptr, byval ns_uri as xmlChar ptr) as xmlXPathFunction
declare sub xmlXPathRegisteredFuncsCleanup cdecl alias "xmlXPathRegisteredFuncsCleanup" (byval ctxt as xmlXPathContextPtr)
declare function xmlXPathVariableLookup cdecl alias "xmlXPathVariableLookup" (byval ctxt as xmlXPathContextPtr, byval name as xmlChar ptr) as xmlXPathObjectPtr
declare function xmlXPathVariableLookupNS cdecl alias "xmlXPathVariableLookupNS" (byval ctxt as xmlXPathContextPtr, byval name as xmlChar ptr, byval ns_uri as xmlChar ptr) as xmlXPathObjectPtr
...
declare function xmlXPathNewParserContext cdecl alias "xmlXPathNewParserContext" (byval str as xmlChar ptr, byval ctxt as xmlXPathContextPtr) as xmlXPathParserContextPtr
...
declare function xmlXPathNewString cdecl alias "xmlXPathNewString" (byval val as xmlChar ptr) as xmlXPathObjectPtr
declare function xmlXPathNewCString cdecl alias "xmlXPathNewCString" (byval val as string) as xmlXPathObjectPtr
declare function xmlXPathWrapString cdecl alias "xmlXPathWrapString" (byval val as xmlChar ptr) as xmlXPathObjectPtr
declare function xmlXPathWrapCString cdecl alias "xmlXPathWrapCString" (byval val as string) as xmlXPathObjectPtr
...
declare function xmlXPathParseName cdecl alias "xmlXPathParseName" (byval ctxt as xmlXPathParserContextPtr) as xmlChar ptr
declare function xmlXPathParseNCName cdecl alias "xmlXPathParseNCName" (byval ctxt as xmlXPathParserContextPtr) as xmlChar ptr
declare function xmlXPathStringEvalNumber cdecl alias "xmlXPathStringEvalNumber" (byval str as xmlChar ptr) as double
...
declare function xmlXPathIsNodeType cdecl alias "xmlXPathIsNodeType" (byval name as xmlChar ptr) as integer
