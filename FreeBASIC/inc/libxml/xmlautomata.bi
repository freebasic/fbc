...
declare function xmlAutomataNewTransition cdecl alias "xmlAutomataNewTransition" (byval am as xmlAutomataPtr, byval from as xmlAutomataStatePtr, byval to as xmlAutomataStatePtr, byval token as string, byval data as any ptr) as xmlAutomataStatePtr
declare function xmlAutomataNewTransition2 cdecl alias "xmlAutomataNewTransition2" (byval am as xmlAutomataPtr, byval from as xmlAutomataStatePtr, byval to as xmlAutomataStatePtr, byval token as string, byval token2 as string, byval data as any ptr) as xmlAutomataStatePtr
declare function xmlAutomataNewCountTrans cdecl alias "xmlAutomataNewCountTrans" (byval am as xmlAutomataPtr, byval from as xmlAutomataStatePtr, byval to as xmlAutomataStatePtr, byval token as string, byval min as integer, byval max as integer, byval data as any ptr) as xmlAutomataStatePtr
declare function xmlAutomataNewCountTrans2 cdecl alias "xmlAutomataNewCountTrans2" (byval am as xmlAutomataPtr, byval from as xmlAutomataStatePtr, byval to as xmlAutomataStatePtr, byval token as string, byval token2 as string, byval min as integer, byval max as integer, byval data as any ptr) as xmlAutomataStatePtr
declare function xmlAutomataNewOnceTrans cdecl alias "xmlAutomataNewOnceTrans" (byval am as xmlAutomataPtr, byval from as xmlAutomataStatePtr, byval to as xmlAutomataStatePtr, byval token as string, byval min as integer, byval max as integer, byval data as any ptr) as xmlAutomataStatePtr
