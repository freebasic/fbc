...
type COMBOBOXEXITEMW as COMBOBOXEXITEMW
...
type NMLVDISPINFOW as NMLVDISPINFOW
...
type TVINSERTSTRUCTW as TVINSERTSTRUCTW
...
#define ListView_GetImageList(w,i) cptr(HIMAGELIST,SNDMSG(w,LVM_GETIMAGELIST,(i),0))
...
#define ListView_SetImageList(w,h,i) cptr(HIMAGELIST,cuint(SNDMSG(w,LVM_SETIMAGELIST,i,cint( h))))
#define ListView_SetItem(w,i) cint(SNDMSG(w,LVM_SETITEM,0,cint( cptr(LV_ITEM ptr,i))))
#define ListView_InsertItem(w,i) cint(SNDMSG(w,LVM_INSERTITEM,0,cint( cptr(LV_ITEM ptr,i))))
...
#define ListView_FindItem(w,i,p) cint(SNDMSG(w, LVM_FINDITEM,i,cint( cptr(LV_FINDINFO ptr,p))))
#define ListView_GetItemRect(w,i,p) cint(SNDMSG(w,LVM_GETITEMRECT,i,cint( cptr(LPRECT, p))))
...
#define ListView_HitTest(w,p) cint(SNDMSG(w,LVM_HITTEST,0,cint( cptr(LV_HITTESTINFO ptr,p))))
...
#define ListView_RedrawItems(w,f,l) cint(SNDMSG(w,LVM_REDRAWITEMS,f,l)_
#define ListView_Arrange(w,c) cint(SNDMSG(w,LVM_ARRANGE,c,0))
#define ListView_EditLabel(w,i) cptr(HWND,SNDMSG(w,LVM_EDITLABEL,i,0))
#define ListView_GetEditControlw cptr(HWND,SNDMSG(w,LVM_GETEDITCONTROL,0,0))
#define ListView_GetColumn(w,i,p) cint(SNDMSG(w,LVM_GETCOLUMN,i,cint( cptr(LV_COLUMN ptr,p))))
#define ListView_SetColumn(w,i,p) cint(SNDMSG(w,LVM_SETCOLUMN,i,cint( cptr(LV_COLUMN ptr,p))))
#define ListView_InsertColumn(w,i,p) cint(SNDMSG(w,LVM_INSERTCOLUMN,i,cint( cptr(LV_COLUMN ptr,p))))
...
#define ListView_CreateDragImage(w,i,p) cptr(HIMAGELIST,SNDMSG(w,LVM_CREATEDRAGIMAGE,i,cint( cptr(LPPOINT,p))))
#define ListView_GetViewRect(w,p) cint(SNDMSG(w,LVM_GETVIEWRECT,0,cint( cptr(LPRECT,p))))
...
#define ListView_GetOrigin(w,p) cint(SNDMSG(w,LVM_GETORIGIN,0,cint( cptr(POINT ptr,p))))
...
#define TabCtrl_GetItem(w,i,p) cint(SNDMSG(w,TCM_GETITEM,i,cint(cptr(TC_ITEM ptr,p))))
#define TabCtrl_SetItem(w,i,p) cint(SNDMSG(w,TCM_SETITEM,i,cint(cptr(TC_ITEM ptr,p))))
#define TabCtrl_InsertItem(w,i,p) cint(SNDMSG(w,TCM_INSERTITEM,i,cint(cptr(TC_ITEM ptr,p))))
...
#define TabCtrl_GetItemRect(w,i,p) cint(SNDMSG(w,TCM_GETITEMRECT,i,cint(cptr(LPRECT,p))))
#define TabCtrl_GetCurSelw cint(SNDMSG(w,TCM_GETCURSEL,0,0))
#define TabCtrl_SetCurSel(w,i) cint(SNDMSG(w,TCM_SETCURSEL,i,0))
#define TabCtrl_HitTest(w,p) cint(SNDMSG(w,TCM_HITTEST,0,cint(cptr(TC_HITTESTINFO ptr,p))))
#define TabCtrl_SetItemExtra(w,c) cint(SNDMSG(w,TCM_SETITEMEXTRA,c,0))
#define TabCtrl_AdjustRect(w,b,p) cint(SNDMSG(w,TCM_ADJUSTRECT,b,cint(cptr(LPRECT,p)))
...
#define TabCtrl_GetToolTipsw cptr(HWND,SNDMSG(w,TCM_GETTOOLTIPS,0,0))
...
#define TabCtrl_SetImageList(w,h) cptr((HIMAGELIST,SNDMSG(w,TCM_SETIMAGELIST,0,cint(cUINT(h))))
