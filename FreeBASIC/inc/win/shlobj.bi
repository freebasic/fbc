...
#define BFFM_SETSTATUSTEXTA (1024+100)
#define BFFM_SETSTATUSTEXTW (1024+104)
#define BFFM_ENABLEOK (1024+101)
#define BFFM_SETSELECTIONA (1024+102)
#define BFFM_SETSELECTIONW (1024+103)
#ifdef UNICODE
...
type IShellBrowserVtbl
	...
	SendControlMsg as function (byval as IShellBrowser ptr, byval as UINT, byval as UINT, byval as WPARAM, byval as LPARAM, byval as LRESULT ptr) as HRESULT
