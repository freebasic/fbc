...
''
''
#ifndef __dplobby_bi__
#define __dplobby_bi__
...
type _DPLMSG_GENERIC
	dwType as DWORD
end type

type DPLMSG_GENERIC as _DPLMSG_GENERIC
type LPDPLMSG_GENERIC as _DPLMSG_GENERIC ptr

type _DPLMSG_SYSTEMMESSAGE
	dwType as DWORD
	guidInstance as GUID
end type

type DPLMSG_SYSTEMMESSAGE as _DPLMSG_SYSTEMMESSAGE
type LPDPLMSG_SYSTEMMESSAGE as _DPLMSG_SYSTEMMESSAGE ptr

type _DPLMSG_SETPROPERTY
	dwType as DWORD
...
type DPLMSG_SETPROPERTY as _DPLMSG_SETPROPERTY
type LPDPLMSG_SETPROPERTY as _DPLMSG_SETPROPERTY ptr

#define DPL_NOCONFIRMATION 0

type _DPLMSG_SETPROPERTYRESPONSE
	dwType as DWORD
	dwRequestID as DWORD
	guidPlayer as GUID
	guidPropertyTag as GUID
...
type DPLMSG_SETPROPERTYRESPONSE as _DPLMSG_SETPROPERTYRESPONSE
type LPDPLMSG_SETPROPERTYRESPONSE as _DPLMSG_SETPROPERTYRESPONSE ptr

type _DPLMSG_GETPROPERTY
	dwType as DWORD
	dwRequestID as DWORD
	guidPlayer as GUID
	guidPropertyTag as GUID
...
type DPLMSG_GETPROPERTY as _DPLMSG_GETPROPERTY
type LPDPLMSG_GETPROPERTY as _DPLMSG_GETPROPERTY ptr

type _DPLMSG_GETPROPERTYRESPONSE
	dwType as DWORD
	dwRequestID as DWORD
	guidPlayer as GUID
	guidPropertyTag as GUID
...
type DPLMSG_GETPROPERTYRESPONSE as _DPLMSG_GETPROPERTYRESPONSE
type LPDPLMSG_GETPROPERTYRESPONSE as _DPLMSG_GETPROPERTYRESPONSE ptr

type _DPLMSG_NEWSESSIONHOST
	dwType as DWORD
	guidInstance as GUID
end type

type DPLMSG_NEWSESSIONHOST as _DPLMSG_NEWSESSIONHOST
type LPDPLMSG_NEWSESSIONHOST as _DPLMSG_NEWSESSIONHOST ptr
...
type _DPLDATA_PLAYERGUID
	guidPlayer as GUID
	dwPlayerFlags as DWORD
end type

type DPLDATA_PLAYERGUID as _DPLDATA_PLAYERGUID
type LPDPLDATA_PLAYERGUID as _DPLDATA_PLAYERGUID ptr
extern DPLPROPERTY_PlayerScore alias "DPLPROPERTY_PlayerScore" as GUID

type _DPLDATA_PLAYERSCORE
	dwScoreCount as DWORD
	Score(0 to 1-1) as LONG
end type

type DPLDATA_PLAYERSCORE as _DPLDATA_PLAYERSCORE
type LPDPLDATA_PLAYERSCORE as _DPLDATA_PLAYERSCORE ptr
...
type DPCOMPORTADDRESS as _DPCOMPORTADDRESS
