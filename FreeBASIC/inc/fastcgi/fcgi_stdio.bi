...
declare function FCGI_Accept cdecl alias "FCGI_Accept" () as integer
...
declare function FCGI_ferror cdecl alias "FCGI_ferror" (byval fp as FCGI_FILE ptr) as integer
