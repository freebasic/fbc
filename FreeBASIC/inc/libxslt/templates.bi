...
declare function xsltEvalAttrValueTemplate cdecl alias "xsltEvalAttrValueTemplate" (byval ctxt as xsltTransformContextPtr, byval node as xmlNodePtr, byval name as string, byval ns as string) as zstring ptr
declare function xsltEvalStaticAttrValueTemplate cdecl alias "xsltEvalStaticAttrValueTemplate" (byval style as xsltStylesheetPtr, byval node as xmlNodePtr, byval name as string, byval ns as string, byval found as integer ptr) as zstring ptr
...
declare function xsltAttrTemplateValueProcess cdecl alias "xsltAttrTemplateValueProcess" (byval ctxt as xsltTransformContextPtr, byval attr as string) as zstring ptr
declare function xsltAttrTemplateValueProcessNode cdecl alias "xsltAttrTemplateValueProcessNode" (byval ctxt as xsltTransformContextPtr, byval str as string, byval node as xmlNodePtr) as zstring ptr
