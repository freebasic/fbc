...
declare function gdImageStringFTCircle alias "gdImageStringFTCircle" (byval im as gdImagePtr, byval cx as integer, byval cy as integer, byval radius as double, byval textRadius as double, byval fillPortion as double, byval font as string, byval points as double, byval top as string, byval bottom as string, byval fgcolor as integer) as zstring ptr
