''
''
'' objects -- header translated with help of SWIG FB wrapper
''
...
declare sub dWorldGetGravity cdecl alias "dWorldGetGravity" (byval as dWorldID, byval gravity as dVector3)
...
declare sub dBodySetRotation cdecl alias "dBodySetRotation" (byval as dBodyID, byval R as dMatrix3)
declare sub dBodySetQuaternion cdecl alias "dBodySetQuaternion" (byval as dBodyID, byval q as dQuaternion)
