...
declare function wxFrame_Create cdecl alias "wxFrame_Create" (byval self as wxFrame ptr, byval parent as wxWindow ptr, byval id as integer, byval title as zstring ptr, byval pos as wxPoint ptr, byval size as wxSize ptr, byval style as uinteger, byval name as zstring ptr) as integer
...
declare function wxFrame_CreateStatusBar cdecl alias "wxFrame_CreateStatusBar" (byval self as wxFrame ptr, byval number as integer, byval style as uinteger, byval id as wxWindowID, byval name as zstring ptr) as wxStatusBar ptr
...
declare sub wxFrame_SetStatusText cdecl alias "wxFrame_SetStatusText" (byval self as wxFrame ptr, byval text as zstring ptr, byval number as integer)
declare function wxFrame_CreateToolBar cdecl alias "wxFrame_CreateToolBar" (byval self as wxFrame ptr, byval style as uinteger, byval id as wxWindowID, byval name as zstring ptr) as wxToolBar ptr
