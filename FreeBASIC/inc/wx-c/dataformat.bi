...
declare function wxDataFormat_ctorById cdecl alias "wxDataFormat_ctorById" (byval id as zstring ptr) as wxDataFormat ptr
declare function wxDataFormat_GetId cdecl alias "wxDataFormat_GetId" (byval self as wxDataFormat ptr) as wxString ptr
declare sub wxDataFormat_SetId cdecl alias "wxDataFormat_SetId" (byval self as wxDataFormat ptr, byval id as zstring ptr)
