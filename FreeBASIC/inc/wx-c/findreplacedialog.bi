...
declare function wxFindReplaceDialog_Create cdecl alias "wxFindReplaceDialog_Create" (byval self as wxFindReplaceDialog ptr, byval parent as wxWindow ptr, byval data as wxFindReplaceData ptr, byval title as string, byval style as integer) as integer
...
declare sub wxFindDialogEvent_SetFindString cdecl alias "wxFindDialogEvent_SetFindString" (byval self as wxFindDialogEvent ptr, byval str as string)
declare sub wxFindDialogEvent_SetReplaceString cdecl alias "wxFindDialogEvent_SetReplaceString" (byval self as wxFindDialogEvent ptr, byval str as string)
...
declare sub wxFindReplaceData_SetFindString cdecl alias "wxFindReplaceData_SetFindString" (byval self as wxFindReplaceData ptr, byval str as string)
declare sub wxFindReplaceData_SetReplaceString cdecl alias "wxFindReplaceData_SetReplaceString" (byval self as wxFindReplaceData ptr, byval str as string)
