...
declare function wxDirDialog cdecl alias "wxDirDialog_ctor" (byval parent as wxWindow ptr, byval message as string, byval defaultPath as string, byval style as integer, byval pos as wxPoint ptr, byval size as wxSize ptr, byval name as string) as wxDirDialog ptr
...
declare sub wxDirDialog_SetMessage cdecl alias "wxDirDialog_SetMessage" (byval self as wxDirDialog ptr, byval message as string)
...
declare sub wxDirDialog_SetPath cdecl alias "wxDirDialog_SetPath" (byval self as wxDirDialog ptr, byval path as string)
