...
declare function wxToolTip cdecl alias "wxToolTip_ctor" (byval tip as string) as wxToolTip ptr
declare sub wxToolTip_SetTip cdecl alias "wxToolTip_SetTip" (byval self as wxToolTip ptr, byval tip as string)
