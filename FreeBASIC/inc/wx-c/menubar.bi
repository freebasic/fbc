...
declare function wxMenuBar_Append cdecl alias "wxMenuBar_Append" (byval self as wxMenuBar ptr, byval menu as wxMenu ptr, byval title as zstring ptr) as integer
...
declare function wxMenuBar_Insert cdecl alias "wxMenuBar_Insert" (byval self as wxMenuBar ptr, byval pos as integer, byval menu as wxMenu ptr, byval title as zstring ptr) as integer
...
declare function wxMenuBar_Replace cdecl alias "wxMenuBar_Replace" (byval self as wxMenuBar ptr, byval pos as integer, byval menu as wxMenu ptr, byval title as zstring ptr) as wxMenu ptr
...
declare function wxMenuBar_FindMenu cdecl alias "wxMenuBar_FindMenu" (byval self as wxMenuBar ptr, byval title as zstring ptr) as integer
declare function wxMenuBar_FindMenuItem cdecl alias "wxMenuBar_FindMenuItem" (byval self as wxMenuBar ptr, byval menustring as zstring ptr, byval itemString as zstring ptr) as integer
...
declare sub wxMenuBar_SetHelpString cdecl alias "wxMenuBar_SetHelpString" (byval self as wxMenuBar ptr, byval id as integer, byval helpstring as zstring ptr)
declare sub wxMenuBar_SetLabel cdecl alias "wxMenuBar_SetLabel" (byval self as wxMenuBar ptr, byval id as integer, byval label as zstring ptr)
declare sub wxMenuBar_SetLabelTop cdecl alias "wxMenuBar_SetLabelTop" (byval self as wxMenuBar ptr, byval pos as integer, byval label as zstring ptr)
