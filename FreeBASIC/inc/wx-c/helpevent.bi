...
declare sub wxHelpEvent_SetLink cdecl alias "wxHelpEvent_SetLink" (byval self as wxHelpEvent ptr, byval link as string)
declare function wxHelpEvent_GetTarget cdecl alias "wxHelpEvent_GetTarget" (byval self as wxHelpEvent ptr) as wxString ptr
declare sub wxHelpEvent_SetTarget cdecl alias "wxHelpEvent_SetTarget" (byval self as wxHelpEvent ptr, byval target as string)
