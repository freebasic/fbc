...
declare function wxLocale_AddCatalog cdecl alias "wxLocale_AddCatalog" (byval self as wxLocale ptr, byval szDomain as zstring ptr) as integer
declare function wxLocale_AddCatalog2 cdecl alias "wxLocale_AddCatalog2" (byval self as wxLocale ptr, byval szDomain as zstring ptr, byval msgIdLanguage as wxLanguage, byval msgIdCharset as zstring ptr) as integer
declare sub wxLocale_AddCatalogLookupPathPrefix cdecl alias "wxLocale_AddCatalogLookupPathPrefix" (byval self as wxLocale ptr, byval prefix as zstring ptr)
declare sub wxLocale_AddLanguage cdecl alias "wxLocale_AddLanguage" (byval info as wxLanguageInfo ptr)
declare function wxLocale_FindLanguageInfo cdecl alias "wxLocale_FindLanguageInfo" (byval locale as zstring ptr) as wxLanguageInfo ptr
...
declare function wxLocale_GetString cdecl alias "wxLocale_GetString" (byval self as wxLocale ptr, byval szOrigString as zstring ptr, byval szDomain as zstring ptr) as wxString ptr
declare function wxLocale_GetHeaderValue cdecl alias "wxLocale_GetHeaderValue" (byval self as wxLocale ptr, byval szHeader as zstring ptr, byval szDomain as zstring ptr) as wxString ptr
...
declare function wxLocale_IsLoaded cdecl alias "wxLocale_IsLoaded" (byval self as wxLocale ptr, byval domain as zstring ptr) as integer
...
declare sub wxLanguageInfo_SetCanonicalName cdecl alias "wxLanguageInfo_SetCanonicalName" (byval self as wxLanguageInfo ptr, byval name as zstring ptr)
...
declare sub wxLanguageInfo_SetDescription cdecl alias "wxLanguageInfo_SetDescription" (byval self as wxLanguageInfo ptr, byval name as zstring ptr)
