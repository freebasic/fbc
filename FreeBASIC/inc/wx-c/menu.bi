...
declare function wxMenuBase_ctor1 cdecl alias "wxMenuBase_ctor1" (byval title as string, byval style as integer) as wxMenuBase ptr
declare function wxMenuBase_ctor2 cdecl alias "wxMenuBase_ctor2" (byval style as integer) as wxMenuBase ptr
declare function wxMenuBase_Append cdecl alias "wxMenuBase_Append" (byval self as wxMenuBase ptr, byval id as integer, byval item as string, byval helpString as string, byval kind as wxItemKind) as wxMenuItem ptr
...
declare function wxMenuBase_AppendCheckItem cdecl alias "wxMenuBase_AppendCheckItem" (byval self as wxMenuBase ptr, byval itemid as integer, byval text as string, byval help as string) as wxMenuItem ptr
declare function wxMenuBase_AppendRadioItem cdecl alias "wxMenuBase_AppendRadioItem" (byval self as wxMenuBase ptr, byval itemid as integer, byval text as string, byval help as string) as wxMenuItem ptr
declare function wxMenuBase_AppendSubMenu cdecl alias "wxMenuBase_AppendSubMenu" (byval self as wxMenuBase ptr, byval id as integer, byval item as string, byval subMenu as wxMenu ptr, byval helpString as string) as wxMenuItem ptr
...
declare function wxMenuBase_Insert2 cdecl alias "wxMenuBase_Insert2" (byval self as wxMenuBase ptr, byval pos as integer, byval itemid as integer, byval text as string, byval help as string, byval kind as wxItemKind) as wxMenuItem ptr
...
declare function wxMenuBase_InsertCheckItem cdecl alias "wxMenuBase_InsertCheckItem" (byval self as wxMenuBase ptr, byval pos as integer, byval itemid as integer, byval text as string, byval help as string) as wxMenuItem ptr
declare function wxMenuBase_InsertRadioItem cdecl alias "wxMenuBase_InsertRadioItem" (byval self as wxMenuBase ptr, byval pos as integer, byval itemid as integer, byval text as string, byval help as string) as wxMenuItem ptr
declare function wxMenuBase_InsertSubMenu cdecl alias "wxMenuBase_InsertSubMenu" (byval self as wxMenuBase ptr, byval pos as integer, byval itemid as integer, byval text as string, byval submenu as wxMenu ptr, byval help as string) as wxMenuItem ptr
...
declare function wxMenuBase_Prepend2 cdecl alias "wxMenuBase_Prepend2" (byval self as wxMenuBase ptr, byval itemid as integer, byval text as string, byval help as string, byval kind as wxItemKind) as wxMenuItem ptr
...
declare function wxMenuBase_PrependCheckItem cdecl alias "wxMenuBase_PrependCheckItem" (byval self as wxMenuBase ptr, byval itemid as integer, byval text as string, byval help as string) as wxMenuItem ptr
declare function wxMenuBase_PrependRadioItem cdecl alias "wxMenuBase_PrependRadioItem" (byval self as wxMenuBase ptr, byval itemid as integer, byval text as string, byval help as string) as wxMenuItem ptr
declare function wxMenuBase_PrependSubMenu cdecl alias "wxMenuBase_PrependSubMenu" (byval self as wxMenuBase ptr, byval itemid as integer, byval text as string, byval submenu as wxMenu ptr, byval help as string) as wxMenuItem ptr
...
declare function wxMenuBase_FindItem cdecl alias "wxMenuBase_FindItem" (byval self as wxMenuBase ptr, byval item as string) as integer
...
declare sub wxMenuBase_SetLabel cdecl alias "wxMenuBase_SetLabel" (byval self as wxMenuBase ptr, byval itemid as integer, byval label as string)
...
declare sub wxMenuBase_SetHelpString cdecl alias "wxMenuBase_SetHelpString" (byval self as wxMenuBase ptr, byval itemid as integer, byval helpString as string)
...
declare sub wxMenuBase_SetTitle cdecl alias "wxMenuBase_SetTitle" (byval self as wxMenuBase ptr, byval title as string)
...
declare function wxMenu cdecl alias "wxMenu_ctor" (byval titel as string, byval style as integer) as wxMenu ptr
