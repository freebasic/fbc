...
declare sub wxChoice_SetString cdecl alias "wxChoice_SetString" (byval self as wxChoice ptr, byval n as integer, byval text as zstring ptr)
...
declare function wxChoice_FindString cdecl alias "wxChoice_FindString" (byval self as wxChoice ptr, byval string as zstring ptr) as integer
...
declare function wxChoice_Append cdecl alias "wxChoice_Append" (byval self as wxChoice ptr, byval item as zstring ptr) as integer
declare function wxChoice_AppendData cdecl alias "wxChoice_AppendData" (byval self as wxChoice ptr, byval item as zstring ptr, byval clientData as wxClientData ptr) as integer
declare sub wxChoice_AppendString cdecl alias "wxChoice_AppendString" (byval self as wxChoice ptr, byval item as zstring ptr)
...
declare function wxChoice_Insert cdecl alias "wxChoice_Insert" (byval self as wxChoice ptr, byval item as zstring ptr, byval pos as integer) as integer
declare function wxChoice_InsertClientData cdecl alias "wxChoice_InsertClientData" (byval self as wxChoice ptr, byval item as zstring ptr, byval pos as integer, byval clientData as wxClientData ptr) as integer
...
declare function wxChoice_SetStringSelection cdecl alias "wxChoice_SetStringSelection" (byval self as wxChoice ptr, byval s as zstring ptr) as integer
