...
declare function wxToggleButton_Create cdecl alias "wxToggleButton_Create" (byval self as wxToggleButton ptr, byval parent as wxWindow ptr, byval id as wxWindowID, byval label as zstring ptr, byval pos as wxPoint ptr, byval size as wxSize ptr, byval style as integer, byval validator as wxValidator ptr, byval name as zstring ptr) as integer
