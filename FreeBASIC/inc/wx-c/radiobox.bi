...
declare function wxRadioBox_SetStringSelection cdecl alias "wxRadioBox_SetStringSelection" (byval self as wxRadioBox ptr, byval s as zstring ptr) as integer
declare function wxRadioBox_GetCount cdecl alias "wxRadioBox_GetCount" (byval self as wxRadioBox ptr) as integer
declare function wxRadioBox_FindString cdecl alias "wxRadioBox_FindString" (byval self as wxRadioBox ptr, byval s as zstring ptr) as integer
...
declare sub wxRadioBox_SetString cdecl alias "wxRadioBox_SetString" (byval self as wxRadioBox ptr, byval n as integer, byval label as zstring ptr)
...
declare sub wxRadioBox_SetLabel cdecl alias "wxRadioBox_SetLabel" (byval self as wxRadioBox ptr, byval label as zstring ptr)
