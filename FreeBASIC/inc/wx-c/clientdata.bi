...
declare function wxStringClientData cdecl alias "wxStringClientData_ctor" (byval data as string) as wxStringClientData ptr
declare sub wxStringClientData_dtor cdecl alias "wxStringClientData_dtor" (byval self as wxStringClientData ptr)
declare sub wxStringClientData_SetData cdecl alias "wxStringClientData_SetData" (byval self as wxStringClientData ptr, byval data as string)
