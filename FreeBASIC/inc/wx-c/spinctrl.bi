...
declare function wxSpinCtrl_Create cdecl alias "wxSpinCtrl_Create" (byval self as wxSpinCtrl ptr, byval parent as wxWindow ptr, byval id as wxWindowID, byval value as string, byval pos as wxPoint ptr, byval size as wxSize ptr, byval style as integer, byval min as integer, byval max as integer, byval initial as integer, byval name as string) as integer
...
declare sub wxSpinCtrl_SetValueStr cdecl alias "wxSpinCtrl_SetValueStr" (byval self as wxSpinCtrl ptr, byval text as string)
