...
declare function wxListBox_Create cdecl alias "wxListBox_Create" (byval self as wxListBox ptr, byval parent as wxWindow ptr, byval id as wxWindowID, byval pos as wxPoint ptr, byval size as wxSize ptr, byval n as integer, byval items as byte ptr ptr, byval style as integer, byval validator as wxValidator ptr, byval name as string) as integer
...
declare sub wxListBox_SetSingleString cdecl alias "wxListBox_SetSingleString" (byval self as wxListBox ptr, byval n as integer, byval s as string)
declare function wxListBox_FindString cdecl alias "wxListBox_FindString" (byval self as wxListBox ptr, byval s as string) as integer
...
declare sub wxListBox_InsertText cdecl alias "wxListBox_InsertText" (byval self as wxListBox ptr, byval item as string, byval pos as integer)
declare sub wxListBox_InsertTextData cdecl alias "wxListBox_InsertTextData" (byval self as wxListBox ptr, byval item as string, byval pos as integer, byval clientData as any ptr)
declare sub wxListBox_InsertTextClientData cdecl alias "wxListBox_InsertTextClientData" (byval self as wxListBox ptr, byval item as string, byval pos as integer, byval clientData as wxClientData ptr)
...
declare function wxListBox_SetStringSelection cdecl alias "wxListBox_SetStringSelection" (byval self as wxListBox ptr, byval s as string, byval select as integer) as integer
declare sub wxListBox_SetFirstItem cdecl alias "wxListBox_SetFirstItem" (byval self as wxListBox ptr, byval n as integer)
declare sub wxListBox_SetFirstItemText cdecl alias "wxListBox_SetFirstItemText" (byval self as wxListBox ptr, byval s as string)
...
declare sub wxListBox_Append cdecl alias "wxListBox_Append" (byval self as wxListBox ptr, byval item as string)
declare sub wxListBox_AppendClientData cdecl alias "wxListBox_AppendClientData" (byval self as wxListBox ptr, byval item as string, byval clientData as any ptr)

declare function wxCheckListBox_ctor1 cdecl alias "wxCheckListBox_ctor1" () as wxCheckListBox ptr
declare function wxCheckListBox_ctor2 cdecl alias "wxCheckListBox_ctor2" (byval parent as wxWindow ptr, byval id as wxWindowID, byval pos as wxPoint ptr, byval size as wxSize ptr, byval nStrings as integer, byval choices as byte ptr ptr, byval style as integer, byval validator as wxValidator ptr, byval name as string) as wxCheckListBox ptr
