...
declare function wxSingleChoiceDialog cdecl alias "wxSingleChoiceDialog_ctor" (byval parent as wxWindow ptr, byval message as zstring ptr, byval caption as zstring ptr, byval n as integer, byval choices as byte ptr ptr, byval clientData as any ptr, byval style as integer, byval pos as wxPoint ptr) as wxSingleChoiceDialog ptr
...
declare function wxMultiChoiceDialog cdecl alias "wxMultiChoiceDialog_ctor" (byval parent as wxWindow ptr, byval message as zstring ptr, byval caption as zstring ptr, byval n as integer, byval choices as byte ptr ptr, byval style as integer, byval pos as wxPoint ptr) as wxMultiChoiceDialog ptr
...
declare function wxGetSingleChoice_func cdecl alias "wxGetSingleChoice_func" (byval message as zstring ptr, byval caption as zstring ptr, byval n as integer, byval choices as byte ptr ptr, byval parent as wxWindow ptr, byval x as integer, byval y as integer, byval centre as integer, byval width as integer, byval height as integer) as wxString ptr
declare function wxGetSingleChoiceIndex_func cdecl alias "wxGetSingleChoiceIndex_func" (byval message as zstring ptr, byval caption as zstring ptr, byval n as integer, byval choices as byte ptr ptr, byval parent as wxWindow ptr, byval x as integer, byval y as integer, byval centre as integer, byval width as integer, byval height as integer) as integer
