...
declare function wxRadioButton_Create cdecl alias "wxRadioButton_Create" (byval self as wxRadioButton ptr, byval parent as wxWindow ptr, byval id as integer, byval label as zstring ptr, byval pos as wxPoint ptr, byval size as wxSize ptr, byval style as integer, byval val as wxValidator ptr, byval name as zstring ptr) as integer
