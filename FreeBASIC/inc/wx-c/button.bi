...
declare function wxButton_Create cdecl alias "wxButton_Create" (byval self as wxButton ptr, byval parent as wxWindow ptr, byval id as wxWindowID, byval label as string, byval pos as wxPoint ptr, byval size as wxSize ptr, byval style as integer, byval validator as wxValidator ptr, byval name as string) as integer
...
declare sub wxButton_SetLabel cdecl alias "wxButton_SetLabel" (byval self as wxButton ptr, byval label as string)
