...
declare function wxStatusBar_Create cdecl alias "wxStatusBar_Create" (byval self as wxStatusBar ptr, byval parent as wxWindow ptr, byval id as wxWindowID, byval style as uinteger, byval name as zstring ptr) as integer
...
declare sub wxStatusBar_SetStatusText cdecl alias "wxStatusBar_SetStatusText" (byval self as wxStatusBar ptr, byval text as zstring ptr, byval number as integer)
...
declare sub wxStatusBar_PushStatusText cdecl alias "wxStatusBar_PushStatusText" (byval self as wxStatusBar ptr, byval xstring as zstring ptr, byval field as integer)
