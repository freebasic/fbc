...
declare function wxComboBox_Create cdecl alias "wxComboBox_Create" (byval self as wxComboBox ptr, byval window as wxWindow ptr, byval id as integer, byval value as string, byval pos as wxPoint ptr, byval size as wxSize ptr, byval n as integer, byval choices as byte ptr ptr, byval style as integer, byval validator as wxValidator ptr, byval name as string) as integer
declare sub wxComboBox_Append cdecl alias "wxComboBox_Append" (byval self as wxComboBox ptr, byval item as string)
declare sub wxComboBox_AppendData cdecl alias "wxComboBox_AppendData" (byval self as wxComboBox ptr, byval item as string, byval data as any ptr)
...
declare function wxComboBox_FindString cdecl alias "wxComboBox_FindString" (byval self as wxComboBox ptr, byval str as string) as integer
...
declare sub wxComboBox_SetStringSelection cdecl alias "wxComboBox_SetStringSelection" (byval self as wxComboBox ptr, byval str as string)
...
declare sub wxComboBox_Replace cdecl alias "wxComboBox_Replace" (byval self as wxComboBox ptr, byval from as integer, byval to as integer, byval value as string)
...
declare sub wxComboBox_SetValue cdecl alias "wxComboBox_SetValue" (byval self as wxComboBox ptr, byval text as string)
