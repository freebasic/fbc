...
declare function wxDialog_Create cdecl alias "wxDialog_Create" (byval self as wxDialog ptr, byval parent as wxWindow ptr, byval id as integer, byval title as zstring ptr, byval pos as wxPoint ptr, byval size as wxSize ptr, byval style as integer, byval name as zstring ptr) as integer
...
declare sub wxDialog_SetTitle cdecl alias "wxDialog_SetTitle" (byval self as wxDialog ptr, byval title as zstring ptr)
