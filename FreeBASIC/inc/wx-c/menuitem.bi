...
declare function wxMenuItem cdecl alias "wxMenuItem_ctor" (byval parentMenu as wxMenu ptr, byval id as integer, byval text as zstring ptr, byval help as zstring ptr, byval kind as wxItemKind, byval subMenu as wxMenu ptr) as wxMenuItem ptr
...
declare sub wxMenuItem_SetText cdecl alias "wxMenuItem_SetText" (byval self as wxMenuItem ptr, byval str as zstring ptr)
...
declare function wxMenuItem_GetLabelFromText cdecl alias "wxMenuItem_GetLabelFromText" (byval self as wxMenuItem ptr, byval text as zstring ptr) as wxString ptr
...
declare sub wxMenuItem_SetHelp cdecl alias "wxMenuItem_SetHelp" (byval self as wxMenuItem ptr, byval str as zstring ptr)
...
declare sub wxMenuItem_SetName cdecl alias "wxMenuItem_SetName" (byval self as wxMenuItem ptr, byval str as zstring ptr)
declare function wxMenuItem_GetName cdecl alias "wxMenuItem_GetName" (byval self as wxMenuItem ptr) as wxString ptr
declare function wxMenuItem_NewCheck cdecl alias "wxMenuItem_NewCheck" (byval parentMenu as wxMenu ptr, byval id as integer, byval text as zstring ptr, byval help as zstring ptr, byval isCheckable as integer, byval subMenu as wxMenu ptr) as wxMenuItem ptr
declare function wxMenuItem_New cdecl alias "wxMenuItem_New" (byval parentMenu as wxMenu ptr, byval id as integer, byval text as zstring ptr, byval help as zstring ptr, byval kind as wxItemKind, byval subMenu as wxMenu ptr) as wxMenuItem ptr
