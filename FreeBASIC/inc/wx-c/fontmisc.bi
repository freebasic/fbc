...
declare function wxFontMapper_GetEncodingFromName cdecl alias "wxFontMapper_GetEncodingFromName" (byval name as zstring ptr) as wxFontEncoding
declare function wxFontMapper_CharsetToEncoding cdecl alias "wxFontMapper_CharsetToEncoding" (byval self as wxFontMapper ptr, byval charset as zstring ptr, byval interactive as integer) as wxFontEncoding
declare function wxFontMapper_IsEncodingAvailable cdecl alias "wxFontMapper_IsEncodingAvailable" (byval self as wxFontMapper ptr, byval encoding as wxFontEncoding, byval facename as zstring ptr) as integer
declare function wxFontMapper_GetAltForEncoding cdecl alias "wxFontMapper_GetAltForEncoding" (byval self as wxFontMapper ptr, byval encoding as wxFontEncoding, byval alt_encoding as wxFontEncoding ptr, byval facename as zstring ptr, byval interactive as integer) as integer
...
declare sub wxFontMapper_SetDialogTitle cdecl alias "wxFontMapper_SetDialogTitle" (byval self as wxFontMapper ptr, byval title as zstring ptr)
...
declare function wxEncodingConverter_Convert cdecl alias "wxEncodingConverter_Convert" (byval self as wxEncodingConverter ptr, byval input as zstring ptr) as wxString ptr
...
declare function wxFontEnumerator_OnFacename cdecl alias "wxFontEnumerator_OnFacename" (byval self as _FontEnumerator ptr, byval facename as zstring ptr) as integer
declare function wxFontEnumerator_OnFontEncoding cdecl alias "wxFontEnumerator_OnFontEncoding" (byval self as _FontEnumerator ptr, byval facename as zstring ptr, byval encoding as zstring ptr) as integer
...
declare function wxFontEnumerator_EnumerateEncodings cdecl alias "wxFontEnumerator_EnumerateEncodings" (byval self as _FontEnumerator ptr, byval facename as zstring ptr) as integer
