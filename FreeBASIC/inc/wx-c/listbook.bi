...
declare function wxListbook_Create cdecl alias "wxListbook_Create" (byval self as wxListbook ptr, byval parent as wxWindow ptr, byval id as wxWindowID, byval pos as wxPoint ptr, byval size as wxSize ptr, byval style as integer, byval name as zstring ptr) as integer
declare function wxListbook_GetSelection cdecl alias "wxListbook_GetSelection" (byval self as wxListbook ptr) as integer
declare function wxListbook_SetPageText cdecl alias "wxListbook_SetPageText" (byval self as wxListbook ptr, byval n as integer, byval strText as zstring ptr) as integer
...
declare function wxListbook_InsertPage cdecl alias "wxListbook_InsertPage" (byval self as wxListbook ptr, byval n as integer, byval page as wxWindow ptr, byval text as zstring ptr, byval bSelect as integer, byval imageId as integer) as integer
...
declare function wxListbook_AddPage cdecl alias "wxListbook_AddPage" (byval self as wxListbook ptr, byval page as wxWindow ptr, byval text as zstring ptr, byval bselect as integer, byval imageId as integer) as integer
