...
declare function wxFont cdecl alias "wxFont_ctor" (byval pointSize as integer, byval family as integer, byval style as integer, byval weight as integer, byval underline as integer, byval faceName as string, byval encoding as wxFontEncoding) as wxFont ptr
...
declare sub wxFont_SetFaceName cdecl alias "wxFont_SetFaceName" (byval self as wxFont ptr, byval faceName as string)
...
declare sub wxFont_SetNativeFontInfoUserDesc cdecl alias "wxFont_SetNativeFontInfoUserDesc" (byval self as wxFont ptr, byval info as string)
...
declare function wxFont_New cdecl alias "wxFont_New" (byval strNativeFontDesc as string) as wxFont ptr
