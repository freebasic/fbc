...
declare function wxImage_ctorByName cdecl alias "wxImage_ctorByName" (byval name as zstring ptr, byval type as integer) as wxImage ptr
...
declare function wxImage_LoadFileByTypeId cdecl alias "wxImage_LoadFileByTypeId" (byval self as wxImage ptr, byval name as zstring ptr, byval type as integer, byval index as integer) as integer
declare function wxImage_LoadFileByMimeTypeId cdecl alias "wxImage_LoadFileByMimeTypeId" (byval self as wxImage ptr, byval name as zstring ptr, byval mimetype as zstring ptr, byval index as integer) as integer
declare function wxImage_SaveFileByType cdecl alias "wxImage_SaveFileByType" (byval self as wxImage ptr, byval name as zstring ptr, byval type as integer) as integer
declare function wxImage_SaveFileByMimeType cdecl alias "wxImage_SaveFileByMimeType" (byval self as wxImage ptr, byval name as zstring ptr, byval mimetype as zstring ptr) as integer
...
declare function wxImage_CanRead cdecl alias "wxImage_CanRead" (byval name as zstring ptr) as integer
declare function wxImage_GetImageCount cdecl alias "wxImage_GetImageCount" (byval name as zstring ptr, byval type as integer) as integer
...
declare sub wxImage_SetOption cdecl alias "wxImage_SetOption" (byval self as wxImage ptr, byval name as zstring ptr, byval value as zstring ptr)
declare sub wxImage_SetOption2 cdecl alias "wxImage_SetOption2" (byval self as wxImage ptr, byval name as zstring ptr, byval value as integer)
declare function wxImage_GetOption cdecl alias "wxImage_GetOption" (byval self as wxImage ptr, byval name as zstring ptr) as wxString ptr
declare function wxImage_GetOptionInt cdecl alias "wxImage_GetOptionInt" (byval self as wxImage ptr, byval name as zstring ptr) as integer
declare function wxImage_HasOption cdecl alias "wxImage_HasOption" (byval self as wxImage ptr, byval name as zstring ptr) as integer
...
declare function wxImage_RemoveHandler cdecl alias "wxImage_RemoveHandler" (byval name as zstring ptr) as integer
declare function wxImage_FindHandler cdecl alias "wxImage_FindHandler" (byval name as zstring ptr) as wxImageHandler ptr
declare function wxImage_FindHandler2 cdecl alias "wxImage_FindHandler2" (byval name as zstring ptr, byval imageType as integer) as wxImageHandler ptr
declare function wxImage_FindHandler3 cdecl alias "wxImage_FindHandler3" (byval imageType as integer) as wxImageHandler ptr
declare function wxImage_FindHandlerMime cdecl alias "wxImage_FindHandlerMime" (byval mimetype as zstring ptr) as wxImageHandler ptr
...
declare sub wxImageHandler_SetName cdecl alias "wxImageHandler_SetName" (byval self as wxImageHandler ptr, byval name as zstring ptr)
declare sub wxImageHandler_SetExtension cdecl alias "wxImageHandler_SetExtension" (byval self as wxImageHandler ptr, byval ext as zstring ptr)
...
declare sub wxImageHandler_SetMimeType cdecl alias "wxImageHandler_SetMimeType" (byval self as wxImageHandler ptr, byval type as zstring ptr)
