...
declare function wxPanel_ctor2 cdecl alias "wxPanel_ctor2" (byval parent as wxWindow ptr, byval id as wxWindowID, byval pos as wxPoint ptr, byval size as wxSize ptr, byval style as integer, byval name as zstring ptr) as wxPanel ptr
declare function wxPanel_Create cdecl alias "wxPanel_Create" (byval self as wxPanel ptr, byval parent as wxWindow ptr, byval id as wxWindowID, byval pos as wxPoint ptr, byval size as wxSize ptr, byval style as integer, byval name as zstring ptr) as integer
