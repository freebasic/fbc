...
declare function gsl_vector_float_fprintf cdecl alias "gsl_vector_float_fprintf" (byval stream as FILE ptr, byval v as gsl_vector_float ptr, byval format as zstring ptr) as integer
