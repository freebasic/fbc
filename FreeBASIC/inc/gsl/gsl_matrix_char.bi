...
declare function gsl_matrix_char_alloc cdecl alias "gsl_matrix_char_alloc" (byval n1 as integer, byval n2 as integer) as gsl_matrix_char ptr
declare function gsl_matrix_char_calloc cdecl alias "gsl_matrix_char_calloc" (byval n1 as integer, byval n2 as integer) as gsl_matrix_char ptr
declare function gsl_matrix_char_alloc_from_block cdecl alias "gsl_matrix_char_alloc_from_block" (byval b as gsl_block_char ptr, byval offset as integer, byval n1 as integer, byval n2 as integer, byval d2 as integer) as gsl_matrix_char ptr
declare function gsl_matrix_char_alloc_from_matrix cdecl alias "gsl_matrix_char_alloc_from_matrix" (byval m as gsl_matrix_char ptr, byval k1 as integer, byval k2 as integer, byval n1 as integer, byval n2 as integer) as gsl_matrix_char ptr
declare function gsl_vector_char_alloc_row_from_matrix cdecl alias "gsl_vector_char_alloc_row_from_matrix" (byval m as gsl_matrix_char ptr, byval i as integer) as gsl_vector_char ptr
declare function gsl_vector_char_alloc_col_from_matrix cdecl alias "gsl_vector_char_alloc_col_from_matrix" (byval m as gsl_matrix_char ptr, byval j as integer) as gsl_vector_char ptr
declare sub gsl_matrix_char_free cdecl alias "gsl_matrix_char_free" (byval m as gsl_matrix_char ptr)
declare function gsl_matrix_char_submatrix cdecl alias "gsl_matrix_char_submatrix" (byval m as gsl_matrix_char ptr, byval i as integer, byval j as integer, byval n1 as integer, byval n2 as integer) as _gsl_matrix_char_view
declare function gsl_matrix_char_row cdecl alias "gsl_matrix_char_row" (byval m as gsl_matrix_char ptr, byval i as integer) as _gsl_vector_char_view
declare function gsl_matrix_char_column cdecl alias "gsl_matrix_char_column" (byval m as gsl_matrix_char ptr, byval j as integer) as _gsl_vector_char_view
...
declare function gsl_matrix_char_const_row cdecl alias "gsl_matrix_char_const_row" (byval m as gsl_matrix_char ptr, byval i as integer) as _gsl_vector_char_const_view
declare function gsl_matrix_char_const_column cdecl alias "gsl_matrix_char_const_column" (byval m as gsl_matrix_char ptr, byval j as integer) as _gsl_vector_char_const_view
...
declare sub gsl_matrix_char_set cdecl alias "gsl_matrix_char_set" (byval m as gsl_matrix_char ptr, byval i as integer, byval j as integer, byval x as byte)
declare function gsl_matrix_char_ptr cdecl alias "gsl_matrix_char_ptr" (byval m as gsl_matrix_char ptr, byval i as integer, byval j as integer) as zstring ptr
declare function gsl_matrix_char_const_ptr cdecl alias "gsl_matrix_char_const_ptr" (byval m as gsl_matrix_char ptr, byval i as integer, byval j as integer) as zstring ptr
declare sub gsl_matrix_char_set_zero cdecl alias "gsl_matrix_char_set_zero" (byval m as gsl_matrix_char ptr)
declare sub gsl_matrix_char_set_identity cdecl alias "gsl_matrix_char_set_identity" (byval m as gsl_matrix_char ptr)
declare sub gsl_matrix_char_set_all cdecl alias "gsl_matrix_char_set_all" (byval m as gsl_matrix_char ptr, byval x as byte)
...
declare function gsl_matrix_char_swap_columns cdecl alias "gsl_matrix_char_swap_columns" (byval m as gsl_matrix_char ptr, byval i as integer, byval j as integer) as integer
declare function gsl_matrix_char_swap_rowcol cdecl alias "gsl_matrix_char_swap_rowcol" (byval m as gsl_matrix_char ptr, byval i as integer, byval j as integer) as integer
declare function gsl_matrix_char_transpose cdecl alias "gsl_matrix_char_transpose" (byval m as gsl_matrix_char ptr) as integer
...
declare function gsl_matrix_char_isnull cdecl alias "gsl_matrix_char_isnull" (byval m as gsl_matrix_char ptr) as integer
declare function gsl_matrix_char_add cdecl alias "gsl_matrix_char_add" (byval a as gsl_matrix_char ptr, byval b as gsl_matrix_char ptr) as integer
declare function gsl_matrix_char_sub cdecl alias "gsl_matrix_char_sub" (byval a as gsl_matrix_char ptr, byval b as gsl_matrix_char ptr) as integer
declare function gsl_matrix_char_mul_elements cdecl alias "gsl_matrix_char_mul_elements" (byval a as gsl_matrix_char ptr, byval b as gsl_matrix_char ptr) as integer
declare function gsl_matrix_char_div_elements cdecl alias "gsl_matrix_char_div_elements" (byval a as gsl_matrix_char ptr, byval b as gsl_matrix_char ptr) as integer
declare function gsl_matrix_char_scale cdecl alias "gsl_matrix_char_scale" (byval a as gsl_matrix_char ptr, byval x as double) as integer
declare function gsl_matrix_char_add_constant cdecl alias "gsl_matrix_char_add_constant" (byval a as gsl_matrix_char ptr, byval x as double) as integer
declare function gsl_matrix_char_add_diagonal cdecl alias "gsl_matrix_char_add_diagonal" (byval a as gsl_matrix_char ptr, byval x as double) as integer
declare function gsl_matrix_char_get_row cdecl alias "gsl_matrix_char_get_row" (byval v as gsl_vector_char ptr, byval m as gsl_matrix_char ptr, byval i as integer) as integer
declare function gsl_matrix_char_get_col cdecl alias "gsl_matrix_char_get_col" (byval v as gsl_vector_char ptr, byval m as gsl_matrix_char ptr, byval j as integer) as integer
declare function gsl_matrix_char_set_row cdecl alias "gsl_matrix_char_set_row" (byval m as gsl_matrix_char ptr, byval i as integer, byval v as gsl_vector_char ptr) as integer
declare function gsl_matrix_char_set_col cdecl alias "gsl_matrix_char_set_col" (byval m as gsl_matrix_char ptr, byval j as integer, byval v as gsl_vector_char ptr) as integer
