...
declare function gsl_block_long_fprintf cdecl alias "gsl_block_long_fprintf" (byval stream as FILE ptr, byval b as gsl_block_long ptr, byval format as string) as integer
...
declare function gsl_block_long_raw_fprintf cdecl alias "gsl_block_long_raw_fprintf" (byval stream as FILE ptr, byval b as integer ptr, byval n as integer, byval stride as integer, byval format as string) as integer
