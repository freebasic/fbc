...
declare function gsl_vector_complex_long_double_fprintf cdecl alias "gsl_vector_complex_long_double_fprintf" (byval stream as FILE ptr, byval v as gsl_vector_complex_long_double ptr, byval format as zstring ptr) as integer
