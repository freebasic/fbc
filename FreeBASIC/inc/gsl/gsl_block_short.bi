...
declare function gsl_block_short_fprintf cdecl alias "gsl_block_short_fprintf" (byval stream as FILE ptr, byval b as gsl_block_short ptr, byval format as string) as integer
...
declare function gsl_block_short_raw_fprintf cdecl alias "gsl_block_short_raw_fprintf" (byval stream as FILE ptr, byval b as short ptr, byval n as integer, byval stride as integer, byval format as string) as integer
