...
declare sub gsl_error cdecl alias "gsl_error" (byval reason as string, byval file as string, byval line as integer, byval gsl_errno as integer)
declare sub gsl_stream_printf cdecl alias "gsl_stream_printf" (byval label as string, byval file as string, byval line as integer, byval reason as string)
