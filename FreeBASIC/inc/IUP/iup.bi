...
declare function IupGetFile cdecl alias "IupGetFile" (byval arq as string) as integer
declare sub IupMessage cdecl alias "IupMessage" (byval title as string, byval msg as string)
declare sub IupMessagef cdecl alias "IupMessagef" (byval title as string, byval format as string, ...)
declare function IupAlarm cdecl alias "IupAlarm" (byval title as string, byval msg as string, byval b1 as string, byval b2 as string, byval b3 as string) as integer
declare function IupScanf cdecl alias "IupScanf" (byval format as string, ...) as integer
declare function IupListDialog cdecl alias "IupListDialog" (byval type as integer, byval title as string, byval size as integer, byval lst as byte ptr ptr, byval op as integer, byval col as integer, byval line as integer, byval marks as integer ptr) as integer
declare function IupGetText cdecl alias "IupGetText" (byval title as string, byval text as string) as integer
declare function IupMapFont cdecl alias "IupMapFont" (byval iupfont as string) as zstring ptr
declare function IupUnMapFont cdecl alias "IupUnMapFont" (byval driverfont as string) as zstring ptr
...
declare function IupHelp cdecl alias "IupHelp" (byval url as string) as integer
...
declare sub IupSetLanguage cdecl alias "IupSetLanguage" (byval lng as string)
declare function IupGetLanguage cdecl alias "IupGetLanguage" () as zstring ptr
declare function IupLoad cdecl alias "IupLoad" (byval fn as string) as zstring ptr
declare sub IupSetAttribute cdecl alias "IupSetAttribute" (byval n as Ihandle ptr, byval a as string, byval v as string)
declare sub IupStoreAttribute cdecl alias "IupStoreAttribute" (byval n as Ihandle ptr, byval a as string, byval v as string)
declare function IupSetAttributes cdecl alias "IupSetAttributes" (byval n as Ihandle ptr, byval e as string) as Ihandle ptr
declare function IupGetAttribute cdecl alias "IupGetAttribute" (byval n as Ihandle ptr, byval a as string) as zstring ptr
declare function IupGetAttributes cdecl alias "IupGetAttributes" (byval n as Ihandle ptr) as zstring ptr
declare function IupGetInt cdecl alias "IupGetInt" (byval n as Ihandle ptr, byval a as string) as integer
declare function IupGetInt2 cdecl alias "IupGetInt2" (byval n as Ihandle ptr, byval a as string) as integer
declare function IupGetFloat cdecl alias "IupGetFloat" (byval n as Ihandle ptr, byval a as string) as single
declare sub IupSetfAttribute cdecl alias "IupSetfAttribute" (byval n as Ihandle ptr, byval a as string, byval f as string, ...)
declare sub IupSetGlobal cdecl alias "IupSetGlobal" (byval key as string, byval value as string)
declare sub IupStoreGlobal cdecl alias "IupStoreGlobal" (byval key as string, byval value as string)
declare function IupGetGlobal cdecl alias "IupGetGlobal" (byval key as string) as zstring ptr
...
declare function IupGetFunction cdecl alias "IupGetFunction" (byval n as string) as Icallback
declare function IupSetFunction cdecl alias "IupSetFunction" (byval n as string, byval fa as Icallback) as Icallback
...
declare function IupGetHandle cdecl alias "IupGetHandle" (byval name as string) as Ihandle ptr
declare function IupSetHandle cdecl alias "IupSetHandle" (byval name as string, byval exp as Ihandle ptr) as Ihandle ptr
...
declare function IupCreate cdecl alias "IupCreate" (byval class_name as string) as Ihandle ptr
declare function IupCreatev cdecl alias "IupCreatev" (byval name as string, byval children as Ihandle ptr ptr) as Ihandle ptr
declare function IupCreatep cdecl alias "IupCreatep" (byval name as string, byval first as Ihandle ptr, ...) as Ihandle ptr
...
declare function IupImage cdecl alias "IupImage" (byval width as uinteger, byval height as uinteger, byval pixmap as string) as Ihandle ptr
declare function IupButton cdecl alias "IupButton" (byval label as string, byval action as string) as Ihandle ptr
declare function IupCanvas cdecl alias "IupCanvas" (byval repaint as string) as Ihandle ptr
...
declare function IupItem cdecl alias "IupItem" (byval label as string, byval action as string) as Ihandle ptr
declare function IupSubmenu cdecl alias "IupSubmenu" (byval label as string, byval exp as Ihandle ptr) as Ihandle ptr
declare function IupSeparator cdecl alias "IupSeparator" () as Ihandle ptr
declare function IupLabel cdecl alias "IupLabel" (byval label as string) as Ihandle ptr
declare function IupList cdecl alias "IupList" (byval action as string) as Ihandle ptr
declare function IupMenu cdecl alias "IupMenu" (byval exp as Ihandle ptr, ...) as Ihandle ptr
declare function IupText cdecl alias "IupText" (byval action as string) as Ihandle ptr
declare function IupMultiLine cdecl alias "IupMultiLine" (byval action as string) as Ihandle ptr
declare function IupToggle cdecl alias "IupToggle" (byval label as string, byval action as string) as Ihandle ptr
