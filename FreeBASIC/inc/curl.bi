...
#define LIBCURL_VERSION "7.13.0"
#define LIBCURL_VERSION_NUM &h070d00
...
declare function curl_getdate cdecl alias "curl_getdate" (byval p as zstring ptr, byval now as time_t ptr) as time_t
