...
declare function gdsl_stack_get_size cdecl alias "gdsl_stack_get_size" (byval S as gdsl_stack_t) as ulong
declare function gdsl_stack_get_growing_factor cdecl alias "gdsl_stack_get_growing_factor" (byval S as gdsl_stack_t) as ubyte
...
declare function gdsl_stack_search cdecl alias "gdsl_stack_search" (byval S as gdsl_stack_t, byval COMP_F as gdsl_compare_func_t, byval VALUE as any ptr) as gdsl_element_t
declare function gdsl_stack_search_by_position cdecl alias "gdsl_stack_search_by_position" (byval S as gdsl_stack_t, byval POS as ulong) as gdsl_element_t
declare function gdsl_stack_map_forward cdecl alias "gdsl_stack_map_forward" (byval S as gdsl_stack_t, byval MAP_F as gdsl_map_func_t, byval USER_DATA as any ptr) as gdsl_element_t
declare function gdsl_stack_map_backward cdecl alias "gdsl_stack_map_backward" (byval S as gdsl_stack_t, byval MAP_F as gdsl_map_func_t, byval USER_DATA as any ptr) as gdsl_element_t
declare sub gdsl_stack_write cdecl alias "gdsl_stack_write" (byval S as gdsl_stack_t, byval WRITE_F as gdsl_write_func_t, byval OUTPUT_FILE as FILE ptr, byval USER_DATA as any ptr)
declare sub gdsl_stack_write_xml cdecl alias "gdsl_stack_write_xml" (byval S as gdsl_stack_t, byval WRITE_F as gdsl_write_func_t, byval OUTPUT_FILE as FILE ptr, byval USER_DATA as any ptr)
declare sub gdsl_stack_dump cdecl alias "gdsl_stack_dump" (byval S as gdsl_stack_t, byval WRITE_F as gdsl_write_func_t, byval OUTPUT_FILE as FILE ptr, byval USER_DATA as any ptr)
