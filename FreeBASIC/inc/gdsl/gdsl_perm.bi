...
declare function gdsl_perm_get_size cdecl alias "gdsl_perm_get_size" (byval P as gdsl_perm_t) as ulong
declare function gdsl_perm_get_element cdecl alias "gdsl_perm_get_element" (byval P as gdsl_perm_t, byval INDIX as ulong) as ulong
declare function gdsl_perm_get_elements_array cdecl alias "gdsl_perm_get_elements_array" (byval P as gdsl_perm_t) as ulong ptr
...
declare function gdsl_perm_multiply cdecl alias "gdsl_perm_multiply" (byval RESULT as gdsl_perm_t, byval ALPHA as gdsl_perm_t, byval BETA as gdsl_perm_t) as gdsl_perm_t
declare function gdsl_perm_linear_to_canonical cdecl alias "gdsl_perm_linear_to_canonical" (byval Q as gdsl_perm_t, byval P as gdsl_perm_t) as gdsl_perm_t
declare function gdsl_perm_canonical_to_linear cdecl alias "gdsl_perm_canonical_to_linear" (byval Q as gdsl_perm_t, byval P as gdsl_perm_t) as gdsl_perm_t
declare function gdsl_perm_inverse cdecl alias "gdsl_perm_inverse" (byval P as gdsl_perm_t) as gdsl_perm_t
declare function gdsl_perm_reverse cdecl alias "gdsl_perm_reverse" (byval P as gdsl_perm_t) as gdsl_perm_t
declare function gdsl_perm_randomize cdecl alias "gdsl_perm_randomize" (byval P as gdsl_perm_t) as gdsl_perm_t
declare function gdsl_perm_apply_on_array cdecl alias "gdsl_perm_apply_on_array" (byval V as gdsl_element_t ptr, byval P as gdsl_perm_t) as gdsl_element_t ptr
declare sub gdsl_perm_write cdecl alias "gdsl_perm_write" (byval P as gdsl_perm_t, byval WRITE_F as gdsl_perm_write_func_t, byval OUTPUT_FILE as FILE ptr, byval USER_DATA as any ptr)
declare sub gdsl_perm_write_xml cdecl alias "gdsl_perm_write_xml" (byval P as gdsl_perm_t, byval WRITE_F as gdsl_write_func_t, byval OUTPUT_FILE as FILE ptr, byval USER_DATA as any ptr)
declare sub gdsl_perm_dump cdecl alias "gdsl_perm_dump" (byval P as gdsl_perm_t, byval WRITE_F as gdsl_write_func_t, byval OUTPUT_FILE as FILE ptr, byval USER_DATA as any ptr)
