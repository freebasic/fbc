...
declare function gdsl_hash cdecl alias "gdsl_hash" (byval KEY as zstring ptr) as ulong
declare function gdsl_hash_alloc cdecl alias "gdsl_hash_alloc" (byval NAME as zstring ptr, byval ALLOC_F as gdsl_alloc_func_t, byval FREE_F as gdsl_free_func_t, byval KEY_F as gdsl_key_func_t, byval HASH_F as gdsl_hash_func_t, byval INITIAL_ENTRIES_NB as ushort) as gdsl_hash_t
...
declare function gdsl_hash_set_name cdecl alias "gdsl_hash_set_name" (byval H as gdsl_hash_t, byval NEW_NAME as zstring ptr) as gdsl_hash_t
...
declare function gdsl_hash_remove cdecl alias "gdsl_hash_remove" (byval H as gdsl_hash_t, byval KEY as zstring ptr) as gdsl_element_t
declare function gdsl_hash_delete cdecl alias "gdsl_hash_delete" (byval H as gdsl_hash_t, byval KEY as zstring ptr) as gdsl_hash_t
...
declare function gdsl_hash_search cdecl alias "gdsl_hash_search" (byval H as gdsl_hash_t, byval KEY as zstring ptr) as gdsl_element_t
