...
declare function sqlite3_exec cdecl alias "sqlite3_exec" (byval as sqlite3 ptr, byval sql as zstring ptr, byval as sqlite3_callback, byval as any ptr, byval errmsg as zstring ptr ptr) as integer
...
declare function sqlite3_complete cdecl alias "sqlite3_complete" (byval sql as zstring ptr) as integer
declare function sqlite3_complete16 cdecl alias "sqlite3_complete16" (byval sql as sqlite_wchar ptr) as integer
declare function sqlite3_busy_handler cdecl alias "sqlite3_busy_handler" (byval as sqlite3 ptr, byval as function cdecl(byval as any ptr, byval as integer) as integer, byval as any ptr) as integer
...
declare function sqlite3_get_table cdecl alias "sqlite3_get_table" (byval as sqlite3 ptr, byval sql as zstring ptr, byval resultp as zstring ptr ptr ptr, byval nrow as integer ptr, byval ncolumn as integer ptr, byval errmsg as zstring ptr ptr) as integer
declare sub sqlite3_free_table cdecl alias "sqlite3_free_table" (byval result as zstring ptr ptr)
...
declare function sqlite3_set_authorizer cdecl alias "sqlite3_set_authorizer" (byval as sqlite3 ptr, byval xAuth as function cdecl(byval as any ptr, byval as integer, byval as zstring ptr, byval as zstring ptr, byval as zstring ptr, byval as zstring ptr) as integer, byval pUserData as any ptr) as integer
...
declare function sqlite3_trace cdecl alias "sqlite3_trace" (byval as sqlite3 ptr, byval xTrace as sub cdecl(byval as any ptr, byval as zstring ptr), byval as any ptr) as any ptr
declare sub sqlite3_progress_handler cdecl alias "sqlite3_progress_handler" (byval as sqlite3 ptr, byval as integer, byval as function cdecl(byval as any ptr) as integer, byval as any ptr)
declare function sqlite3_commit_hook cdecl alias "sqlite3_commit_hook" (byval as sqlite3 ptr, byval as function cdecl(byval as any ptr) as integer, byval as any ptr) as any ptr
declare function sqlite3_open cdecl alias "sqlite3_open" (byval filename as zstring ptr, byval ppDb as sqlite3 ptr ptr) as integer
declare function sqlite3_open16 cdecl alias "sqlite3_open16" (byval filename as sqlite_wchar ptr, byval ppDb as sqlite3 ptr ptr) as integer
...
declare function sqlite3_errmsg16 cdecl alias "sqlite3_errmsg16" (byval as sqlite3 ptr) as sqlite_wchar ptr

type sqlite3_stmt as any

declare function sqlite3_prepare cdecl alias "sqlite3_prepare" (byval db as sqlite3 ptr, byval zSql as zstring ptr, byval nBytes as integer, byval ppStmt as sqlite3_stmt ptr ptr, byval pzTail as zstring ptr ptr) as integer
declare function sqlite3_prepare16 cdecl alias "sqlite3_prepare16" (byval db as sqlite3 ptr, byval zSql as sqlite_wchar ptr, byval nBytes as integer, byval ppStmt as sqlite3_stmt ptr ptr, byval pzTail as sqlite_wchar ptr ptr) as integer

type sqlite3_context as any
type sqlite3_value as any

declare function sqlite3_bind_blob cdecl alias "sqlite3_bind_blob" (byval as sqlite3_stmt ptr, byval as integer, byval as any ptr, byval n as integer, byval as sub cdecl(byval as any ptr)) as integer
...
declare function sqlite3_bind_text cdecl alias "sqlite3_bind_text" (byval as sqlite3_stmt ptr, byval as integer, byval as zstring ptr, byval n as integer, byval as sub cdecl(byval as any ptr)) as integer
declare function sqlite3_bind_text16 cdecl alias "sqlite3_bind_text16" (byval as sqlite3_stmt ptr, byval as integer, byval as sqlite_wchar ptr, byval as integer, byval as sub cdecl(byval as any ptr)) as integer
...
declare function sqlite3_bind_parameter_index cdecl alias "sqlite3_bind_parameter_index" (byval as sqlite3_stmt ptr, byval zName as zstring ptr) as integer
...
declare function sqlite3_column_name16 cdecl alias "sqlite3_column_name16" (byval as sqlite3_stmt ptr, byval as integer) as sqlite_wchar ptr
declare function sqlite3_column_decltype cdecl alias "sqlite3_column_decltype" (byval as sqlite3_stmt ptr, byval as integer) as zstring ptr
declare function sqlite3_column_decltype16 cdecl alias "sqlite3_column_decltype16" (byval as sqlite3_stmt ptr, byval as integer) as sqlite_wchar ptr
...
declare function sqlite3_column_text cdecl alias "sqlite3_column_text" (byval as sqlite3_stmt ptr, byval iCol as integer) as zstring ptr
declare function sqlite3_column_text16 cdecl alias "sqlite3_column_text16" (byval as sqlite3_stmt ptr, byval iCol as integer) as sqlite_wchar ptr
...
declare function sqlite3_create_function cdecl alias "sqlite3_create_function" (byval as sqlite3 ptr, byval zFunctionName as zstring ptr, byval nArg as integer, byval eTextRep as integer, byval as any ptr, byval xFunc as sub cdecl(byval as sqlite3_context ptr, byval as integer, byval as sqlite3_value ptr ptr), byval xStep as sub cdecl(byval as sqlite3_context ptr, byval as integer, byval as sqlite3_value ptr ptr), byval xFinal as sub cdecl(byval as sqlite3_context ptr)) as integer
declare function sqlite3_create_function16 cdecl alias "sqlite3_create_function16" (byval as sqlite3 ptr, byval zFunctionName as sqlite_wchar ptr, byval nArg as integer, byval eTextRep as integer, byval as any ptr, byval xFunc as sub cdecl(byval as sqlite3_context ptr, byval as integer, byval as sqlite3_value ptr ptr), byval xStep as sub cdecl(byval as sqlite3_context ptr, byval as integer, byval as sqlite3_value ptr ptr), byval xFinal as sub cdecl(byval as sqlite3_context ptr)) as integer
...
declare function sqlite3_value_text cdecl alias "sqlite3_value_text" (byval as sqlite3_value ptr) as zstring ptr
declare function sqlite3_value_text16 cdecl alias "sqlite3_value_text16" (byval as sqlite3_value ptr) as sqlite_wchar ptr
declare function sqlite3_value_text16le cdecl alias "sqlite3_value_text16le" (byval as sqlite3_value ptr) as sqlite_wchar ptr
declare function sqlite3_value_text16be cdecl alias "sqlite3_value_text16be" (byval as sqlite3_value ptr) as sqlite_wchar ptr
...
declare sub sqlite3_result_error16 cdecl alias "sqlite3_result_error16" (byval as sqlite3_context ptr, byval as sqlite_wchar ptr, byval as integer)
...
declare sub sqlite3_result_text cdecl alias "sqlite3_result_text" (byval as sqlite3_context ptr, byval as zstring ptr, byval as integer, byval as sub cdecl(byval as any ptr))
declare sub sqlite3_result_text16 cdecl alias "sqlite3_result_text16" (byval as sqlite3_context ptr, byval as sqlite_wchar ptr, byval as integer, byval as sub cdecl(byval as any ptr))
declare sub sqlite3_result_text16le cdecl alias "sqlite3_result_text16le" (byval as sqlite3_context ptr, byval as sqlite_wchar ptr, byval as integer, byval as sub cdecl(byval as any ptr))
declare sub sqlite3_result_text16be cdecl alias "sqlite3_result_text16be" (byval as sqlite3_context ptr, byval as sqlite_wchar ptr, byval as integer, byval as sub cdecl(byval as any ptr))
...
declare function sqlite3_create_collation cdecl alias "sqlite3_create_collation" (byval as sqlite3 ptr, byval zName as zstring ptr, byval eTextRep as integer, byval as any ptr, byval xCompare as function cdecl(byval as any ptr, byval as integer, byval as any ptr, byval as integer, byval as any ptr) as integer) as integer
declare function sqlite3_create_collation16 cdecl alias "sqlite3_create_collation16" (byval as sqlite3 ptr, byval zName as sqlite_wchar ptr, byval eTextRep as integer, byval as any ptr, byval xCompare as function cdecl(byval as any ptr, byval as integer, byval as any ptr, byval as integer, byval as any ptr) as integer) as integer
declare function sqlite3_collation_needed cdecl alias "sqlite3_collation_needed" (byval as sqlite3 ptr, byval as any ptr, byval as sub cdecl(byval as any ptr, byval as sqlite3 ptr, byval as integer, byval as zstring ptr)) as integer
declare function sqlite3_collation_needed16 cdecl alias "sqlite3_collation_needed16" (byval as sqlite3 ptr, byval as any ptr, byval as sub cdecl(byval as any ptr, byval as sqlite3 ptr, byval as integer, byval as sqlite_wchar ptr)) as integer
