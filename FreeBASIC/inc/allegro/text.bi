...
Declare Sub textprintf_centre CDecl Alias "textprintf_centre" (ByVal bmp As BITMAP Ptr, ByVal f As FONT Ptr, ByVal x As Integer, ByVal y As Integer, ByVal _color As Integer, ByVal format As String, ...)
Declare Sub textprintf_right CDecl Alias "textprintf_right" (ByVal bmp As BITMAP Ptr, ByVal f As FONT Ptr, ByVal x As Integer, ByVal y As Integer, ByVal _color As Integer, ByVal format As String, ...)
Declare Sub textprintf_justify CDecl Alias "textprintf_justify" (ByVal bmp As BITMAP Ptr, ByVal f As FONT Ptr, Byval x1 As Integer, ByVal x2 As Integer, ByVal y As Integer, ByVal diff As Integer, ByVal _color As Integer, BYVal  format As String, ...)
