...
declare function cryptKeysetOpen stdcall alias "cryptKeysetOpen" (byval keyset as CRYPT_KEYSET ptr, byval cryptUser as CRYPT_USER, byval keysetType as CRYPT_KEYSET_TYPE, byval name as string, byval options as CRYPT_KEYOPT_TYPE) as integer
declare function cryptKeysetClose stdcall alias "cryptKeysetClose" (byval keyset as CRYPT_KEYSET) as integer
declare function cryptGetPublicKey stdcall alias "cryptGetPublicKey" (byval keyset as CRYPT_KEYSET, byval cryptContext as CRYPT_CONTEXT ptr, byval keyIDtype as CRYPT_KEYID_TYPE, byval keyID as string) as integer
declare function cryptGetPrivateKey stdcall alias "cryptGetPrivateKey" (byval keyset as CRYPT_KEYSET, byval cryptContext as CRYPT_CONTEXT ptr, byval keyIDtype as CRYPT_KEYID_TYPE, byval keyID as string, byval password as string) as integer
...
declare function cryptAddPrivateKey stdcall alias "cryptAddPrivateKey" (byval keyset as CRYPT_KEYSET, byval cryptKey as CRYPT_HANDLE, byval password as string) as integer
declare function cryptDeleteKey stdcall alias "cryptDeleteKey" (byval keyset as CRYPT_KEYSET, byval keyIDtype as CRYPT_KEYID_TYPE, byval keyID as string) as integer
...
declare function cryptGetCertExtension stdcall alias "cryptGetCertExtension" (byval certificate as CRYPT_CERTIFICATE, byval oid as string, byval criticalFlag as integer ptr, byval extension as any ptr, byval extensionLength as integer ptr) as integer
declare function cryptAddCertExtension stdcall alias "cryptAddCertExtension" (byval certificate as CRYPT_CERTIFICATE, byval oid as string, byval criticalFlag as integer, byval extension as any ptr, byval extensionLength as integer) as integer
declare function cryptDeleteCertExtension stdcall alias "cryptDeleteCertExtension" (byval certificate as CRYPT_CERTIFICATE, byval oid as string) as integer
...
declare function cryptCAGetItem stdcall alias "cryptCAGetItem" (byval keyset as CRYPT_KEYSET, byval certificate as CRYPT_CERTIFICATE ptr, byval certType as CRYPT_CERTTYPE_TYPE, byval keyIDtype as CRYPT_KEYID_TYPE, byval keyID as string) as integer
declare function cryptCADeleteItem stdcall alias "cryptCADeleteItem" (byval keyset as CRYPT_KEYSET, byval keyIDtype as CRYPT_KEYID_TYPE, byval keyID as string) as integer
...
declare function cryptDeviceOpen stdcall alias "cryptDeviceOpen" (byval device as CRYPT_DEVICE ptr, byval cryptUser as CRYPT_USER, byval deviceType as CRYPT_DEVICE_TYPE, byval name as string) as integer
...
declare function cryptLogin stdcall alias "cryptLogin" (byval user as CRYPT_USER ptr, byval name as string, byval password as string) as integer
