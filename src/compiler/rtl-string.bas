...
/'		/' function ucode alias "fb_WcharFromStr" (z as zstring) as wstring '/ _
		...
		/' function acode alias "fb_StrFromWchar" (w as wstring) as string '/ _
		( _
			@"acode", @"fb_StrFromWchar", _
			FB_DATATYPE_STRING, FB_FUNCMODE_FBCALL, _
			NULL, FB_RTL_OPT_NOQB, _
			1, _
			{ _
		...
		/' function pathname_path overload( byref z as zstring ) as wstring '/ _
		( _
			@"pathname_path", @"fb_StrPath_path", _
			FB_DATATYPE_STRING, FB_FUNCMODE_FBCALL, _
			NULL, FB_RTL_OPT_OVER or FB_RTL_OPT_NOQB, _
			1, _
			{ _
		...
		/' function pathname_name overload( byref w as wstring ) as wstring '/ _
		( _
			@"pathname_name", @"fb_WstrPath_name", _
			FB_DATATYPE_WCHAR, FB_FUNCMODE_FBCALL, _
			NULL, FB_RTL_OPT_OVER or FB_RTL_OPT_NOQB, _
			1, _
			{ _
		...
		/' function pathname_name overload( byref z as zstring ) as wstring '/ _
		( _
			@"pathname_name", @"fb_StrPath_name", _
			FB_DATATYPE_STRING, FB_FUNCMODE_FBCALL, _
			NULL, FB_RTL_OPT_OVER or FB_RTL_OPT_NOQB, _
			1, _
			{ _
		...
		/' function pathname_namex overload( byref w as wstring ) as wstring '/ _
		( _
			@"pathname_namex", @"fb_WstrPath_namex", _
			FB_DATATYPE_WCHAR, FB_FUNCMODE_FBCALL, _
			NULL, FB_RTL_OPT_OVER or FB_RTL_OPT_NOQB, _
			1, _
			{ _
		...
		/' function pathname_namex overload( byref z as zstring ) as wstring '/ _
		( _
			@"pathname_namex", @"fb_StrPath_namex", _
			FB_DATATYPE_STRING, FB_FUNCMODE_FBCALL, _
			NULL, FB_RTL_OPT_OVER or FB_RTL_OPT_NOQB, _
			1, _
			{ _
		...
		/' function pathname_extn overload( byref w as wstring ) as wstring '/ _
		( _
			@"pathname_extn", @"fb_WstrPath_extn", _
			FB_DATATYPE_WCHAR, FB_FUNCMODE_FBCALL, _
			NULL, FB_RTL_OPT_OVER or FB_RTL_OPT_NOQB, _
			1, _
			{ _
		...
		/' function pathname_extn overload( byref z as zstring ) as wstring '/ _
		( _
			@"pathname_extn", @"fb_StrPath_extn", _
			FB_DATATYPE_STRING, FB_FUNCMODE_FBCALL, _
			NULL, FB_RTL_OPT_OVER or FB_RTL_OPT_NOQB, _
			1, _
			{ _
		...
		/' function repeat overload( byval n as integer, byref z as zstring ) as string '/ _
		( _
			@"repeat", @"fb_StrRepeat", _
			FB_DATATYPE_STRING, FB_FUNCMODE_FBCALL, _
			NULL, FB_RTL_OPT_OVER or FB_RTL_OPT_NOQB, _
			2, _
			{ _
		...
		/' function repeat overload( byval n as integer, byref w as wstring ) as wstring '/ _
		( _
			@"repeat", @"fb_WstrRepeat", _
			FB_DATATYPE_WCHAR, FB_FUNCMODE_FBCALL, _
			NULL, FB_RTL_OPT_OVER or FB_RTL_OPT_NOQB, _
			2, _
			{ _
		...
		/' function remain overload( byref w as wstring, byval any as long, byref w as wstring ) as wstring '/ _
		( _
			@"fb_remain", @"fb_WstrRemain", _
			FB_DATATYPE_WCHAR, FB_FUNCMODE_FBCALL, _
			NULL, FB_RTL_OPT_OVER or FB_RTL_OPT_NOQB, _
			3, _
			{ _
		...
		/' function remain overload( byval n as integer, byval any as long, byref z as zstring, byval any as long, byref z as zstring ) as string '/ _
		( _
			@"fb_remain", @"fb_StrRemainStart", _
			FB_DATATYPE_STRING, FB_FUNCMODE_FBCALL, _
			NULL, FB_RTL_OPT_OVER or FB_RTL_OPT_NOQB, _
			5, _
			{ _
		...
		/' function remain overload( byval n as integer, byval any as long, byref w as wstring, byval any as long, byref w as wstring ) as wstring '/ _
		( _
			@"fb_remain", @"fb_WstrRemainStart", _
			FB_DATATYPE_WCHAR, FB_FUNCMODE_FBCALL, _
			NULL, FB_RTL_OPT_OVER or FB_RTL_OPT_NOQB, _
			5, _
			{ _
		...
		/' function remove overload( byref w as wstring, byval any as long, byref w as wstring ) as wstring '/ _
		( _
			@"fb_remove", @"fb_WstrRemove", _
			FB_DATATYPE_WCHAR, FB_FUNCMODE_FBCALL, _
			NULL, FB_RTL_OPT_OVER or FB_RTL_OPT_NOQB, _
			3, _
			{ _
		...
		/' function replace overload( byref z as zstring, byval any as long, byref z as zstring, byref z as zstring ) as string '/ _
		( _
			@"fb_replace", @"fb_StrReplace", _
			FB_DATATYPE_STRING, FB_FUNCMODE_FBCALL, _
			NULL, FB_RTL_OPT_OVER or FB_RTL_OPT_NOQB, _
			4, _
			{ _
		...
		/' function replace overload( byref w as wstring, byval any as long, byref w as wstring, byref z as wstring ) as wstring '/ _
		( _
			@"fb_replace", @"fb_WstrReplace", _
			FB_DATATYPE_WCHAR, FB_FUNCMODE_FBCALL, _
			NULL, FB_RTL_OPT_OVER or FB_RTL_OPT_NOQB, _
			4, _
			{ _
