...
{ _
	( _
		...
		FB_TARGETOPT_UNDERSCORE or FB_TARGETOPT_EXPORT _
	), _
	( _
		@"cygwin", _
		FB_DATATYPE_UINT, _
		...
		FB_FUNCMODE_STDCALL, _
		FB_TARGETOPT_UNIX or FB_TARGETOPT_UNDERSCORE or _
			FB_TARGETOPT_EXPORT _
	), _
	( _
		@"linux", _
		FB_DATATYPE_UINT, _
		...
		FB_TARGETOPT_UNIX or FB_TARGETOPT_CALLEEPOPSHIDDENPTR _
	), _
	( _
		@"dos", _
		FB_DATATYPE_ULONG, _
		...
		FB_FUNCMODE_CDECL, _
		FB_FUNCMODE_STDCALL_MS, _
		FB_TARGETOPT_UNDERSCORE or FB_TARGETOPT_CALLEEPOPSHIDDENPTR _
	), _
	( _
		@"xbox", _
		FB_DATATYPE_ULONG, _
