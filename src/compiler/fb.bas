...
{ _
	...
	( @"win32"  , FB_DATATYPE_UINT , FB_DATATYPE_USHORT, FB_FUNCMODE_STDCALL, FB_FUNCMODE_STDCALL    , FB_TARGETOPT_UNDERSCORE or FB_TARGETOPT_EXPORT ), _
	( @"cygwin" , FB_DATATYPE_UINT , FB_DATATYPE_USHORT, FB_FUNCMODE_STDCALL, FB_FUNCMODE_STDCALL    , FB_TARGETOPT_UNIX or FB_TARGETOPT_UNDERSCORE or FB_TARGETOPT_EXPORT ), _
