	...
	do
		...
		case CHAR_SHARP
			...
			case FB_TK_PP_DEFINE, FB_TK_PP_UNDEF, FB_TK_PP_PRINT, FB_TK_PP_ERROR, _
			     ...
			     FB_TK_PP_ASSERT, FB_TK_PP_DUMP, FB_TK_PP_ODUMP, FB_TK_PP_UCASE, _
	             FB_TK_PP_COUNT, FB_TK_PP_JOIN, FB_TK_PP_SPLIT, FB_TK_PP_LEFT_OF, FB_TK_PP_RIGHT_OF, FB_TK_PP_IS
