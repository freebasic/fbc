...
'' ustring specific
DECLARE FUNCTION astTryConvertUdtToWstring (byref expr as ASTNODE ptr) as boolean 
DECLARE FUNCTION astCanConvertUdtToWstring (byref expr as ASTNODE ptr) as boolean
