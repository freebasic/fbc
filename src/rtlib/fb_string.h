...
FBCALL FBSTRING    *fb_StrFromWchar     ( FB_WCHAR *src, ssize_t slen );
FBCALL FB_WCHAR    *fb_WcharFromStr     ( char *src, ssize_t *slen );
...
FBCALL FB_WCHAR    *fb_WstrRemainStart  ( ssize_t n, int dummy, FB_WCHAR *src, ssize_t *slen, int any, FB_WCHAR *i, ssize_t ilen );
...
FBCALL FB_WCHAR    *fb_WstrReplace       ( FB_WCHAR *src, ssize_t *slen, int any, FB_WCHAR *t, ssize_t tlen, FB_WCHAR *r, ssize_t rlen );
