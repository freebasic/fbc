...
stop2:
	...
	case 14  : while (p1 <= p1e){if (*((char*)p1) == *((ssize_t*)ps)) { scan_macro }} break;
	case 15  : while (p1 <= p1e){if (*((char*)p1) == *((ssize_t*)ps)) { scan_macro }} break;
	case 16  : while (p1 <= p1e){if (*((char*)p1) == *((int*)ps)) { scan_macro }} break;
	case 17  : while (p1 <= p1e){if (*((char*)p1) == *((int*)ps)) { scan_macro }} break;
	case 18  : while (p1 <= p1e){if (*((char*)p1) == *((long long*)ps)) { scan_macro }} break;
	case 19  : while (p1 <= p1e){if (*((char*)p1) == *((long long*)ps)) { scan_macro }} break;
	...
	case 34  : while (p1 <= p1e){if (*((short*)p1) == *((ssize_t*)ps)) { scan_macro }} break;
	case 35  : while (p1 <= p1e){if (*((short*)p1) == *((ssize_t*)ps)) { scan_macro }} break;
	case 36  : while (p1 <= p1e){if (*((short*)p1) == *((int*)ps)) { scan_macro }} break;
	case 37  : while (p1 <= p1e){if (*((short*)p1) == *((int*)ps)) { scan_macro }} break;
	case 38  : while (p1 <= p1e){if (*((short*)p1) == *((long long*)ps)) { scan_macro }} break;
	case 39  : while (p1 <= p1e){if (*((short*)p1) == *((long long*)ps)) { scan_macro }} break;
	...
	case 50  : while (p1 <= p1e){if (*((size_t*)p1) == *((unsigned char*)ps)) { scan_macro }} break;
	case 51  : while (p1 <= p1e){if (*((size_t*)p1) == *((unsigned char*)ps)) { scan_macro }} break;
	case 52  : while (p1 <= p1e){if (*((size_t*)p1) == *((unsigned short*)ps)) { scan_macro }} break;
	...
	case 55  : while (p1 <= p1e){if (*((size_t*)p1) == *((size_t*)ps)) { scan_macro }} break;
	case 56  : while (p1 <= p1e){if (*((size_t*)p1) == *((unsigned int*)ps)) { scan_macro }} break;
	case 57  : while (p1 <= p1e){if (*((size_t*)p1) == *((unsigned int*)ps)) { scan_macro }} break;
	case 58  : while (p1 <= p1e){if (*((size_t*)p1) == *((unsigned long long*)ps)) { scan_macro }} break;
	...
	case 64  : while (p1 <= p1e){if (*((ssize_t*)p1) == *((ssize_t*)ps)) { scan_macro }} break;
	case 65  : while (p1 <= p1e){if (*((ssize_t*)p1) == *((ssize_t*)ps)) { scan_macro }} break;
	case 66  : while (p1 <= p1e){if (*((ssize_t*)p1) == *((int*)ps)) { scan_macro }} break;
	case 67  : while (p1 <= p1e){if (*((ssize_t*)p1) == *((int*)ps)) { scan_macro }} break;
	case 68  : while (p1 <= p1e){if (*((ssize_t*)p1) == *((long long*)ps)) { scan_macro }} break;
	case 69  : while (p1 <= p1e){if (*((ssize_t*)p1) == *((long long*)ps)) { scan_macro }} break;
	...
	case 74  : while (p1 <= p1e){if (*((int*)p1) == *((ssize_t*)ps)) { scan_macro }} break;
	case 75  : while (p1 <= p1e){if (*((int*)p1) == *((ssize_t*)ps)) { scan_macro }} break;
	case 76  : while (p1 <= p1e){if (*((int*)p1) == *((int*)ps)) { scan_macro }} break;
	case 77  : while (p1 <= p1e){if (*((int*)p1) == *((int*)ps)) { scan_macro }} break;
	case 78  : while (p1 <= p1e){if (*((int*)p1) == *((long long*)ps)) { scan_macro }} break;
	case 79  : while (p1 <= p1e){if (*((int*)p1) == *((long long*)ps)) { scan_macro }} break;
	case 80  : while (p1 <= p1e){if (*((unsigned int*)p1) == *((unsigned char*)ps)) { scan_macro }} break;
	case 81  : while (p1 <= p1e){if (*((unsigned int*)p1) == *((unsigned char*)ps)) { scan_macro }} break;
	case 82  : while (p1 <= p1e){if (*((unsigned int*)p1) == *((unsigned short*)ps)) { scan_macro }} break;
	...
	case 85  : while (p1 <= p1e){if (*((unsigned int*)p1) == *((size_t*)ps)) { scan_macro }} break;
	case 86  : while (p1 <= p1e){if (*((unsigned int*)p1) == *((unsigned int*)ps)) { scan_macro }} break;
	...
	case 94  : while (p1 <= p1e){if (*((long long*)p1) == *((ssize_t*)ps)) { scan_macro }} break;
	...
	case 99  : while (p1 <= p1e){if (*((long long*)p1) == *((long long*)ps)) { scan_macro }} break;
//	case 100 : while (p1 <= p1e){if (*((unsigned long long*)p1) == *((char*)ps)) { scan_macro }} break;
	case 100 : while (p1 <= p1e){if (*((unsigned long long*)p1) == *((unsigned char*)ps)) { scan_macro }} break;
...
//	case 102 : while (p1 <= p1e){if (*((unsigned long long*)p1) == *((short*)ps)) { scan_macro }} break;
	case 102 : while (p1 <= p1e){if (*((unsigned long long*)p1) == *((unsigned short*)ps)) { scan_macro }} break;
	case 103 : while (p1 <= p1e){if (*((unsigned long long*)p1) == *((unsigned short*)ps)) { scan_macro }} break;
//	case 104 : while (p1 <= p1e){if (*((unsigned long long*)p1) == *((ssize_t*)ps)) { scan_macro }} break;
	case 104 : while (p1 <= p1e){if (*((unsigned long long*)p1) == *((size_t*)ps)) { scan_macro }} break;
	case 105 : while (p1 <= p1e){if (*((unsigned long long*)p1) == *((size_t*)ps)) { scan_macro }} break;
//	case 106 : while (p1 <= p1e){if (*((unsigned long long*)p1) == *((int*)ps)) { scan_macro }} break;
	case 106 : while (p1 <= p1e){if (*((unsigned long long*)p1) == *((unsigned int*)ps)) { scan_macro }} break;
...
//	case 108 : while (p1 <= p1e){if (*((unsigned long long*)p1) == *((long long*)ps)) { scan_macro }} break;
	case 108 : while (p1 <= p1e){if (*((unsigned long long*)p1) == *((unsigned long long*)ps)) { scan_macro }} break;
