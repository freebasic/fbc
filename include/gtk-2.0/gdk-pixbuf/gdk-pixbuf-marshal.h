...
/* VOID:VOID (/build/buildd/gtk+2.0-2.18.3/gdk-pixbuf/gdk-pixbuf-marshal.list:25) */
#define _gdk_pixbuf_marshal_VOID__VOID	g_cclosure_marshal_VOID__VOID

/* VOID:INT,INT (/build/buildd/gtk+2.0-2.18.3/gdk-pixbuf/gdk-pixbuf-marshal.list:26) */
...
/* VOID:INT,INT,INT,INT (/build/buildd/gtk+2.0-2.18.3/gdk-pixbuf/gdk-pixbuf-marshal.list:27) */
...
/* VOID:POINTER (/build/buildd/gtk+2.0-2.18.3/gdk-pixbuf/gdk-pixbuf-marshal.list:28) */
