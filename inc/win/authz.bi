...
#define AUTHZ_SKIP_TOKEN_GROUPS &h2
#define AUTHZ_REQUIRE_S4U_LOGON &h4
#define AUTHZ_COMPUTE_PRIVILEGES &h8
...
#define AUTHZ_SECURITY_ATTRIBUTE_TYPE_INVALID &h00
#define AUTHZ_SECURITY_ATTRIBUTE_TYPE_INT64 &h01
#define AUTHZ_SECURITY_ATTRIBUTE_TYPE_UINT64 &h02
#define AUTHZ_SECURITY_ATTRIBUTE_TYPE_STRING &h03
#define AUTHZ_SECURITY_ATTRIBUTE_TYPE_FQBN &h04

#if _WIN32_WINNT = &h0602
	#define AUTHZ_SECURITY_ATTRIBUTE_TYPE_SID &h05
	#define AUTHZ_SECURITY_ATTRIBUTE_TYPE_BOOLEAN &h06
#endif

#define AUTHZ_SECURITY_ATTRIBUTE_TYPE_OCTET_STRING &h10
...
#define AUTHZ_SECURITY_ATTRIBUTE_NON_INHERITABLE &h1
#define AUTHZ_SECURITY_ATTRIBUTE_VALUE_CASE_SENSITIVE &h2
#define AUTHZ_SECURITY_ATTRIBUTE_VALID_FLAGS (AUTHZ_SECURITY_ATTRIBUTE_NON_INHERITABLE or AUTHZ_SECURITY_ATTRIBUTE_VALUE_CASE_SENSITIVE)
...
#define AUTHZ_ACCESS_CHECK_NO_DEEP_COPY_SD &h1
#define AUTHZ_RM_FLAG_NO_AUDIT &h1
#define AUTHZ_RM_FLAG_INITIALIZE_UNDER_IMPERSONATION &h2
#define AUTHZ_RM_FLAG_NO_CENTRAL_ACCESS_POLICIES &h4
#define AUTHZ_VALID_RM_INIT_FLAGS ((AUTHZ_RM_FLAG_NO_AUDIT or AUTHZ_RM_FLAG_INITIALIZE_UNDER_IMPERSONATION) or AUTHZ_RM_FLAG_NO_CENTRAL_ACCESS_POLICIES)

union ___AUTHZ_SECURITY_ATTRIBUTE_V1_Values
	pInt64 as PLONG64
	pUint64 as PULONG64
...
type _AUTHZ_SECURITY_ATTRIBUTE_V1
	...
	Flags as ULONG
	ValueCount as ULONG
	Values as ___AUTHZ_SECURITY_ATTRIBUTE_V1_Values
end type
...
union ___AUTHZ_SECURITY_ATTRIBUTES_INFORMATION_Attribute
...
type _AUTHZ_SECURITY_ATTRIBUTES_INFORMATION
	...
	Attribute as ___AUTHZ_SECURITY_ATTRIBUTES_INFORMATION_Attribute
end type
