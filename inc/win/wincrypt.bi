...
#else
	const CALG_ECDH = &h0000aa05
	const CALG_ECDSA = &h00002203
#endif
...
const CERT_ENCODING_TYPE_MASK = &hffff
...
const CERT_KEY_AGREEMENT_KEY_USAGE = &h8
const CERT_KEY_CERT_SIGN_KEY_USAGE = &h4
const CERT_OFFLINE_CRL_SIGN_KEY_USAGE = &h2
const CERT_CRL_SIGN_KEY_USAGE = &h2
const CERT_ENCIPHER_ONLY_KEY_USAGE = &h1
...
const CERT_ALT_NAME_VALUE_ERR_INDEX_MASK = &hffff
...
const CRL_REASON_SUPERSEDED_FLAG = &h8
const CRL_REASON_CESSATION_OF_OPERATION_FLAG = &h4
const CRL_REASON_CERTIFICATE_HOLD_FLAG = &h2
...
const NETSCAPE_SSL_CA_CERT_TYPE = &h4
const NETSCAPE_SMIME_CA_CERT_TYPE = &h2
const NETSCAPE_SIGN_CA_CERT_TYPE = &h1
...
const CERT_LAST_RESERVED_PROP_ID = &h7fff
const CERT_FIRST_USER_PROP_ID = &h8000
const CERT_LAST_USER_PROP_ID = &hffff
...
const CERT_SYSTEM_STORE_LOCATION_MASK = &hff0000
...
#define CERT_AUTH_ROOT_AUTO_UPDATE_LOCAL_MACHINE_REGPATH CERT_LOCAL_MACHINE_SYSTEM_STORE_REGPATH wstr(!"\\AuthRoot\\AutoUpdate")
...
const CRYPTPROTECT_PROMPT_RESERVED = &h4
const CRYPTPROTECT_PROMPT_STRONG = &h8
...
const CRYPT_STRING_BASE64REQUESTHEADER = &h3
const CRYPT_STRING_HEX = &h4
const CRYPT_STRING_HEXASCII = &h5
const CRYPT_STRING_BASE64_ANY = &h6
const CRYPT_STRING_ANY = &h7
const CRYPT_STRING_HEX_ANY = &h8
const CRYPT_STRING_BASE64X509CRLHEADER = &h9
const CRYPT_STRING_HEXADDR = &ha
const CRYPT_STRING_HEXASCIIADDR = &hb
...
declare function PFXExportCertStore(byval hStore as HCERTSTORE, byval pPFX as CRYPT_DATA_BLOB ptr, byval szPassword as LPCWSTR, byval dwFlags as DWORD) as WINBOOL
	...
	const CERT_CHAIN_REVOCATION_CHECK_OCSP_CERT = &h04000000
	...
	const TIMESTAMP_DONT_HASH_DATA = &h00000001
	const TIMESTAMP_VERIFY_CONTEXT_SIGNATURE = &h00000020
	const TIMESTAMP_NO_AUTH_RETRIEVAL = &h00020000
