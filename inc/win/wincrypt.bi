...
#if _WIN32_WINNT = &h0602
	#define CALG_ECDH ((ALG_CLASS_KEY_EXCHANGE or ALG_TYPE_DH) or ALG_SID_ECDH)
	#define CALG_ECMQV ((ALG_CLASS_KEY_EXCHANGE or ALG_TYPE_ANY) or ALG_SID_ECMQV)
	#define CALG_ECDSA ((ALG_CLASS_SIGNATURE or ALG_TYPE_DSS) or ALG_SID_ECDSA)
#endif
...
#define CRYPT_ENCODE_ENABLE_IA5CONVERSION_FLAG (CRYPT_ENCODE_ENABLE_PUNYCODE_FLAG or CRYPT_ENCODE_ENABLE_UTF8PERCENT_FLAG)
...
#define X509_QC_STATEMENTS_EXT cast(LPCSTR, 42)
...
#define TIMESTAMP_REQUEST cast(LPCSTR, 78)
#define TIMESTAMP_RESPONSE cast(LPCSTR, 79)
#define TIMESTAMP_INFO cast(LPCSTR, 80)
#define X509_CERT_BUNDLE cast(LPCSTR, 81)
#define X509_ECC_PRIVATE_KEY cast(LPCSTR, 82)
#define CNG_RSA_PRIVATE_KEY_BLOB cast(LPCSTR, 83)
...
#define CERT_STORE_PROV_PKCS12 cast(LPCSTR, 17)
...
#define CERT_FIND_SUBJECT_INFO_ACCESS (CERT_COMPARE_SUBJECT_INFO_ACCESS shl CERT_COMPARE_SHIFT)
#define CERT_FIND_HASH_STR (CERT_COMPARE_HASH_STR shl CERT_COMPARE_SHIFT)
#define CERT_FIND_HAS_PRIVATE_KEY (CERT_COMPARE_HAS_PRIVATE_KEY shl CERT_COMPARE_SHIFT)
...
#define CERT_QUERY_CONTENT_FLAG_PFX_AND_LOAD (1 shl CERT_QUERY_CONTENT_PFX_AND_LOAD)
...
#define CERT_QUERY_CONTENT_FLAG_ALL_ISSUER_CERT ((((CERT_QUERY_CONTENT_FLAG_CERT or CERT_QUERY_CONTENT_FLAG_SERIALIZED_STORE) or CERT_QUERY_CONTENT_FLAG_SERIALIZED_CERT) or CERT_QUERY_CONTENT_FLAG_PKCS7_SIGNED) or CERT_QUERY_CONTENT_FLAG_PKCS7_UNSIGNED)
...
#define CONTEXT_OID_OCSP_RESP cast(LPCSTR, 6)
...
#define URL_OID_CERTIFICATE_OCSP cast(LPCSTR, 9)
#define URL_OID_CERTIFICATE_OCSP_AND_CRL_DIST_POINT cast(LPCSTR, 10)
#define URL_OID_CERTIFICATE_CRL_DIST_POINT_AND_OCSP cast(LPCSTR, 11)
#define URL_OID_CROSS_CERT_SUBJECT_INFO_ACCESS cast(LPCSTR, 12)
#define URL_OID_CERTIFICATE_ONLY_OCSP cast(LPCSTR, 13)
...
#define CERT_RETRIEVE_ISSUER_LOGO cast(LPCSTR, 1)
#define CERT_RETRIEVE_SUBJECT_LOGO cast(LPCSTR, 2)
#define CERT_RETRIEVE_COMMUNITY_LOGO cast(LPCSTR, 3)
#define CERT_RETRIEVE_BIOMETRIC_PREDEFINED_BASE_TYPE cast(LPCSTR, 1000)
