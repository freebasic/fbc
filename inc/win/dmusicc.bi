...
#define DAUD_CHAN1_DEF_VOICE_PRIORITY (DAUD_STANDARD_VOICE_PRIORITY or DAUD_CHAN1_VOICE_PRIORITY_OFFSET)
#define DAUD_CHAN2_DEF_VOICE_PRIORITY (DAUD_STANDARD_VOICE_PRIORITY or DAUD_CHAN2_VOICE_PRIORITY_OFFSET)
#define DAUD_CHAN3_DEF_VOICE_PRIORITY (DAUD_STANDARD_VOICE_PRIORITY or DAUD_CHAN3_VOICE_PRIORITY_OFFSET)
#define DAUD_CHAN4_DEF_VOICE_PRIORITY (DAUD_STANDARD_VOICE_PRIORITY or DAUD_CHAN4_VOICE_PRIORITY_OFFSET)
#define DAUD_CHAN5_DEF_VOICE_PRIORITY (DAUD_STANDARD_VOICE_PRIORITY or DAUD_CHAN5_VOICE_PRIORITY_OFFSET)
#define DAUD_CHAN6_DEF_VOICE_PRIORITY (DAUD_STANDARD_VOICE_PRIORITY or DAUD_CHAN6_VOICE_PRIORITY_OFFSET)
#define DAUD_CHAN7_DEF_VOICE_PRIORITY (DAUD_STANDARD_VOICE_PRIORITY or DAUD_CHAN7_VOICE_PRIORITY_OFFSET)
#define DAUD_CHAN8_DEF_VOICE_PRIORITY (DAUD_STANDARD_VOICE_PRIORITY or DAUD_CHAN8_VOICE_PRIORITY_OFFSET)
#define DAUD_CHAN9_DEF_VOICE_PRIORITY (DAUD_STANDARD_VOICE_PRIORITY or DAUD_CHAN9_VOICE_PRIORITY_OFFSET)
#define DAUD_CHAN10_DEF_VOICE_PRIORITY (DAUD_STANDARD_VOICE_PRIORITY or DAUD_CHAN10_VOICE_PRIORITY_OFFSET)
#define DAUD_CHAN11_DEF_VOICE_PRIORITY (DAUD_STANDARD_VOICE_PRIORITY or DAUD_CHAN11_VOICE_PRIORITY_OFFSET)
#define DAUD_CHAN12_DEF_VOICE_PRIORITY (DAUD_STANDARD_VOICE_PRIORITY or DAUD_CHAN12_VOICE_PRIORITY_OFFSET)
#define DAUD_CHAN13_DEF_VOICE_PRIORITY (DAUD_STANDARD_VOICE_PRIORITY or DAUD_CHAN13_VOICE_PRIORITY_OFFSET)
#define DAUD_CHAN14_DEF_VOICE_PRIORITY (DAUD_STANDARD_VOICE_PRIORITY or DAUD_CHAN14_VOICE_PRIORITY_OFFSET)
#define DAUD_CHAN15_DEF_VOICE_PRIORITY (DAUD_STANDARD_VOICE_PRIORITY or DAUD_CHAN15_VOICE_PRIORITY_OFFSET)
#define DAUD_CHAN16_DEF_VOICE_PRIORITY (DAUD_STANDARD_VOICE_PRIORITY or DAUD_CHAN16_VOICE_PRIORITY_OFFSET)
#define DMUS_CLOCKF_GLOBAL &h1
#define DMUS_EFFECT_NONE &h0
#define DMUS_EFFECT_REVERB &h1
#define DMUS_EFFECT_CHORUS &h2
#define DMUS_EFFECT_DELAY &h4
#define DMUS_MAX_DESCRIPTION &h80
#define DMUS_MAX_DRIVER &h80
#define DMUS_PC_INPUTCLASS &h0
#define DMUS_PC_OUTPUTCLASS &h1
...
#define DMUS_PORT_WINMM_DRIVER &h0
#define DMUS_PORT_USER_MODE_SYNTH &h1
#define DMUS_PORT_KERNEL_MODE &h2
#define DMUS_PORT_FEATURE_AUDIOPATH &h1
#define DMUS_PORT_FEATURE_STREAMING &h2
#define DMUS_PORTPARAMS_VOICES &h01
#define DMUS_PORTPARAMS_CHANNELGROUPS &h02
#define DMUS_PORTPARAMS_AUDIOCHANNELS &h04
#define DMUS_PORTPARAMS_SAMPLERATE &h08
#define DMUS_PORTPARAMS_EFFECTS &h20
#define DMUS_PORTPARAMS_SHARE &h40
#define DMUS_PORTPARAMS_FEATURES &h80
#define DMUS_VOLUME_MAX 2000
#define DMUS_VOLUME_MIN (-20000)
#define DMUS_SYNTHSTATS_VOICES &h01
#define DMUS_SYNTHSTATS_TOTAL_CPU &h02
#define DMUS_SYNTHSTATS_CPU_PER_VOICE &h04
#define DMUS_SYNTHSTATS_LOST_NOTES &h08
#define DMUS_SYNTHSTATS_PEAK_VOLUME &h10
#define DMUS_SYNTHSTATS_FREE_MEMORY &h20
#define DMUS_SYNTHSTATS_SYSTEMMEMORY DMUS_PC_SYSTEMMEMORY
#define DSBUSID_FIRST_SPKR_LOC &h00000000
#define DSBUSID_FRONT_LEFT &h00000000
#define DSBUSID_LEFT &h00000000
#define DSBUSID_FRONT_RIGHT &h00000001
#define DSBUSID_RIGHT &h00000001
#define DSBUSID_FRONT_CENTER &h00000002
#define DSBUSID_LOW_FREQUENCY &h00000003
#define DSBUSID_BACK_LEFT &h00000004
#define DSBUSID_BACK_RIGHT &h00000005
#define DSBUSID_FRONT_LEFT_OF_CENTER &h00000006
#define DSBUSID_FRONT_RIGHT_OF_CENTER &h00000007
#define DSBUSID_BACK_CENTER &h00000008
#define DSBUSID_SIDE_LEFT &h00000009
#define DSBUSID_SIDE_RIGHT &h0000000A
#define DSBUSID_TOP_CENTER &h0000000B
#define DSBUSID_TOP_FRONT_LEFT &h0000000C
#define DSBUSID_TOP_FRONT_CENTER &h0000000D
#define DSBUSID_TOP_FRONT_RIGHT &h0000000E
#define DSBUSID_TOP_BACK_LEFT &h0000000F
#define DSBUSID_TOP_BACK_CENTER &h00000010
#define DSBUSID_TOP_BACK_RIGHT &h011
#define DSBUSID_LAST_SPKR_LOC &h00000011
#define DSBUSID_IS_SPKR_LOC(id) (((id) >= DSBUSID_FIRST_SPKR_LOC) andalso ((id) <= DSBUSID_LAST_SPKR_LOC))
#define DSBUSID_REVERB_SEND &h00000040
#define DSBUSID_CHORUS_SEND &h00000041
#define DSBUSID_DYNAMIC_0 &h00000200
