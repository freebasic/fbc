...
const DIERR_INSUFFICIENTPRIVS = cast(clong, &h80040200)
const DIERR_DEVICEFULL = cast(clong, &h80040201)
const DIERR_MOREDATA = cast(clong, &h80040202)
const DIERR_NOTDOWNLOADED = cast(clong, &h80040203)
const DIERR_HASEFFECTS = cast(clong, &h80040204)
const DIERR_NOTEXCLUSIVEACQUIRED = cast(clong, &h80040205)
const DIERR_INCOMPLETEEFFECT = cast(clong, &h80040206)
const DIERR_NOTBUFFERED = cast(clong, &h80040207)
const DIERR_EFFECTPLAYING = cast(clong, &h80040208)
const DIERR_UNPLUGGED = cast(clong, &h80040209)
const DIERR_REPORTFULL = cast(clong, &h8004020A)
const DIERR_MAPFILEFAIL = cast(clong, &h8004020B)
const DIENUM_STOP = 0
