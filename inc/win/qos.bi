...
#define QOS_OBJECT_END_OF_LIST (&h00000001 + QOS_GENERAL_ID_BASE)
#define QOS_OBJECT_SD_MODE (&h00000002 + QOS_GENERAL_ID_BASE)
#define QOS_OBJECT_SHAPING_RATE (&h00000003 + QOS_GENERAL_ID_BASE)
#define QOS_OBJECT_DESTADDR (&h00000004 + QOS_GENERAL_ID_BASE)
