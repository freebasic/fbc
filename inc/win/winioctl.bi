...
#define OBSOLETE_IOCTL_STORAGE_RESET_DEVICE CTL_CODE(IOCTL_STORAGE_BASE, &h0401, METHOD_BUFFERED, FILE_READ_ACCESS or FILE_WRITE_ACCESS)
	...
	#define DeviceDsmActionFlag_NonDestructive &h80000000
	#define DeviceDsmAction_None 0
	#define DeviceDsmAction_Trim 1
	#define DeviceDsmAction_Notification (2 or DeviceDsmActionFlag_NonDestructive)
	#define IsDsmActionNonDestructive(x) cast(BOOLEAN, -((((x) and DeviceDsmActionFlag_NonDestructive) = 0) = 0))
...
type PVOLUME_GET_GPT_ATTRIBUTES_INFORMATION as _VOLUME_GET_GPT_ATTRIBUTES_INFORMATION ptr
	...
	#define SET_REPAIR_ENABLED &h00000001
	#define SET_REPAIR_VOLUME_BITMAP_SCAN &h00000002
	#define SET_REPAIR_DELETE_CROSSLINK &h00000004
	#define SET_REPAIR_WARN_ABOUT_DATA_LOSS &h00000008
	#define SET_REPAIR_DISABLED_AND_BUGCHECK_ON_CORRUPT &h00000010
	#define SET_REPAIR_VALID_MASK &h0000001F
	...
	#define TXFS_RM_FLAG_LOGGING_MODE &h00000001
	#define TXFS_RM_FLAG_RENAME_RM &h00000002
	#define TXFS_RM_FLAG_LOG_CONTAINER_COUNT_MAX &h00000004
	#define TXFS_RM_FLAG_LOG_CONTAINER_COUNT_MIN &h00000008
	#define TXFS_RM_FLAG_LOG_GROWTH_INCREMENT_NUM_CONTAINERS &h00000010
	#define TXFS_RM_FLAG_LOG_GROWTH_INCREMENT_PERCENT &h00000020
	#define TXFS_RM_FLAG_LOG_AUTO_SHRINK_PERCENTAGE &h00000040
	#define TXFS_RM_FLAG_LOG_NO_CONTAINER_COUNT_MAX &h00000080
	#define TXFS_RM_FLAG_LOG_NO_CONTAINER_COUNT_MIN &h00000100
	#define TXFS_RM_FLAG_GROW_LOG &h00000400
	#define TXFS_RM_FLAG_SHRINK_LOG &h00000800
	#define TXFS_RM_FLAG_ENFORCE_MINIMUM_SIZE &h00001000
	#define TXFS_RM_FLAG_PRESERVE_CHANGES &h00002000
	#define TXFS_RM_FLAG_RESET_RM_AT_NEXT_START &h00004000
	#define TXFS_RM_FLAG_DO_NOT_RESET_RM_AT_NEXT_START &h00008000
	#define TXFS_RM_FLAG_PREFER_CONSISTENCY &h00010000
	#define TXFS_RM_FLAG_PREFER_AVAILABILITY &h00020000
	...
	#define TXFS_ROLLFORWARD_REDO_FLAG_USE_LAST_REDO_LSN &h01
	#define TXFS_ROLLFORWARD_REDO_FLAG_USE_LAST_VIRTUAL_CLOCK &h02
	#define TXFS_ROLLFORWARD_REDO_VALID_FLAGS (TXFS_ROLLFORWARD_REDO_FLAG_USE_LAST_REDO_LSN or TXFS_ROLLFORWARD_REDO_FLAG_USE_LAST_VIRTUAL_CLOCK)
	...
	#define TXFS_START_RM_FLAG_LOG_CONTAINER_COUNT_MAX &h00000001
	#define TXFS_START_RM_FLAG_LOG_CONTAINER_COUNT_MIN &h00000002
	#define TXFS_START_RM_FLAG_LOG_CONTAINER_SIZE &h00000004
	#define TXFS_START_RM_FLAG_LOG_GROWTH_INCREMENT_NUM_CONTAINERS &h00000008
	#define TXFS_START_RM_FLAG_LOG_GROWTH_INCREMENT_PERCENT &h00000010
	#define TXFS_START_RM_FLAG_LOG_AUTO_SHRINK_PERCENTAGE &h00000020
	#define TXFS_START_RM_FLAG_LOG_NO_CONTAINER_COUNT_MAX &h00000040
	#define TXFS_START_RM_FLAG_LOG_NO_CONTAINER_COUNT_MIN &h00000080
	#define TXFS_START_RM_FLAG_RECOVER_BEST_EFFORT &h00000200
	#define TXFS_START_RM_FLAG_LOGGING_MODE &h00000400
	#define TXFS_START_RM_FLAG_PRESERVE_CHANGES &h00000800
	#define TXFS_START_RM_FLAG_PREFER_CONSISTENCY &h00001000
	#define TXFS_START_RM_FLAG_PREFER_AVAILABILITY &h00002000
	...
	#define TXFS_LIST_TRANSACTION_LOCKED_FILES_ENTRY_FLAG_CREATED &h00000001
	#define TXFS_LIST_TRANSACTION_LOCKED_FILES_ENTRY_FLAG_DELETED &h000000012
	...
	#define TXFS_TRANSACTED_VERSION_NONTRANSACTED &hFFFFFFFE
	#define TXFS_TRANSACTED_VERSION_UNCOMMITTED &hFFFFFFFF
	...
	type _STORAGE_WRITE_CACHE_PROPERTY
		...
		FlushCacheSupported as BOOLEAN
		UserDefinedPowerProtection as BOOLEAN
		NVCacheEnabled as BOOLEAN
	end type
	...
	type _STORAGE_MINIPORT_DESCRIPTOR
		...
		LUNResetSupported as BOOLEAN
		TargetResetSupported as BOOLEAN
	end type
	...
	#define LOOKUP_STREAM_FROM_CLUSTER_ENTRY_ATTRIBUTE_MASK &hff000000
	#define LOOKUP_STREAM_FROM_CLUSTER_ENTRY_FLAG_PAGE_FILE &h00000001
	#define LOOKUP_STREAM_FROM_CLUSTER_ENTRY_FLAG_DENY_DEFRAG_SET &h00000002
	#define LOOKUP_STREAM_FROM_CLUSTER_ENTRY_FLAG_FS_SYSTEM_FILE &h00000004
	#define LOOKUP_STREAM_FROM_CLUSTER_ENTRY_FLAG_TXF_SYSTEM_FILE &h00000008
	#define LOOKUP_STREAM_FROM_CLUSTER_ENTRY_ATTRIBUTE_DATA &h01000000
	#define LOOKUP_STREAM_FROM_CLUSTER_ENTRY_ATTRIBUTE_INDEX &h02000000
	#define LOOKUP_STREAM_FROM_CLUSTER_ENTRY_ATTRIBUTE_SYSTEM &h03000000
