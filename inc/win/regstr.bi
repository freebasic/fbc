...
#define IT_COMPACT &h0000
#define IT_TYPICAL &h0001
#define IT_PORTABLE &h0002
#define IT_CUSTOM &h0003
...
#define DRIVERSIGN_NONE &h00000000
#define DRIVERSIGN_WARNING &h00000001
#define DRIVERSIGN_BLOCKING &h00000002
...
#define DOSOPTGF_DEFCLEAN __MSABI_LONG(&h00000001)
...
#define DOSOPTF_DEFAULT __MSABI_LONG(&h00000001)
#define DOSOPTF_SUPPORTED __MSABI_LONG(&h00000002)
#define DOSOPTF_ALWAYSUSE __MSABI_LONG(&h00000004)
#define DOSOPTF_USESPMODE __MSABI_LONG(&h00000008)
#define DOSOPTF_PROVIDESUMB __MSABI_LONG(&h00000010)
#define DOSOPTF_NEEDSETUP __MSABI_LONG(&h00000020)
#define DOSOPTF_INDOSSTART __MSABI_LONG(&h00000040)
#define DOSOPTF_MULTIPLE __MSABI_LONG(&h00000080)
#define SUF_FIRSTTIME __MSABI_LONG(&h00000001)
#define SUF_EXPRESS __MSABI_LONG(&h00000002)
#define SUF_BATCHINF __MSABI_LONG(&h00000004)
#define SUF_CLEAN __MSABI_LONG(&h00000008)
#define SUF_INSETUP __MSABI_LONG(&h00000010)
#define SUF_NETSETUP __MSABI_LONG(&h00000020)
#define SUF_NETHDBOOT __MSABI_LONG(&h00000040)
#define SUF_NETRPLBOOT __MSABI_LONG(&h00000080)
#define SUF_SBSCOPYOK __MSABI_LONG(&h00000100)
...
#define VPDF_DISABLEPWRMGMT &h00000001
#define VPDF_FORCEAPM10MODE &h00000002
#define VPDF_SKIPINTELSLCHECK &h00000004
#define VPDF_DISABLEPWRSTATUSPOLL &h00000008
#define VPDF_DISABLERINGRESUME &h00000010
#define VPDF_SHOWMULTIBATT &h00000020
#define BIF_SHOWSIMILARDRIVERS &h00000001
#define BIF_RAWDEVICENEEDSDRIVER &h00000002
...
#define PCMCIA_OPT_HAVE_SOCKET __MSABI_LONG(&h00000001)
#define PCMCIA_OPT_AUTOMEM __MSABI_LONG(&h00000004)
#define PCMCIA_OPT_NO_SOUND __MSABI_LONG(&h00000008)
...
#define PCMCIA_DEF_MEMBEGIN &h000C0000
#define PCMCIA_DEF_MEMEND &h00FFFFFF
#define PCMCIA_DEF_MEMLEN &h00001000
...
#define PCMCIA_DEF_MIN_REGION &h00010000
...
#define PCI_OPTIONS_USE_BIOS __MSABI_LONG(&h00000001)
#define PCI_OPTIONS_USE_IRQ_STEERING __MSABI_LONG(&h00000002)
#define AGP_FLAG_NO_1X_RATE __MSABI_LONG(&h00000001)
#define AGP_FLAG_NO_2X_RATE __MSABI_LONG(&h00000002)
#define AGP_FLAG_NO_4X_RATE __MSABI_LONG(&h00000004)
#define AGP_FLAG_NO_8X_RATE __MSABI_LONG(&h00000008)
...
#define REGDF_NOTDETIO &h00000001
#define REGDF_NOTDETMEM &h00000002
#define REGDF_NOTDETIRQ &h00000004
#define REGDF_NOTDETDMA &h00000008
#define REGDF_NOTDETALL (((REGDF_NOTDETIO or REGDF_NOTDETMEM) or REGDF_NOTDETIRQ) or REGDF_NOTDETDMA)
#define REGDF_NEEDFULLCONFIG &h00000010
#define REGDF_GENFORCEDCONFIG &h00000020
#define REGDF_NODETCONFIG &h00008000
#define REGDF_CONFLICTIO &h00010000
#define REGDF_CONFLICTMEM &h00020000
#define REGDF_CONFLICTIRQ &h00040000
#define REGDF_CONFLICTDMA &h00080000
#define REGDF_CONFLICTALL (((REGDF_CONFLICTIO or REGDF_CONFLICTMEM) or REGDF_CONFLICTIRQ) or REGDF_CONFLICTDMA)
#define REGDF_MAPIRQ2TO9 &h00100000
...
#define APMMENUSUSPEND_NOCHANGE &h80
...
#define CONFIGFLAG_DISABLED &h00000001
#define CONFIGFLAG_REMOVED &h00000002
#define CONFIGFLAG_MANUAL_INSTALL &h00000004
#define CONFIGFLAG_IGNORE_BOOT_LC &h00000008
#define CONFIGFLAG_NET_BOOT &h00000010
#define CONFIGFLAG_REINSTALL &h00000020
#define CONFIGFLAG_FAILEDINSTALL &h00000040
#define CONFIGFLAG_CANTSTOPACHILD &h00000080
#define CONFIGFLAG_OKREMOVEROM &h00000100
#define CONFIGFLAG_NOREMOVEEXIT &h00000200
#define CONFIGFLAG_FINISH_INSTALL &h00000400
#define CONFIGFLAG_NEEDS_FORCED_CONFIG &h00000800
#define CONFIGFLAG_PARTIAL_LOG_CONF &h00002000
#define CONFIGFLAG_SUPPRESS_SURPRISE &h00004000
#define CONFIGFLAG_VERIFY_HARDWARE &h00008000
#define CSCONFIGFLAG_BITS &h00000007
#define CSCONFIGFLAG_DISABLED &h00000001
#define CSCONFIGFLAG_DO_NOT_CREATE &h00000002
#define CSCONFIGFLAG_DO_NOT_START &h00000004
#define DMSTATEFLAG_APPLYTOALL &h00000001
...
#define MF_FLAGS_EVEN_IF_NO_RESOURCE &h00000001
#define MF_FLAGS_NO_CREATE_IF_NO_RESOURCE &h00000002
#define MF_FLAGS_FILL_IN_UNKNOWN_RESOURCE &h00000004
#define MF_FLAGS_CREATE_BUT_NO_SHOW_DISABLED &h00000008
...
#define EISAFLAG_NO_IO_MERGE &h00000001
#define EISAFLAG_SLOT_IO_FIRST &h00000002
...
#define PIR_OPTION_ENABLED &h00000001
#define PIR_OPTION_REGISTRY &h00000002
#define PIR_OPTION_MSSPEC &h00000004
#define PIR_OPTION_REALMODE &h00000008
#define PIR_OPTION_DEFAULT &h0000000f
#define PIR_STATUS_ERROR &h00000000
#define PIR_STATUS_ENABLED &h00000001
#define PIR_STATUS_DISABLED &h00000002
#define PIR_STATUS_MAX &h00000003
#define PIR_STATUS_TABLE_REGISTRY &h00000000
#define PIR_STATUS_TABLE_MSSPEC &h00000001
#define PIR_STATUS_TABLE_REALMODE &h00000002
#define PIR_STATUS_TABLE_NONE &h00000003
#define PIR_STATUS_TABLE_ERROR &h00000004
#define PIR_STATUS_TABLE_BAD &h00000005
#define PIR_STATUS_TABLE_SUCCESS &h00000006
#define PIR_STATUS_TABLE_MAX &h00000007
#define PIR_STATUS_MINIPORT_NORMAL &h00000000
#define PIR_STATUS_MINIPORT_COMPATIBLE &h00000001
#define PIR_STATUS_MINIPORT_OVERRIDE &h00000002
#define PIR_STATUS_MINIPORT_NONE &h00000003
#define PIR_STATUS_MINIPORT_ERROR &h00000004
#define PIR_STATUS_MINIPORT_NOKEY &h00000005
#define PIR_STATUS_MINIPORT_SUCCESS &h00000006
#define PIR_STATUS_MINIPORT_INVALID &h00000007
#define PIR_STATUS_MINIPORT_MAX &h00000008
...
#define LASTGOOD_OPERATION &h000000FF
#define LASTGOOD_OPERATION_NOPOSTPROC &h00000000
#define LASTGOOD_OPERATION_DELETE &h00000001
