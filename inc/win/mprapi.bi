...
#define MPR_INTERFACE_SERVICE_PAUSED &h00000008
#define MPR_INTERFACE_DIALOUT_HOURS_RESTRICTION &h00000010
#define MPR_INTERFACE_NO_MEDIA_SENSE &h00000020
#define MPR_INTERFACE_NO_DEVICE &h00000040
...
#define MPRIO_IpSecPreSharedKey &h80000000
...
#define PPP_CCP_ENCRYPTION40BITOLD &h00000010
#define PPP_CCP_ENCRYPTION40BIT &h00000020
#define PPP_CCP_ENCRYPTION128BIT &h00000040
#define PPP_CCP_ENCRYPTION56BIT &h00000080
#define PPP_CCP_HISTORYLESS &h01000000
...
#define PPP_LCP_EAP &hC227
#define PPP_LCP_CHAP_MD5 &h05
#define PPP_LCP_CHAP_MS &h80
#define PPP_LCP_CHAP_MSV2 &h81
#define PPP_LCP_MULTILINK_FRAMING &h00000001
#define PPP_LCP_PFC &h00000002
#define PPP_LCP_ACFC &h00000004
#define PPP_LCP_SSHF &h00000008
#define PPP_LCP_DES_56 &h00000010
#define PPP_LCP_3_DES &h00000020
...
#define MprInfoBlockExists(h, t) (MprInfoBlockFind((h), (t), NULL, NULL, NULL) = NO_ERROR)
	...
	#define MPRAPI_RAS_CONNECTION_OBJECT_REVISION_1 &h01
	#define MPRAPI_MPR_SERVER_OBJECT_REVISION_1 &h01
	#define MPRAPI_MPR_SERVER_SET_CONFIG_OBJECT_REVISION_1 &h01
	...
	#define RAS_FLAGS_MESSENGER_PRESENT &h00000002
	#define RAS_FLAGS_QUARANTINE_PRESENT &h00000008
	#define RAS_FLAGS_ARAP_CONNECTION &h00000010
	#define RAS_FLAGS_IKEV2_CONNECTION &h00000010
	#define RAS_FLAGS_DORMANT &h00000020
	#define IPADDRESSLEN 15
