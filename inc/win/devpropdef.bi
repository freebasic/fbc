...
#pragma once
	...
	#define DEVPROP_TYPE_STRING_LIST (DEVPROP_TYPE_STRING or DEVPROP_TYPEMOD_LIST)
	...
	#define DEVPROP_TYPE_BINARY (DEVPROP_TYPE_BYTE or DEVPROP_TYPEMOD_ARRAY)
	...
	type DEVPROP_BOOLEAN as zstring
	type PDEVPROP_BOOLEAN as zstring ptr
	const DEVPROP_TRUE = cbyte(-1)
	const DEVPROP_FALSE = cbyte(0)
