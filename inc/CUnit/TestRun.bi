...
type CU_TestStartMessageHandler as sub(byval as CU_pTest, byval as CU_pSuite)
type CU_TestCompleteMessageHandler as sub(byval as CU_pTest, byval as CU_pSuite, byval as CU_pFailureRecord)
type CU_AllTestsCompleteMessageHandler as sub(byval as CU_pFailureRecord)
type CU_SuiteInitFailureMessageHandler as sub(byval as CU_pSuite)
type CU_SuiteCleanupFailureMessageHandler as sub(byval as CU_pSuite)
...
declare function CU_get_number_of_suites_run() as uinteger
declare function CU_get_number_of_suites_failed() as uinteger
declare function CU_get_number_of_tests_run() as uinteger
declare function CU_get_number_of_tests_failed() as uinteger
declare function CU_get_number_of_asserts() as uinteger
declare function CU_get_number_of_successes() as uinteger
declare function CU_get_number_of_failures() as uinteger
declare function CU_get_number_of_failure_records() as uinteger
...
declare function CU_is_test_running() as integer
declare sub CU_clear_previous_results()
declare function CU_assertImplementation(byval bValue as integer, byval uiLine as uinteger, byval strCondition as zstring ptr, byval strFile as zstring ptr, byval strFunction as zstring ptr, byval bFatal as integer) as integer
