...
declare function gsl_block_char_alloc(byval n as const uinteger) as gsl_block_char ptr
declare function gsl_block_char_calloc(byval n as const uinteger) as gsl_block_char ptr
declare sub gsl_block_char_free(byval b as gsl_block_char ptr)
declare function gsl_block_char_fread(byval stream as FILE ptr, byval b as gsl_block_char ptr) as long
