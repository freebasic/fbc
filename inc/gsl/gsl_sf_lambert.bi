...
declare function gsl_sf_lambert_W0_e(byval x as double, byval result as gsl_sf_result ptr) as long
declare function gsl_sf_lambert_W0(byval x as double) as double
declare function gsl_sf_lambert_Wm1_e(byval x as double, byval result as gsl_sf_result ptr) as long
