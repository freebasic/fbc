#pragma once
	...
	'' On 64bit systems except 64bit Windows, i.e. 64bit Linux/BSD,
	'' C's long is 64bit like FB's integer.
	...
	'' this is also used for 64bit Windows where Integer isn't be 32bit.
	type clong as long
