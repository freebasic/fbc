...
// please add it here.
$lang['TRANSLATION'] = '<a href=\'http://www.phpbbguru.net/\'>Русская поддержка phpBB</a>';
...
$lang['Board_disable'] = 'Извините, эти форумы отключены. Попробуйте зайти позже';
...
$lang['Flood_Error'] = 'Вы не можете отправить следующее сообщение сразу после предыдущего. Пожалуйста, попробуйте чуть позже.';
...
$lang['No_email_match'] = 'Введённый вами адрес e-mail не совпадает с адресом данного пользователя';
...
$lang['Search_Flood_Error'] = 'Вы не можете произвести поиск сразу после предыдущего. Пожалуйста, попробуйте чуть позже.';
...
$lang['Login_attempts_exceeded'] = 'Максимальное количество попыток войти на эти форумы (%s) было исчерпано.<br />Вы не сможете войти на эти форумы в последующие %s минут.'; 
$lang['Please_remove_install_contrib'] = 'Пожалуйста, удалите каталоги install/ и contrib/';
